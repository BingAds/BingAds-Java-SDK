...
public class BulkLocationAdExtensionReadFromRowValuesIdTest extends BulkLocationAdExtensionTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkLocationAdExtension, Long>() {
            @Override
            public Long apply(BulkLocationAdExtension c) {
                return c.getLocationAdExtension().getId();
            }
        });
    }
}
