...
public class BulkLocationAdExtensionReadFromRowValuesIconMediaIdTest extends BulkLocationAdExtensionTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Map Icon", this.datum, this.expectedResult, new Function<BulkLocationAdExtension, Long>() {
            @Override
