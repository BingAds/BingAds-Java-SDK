...
public class BulkLocationAdExtensionWriteFromRowValuesIdTest extends BulkLocationAdExtensionTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Id", this.datum, this.expectedResult, new BiConsumer<BulkLocationAdExtension, Long>() {
            @Override
            public void accept(BulkLocationAdExtension c, Long v) {
                c.getLocationAdExtension().setId(v);
            }
        });
    }
}
