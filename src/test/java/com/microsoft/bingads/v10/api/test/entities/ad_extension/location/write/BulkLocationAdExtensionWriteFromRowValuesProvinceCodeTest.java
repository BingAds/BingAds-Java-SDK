...
public class BulkLocationAdExtensionWriteFromRowValuesProvinceCodeTest extends BulkLocationAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("State Or Province Code", this.datum, this.expectedResult, new BiConsumer<BulkLocationAdExtension, String>() {
            @Override
            public void accept(BulkLocationAdExtension c, String v) {
                c.getLocationAdExtension().getAddress().setProvinceCode(v);
            }
        });
    }
}
