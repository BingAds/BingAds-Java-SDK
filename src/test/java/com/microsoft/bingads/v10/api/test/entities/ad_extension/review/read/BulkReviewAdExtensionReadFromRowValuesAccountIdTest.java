...
public class BulkReviewAdExtensionReadFromRowValuesAccountIdTest extends BulkReviewAdExtensionTest {
    ...
    public void testRead() {
        this.testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkReviewAdExtension, Long>() {
            @Override
