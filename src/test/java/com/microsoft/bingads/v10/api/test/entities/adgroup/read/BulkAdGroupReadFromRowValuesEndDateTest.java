...
import com.microsoft.bingads.v10.api.test.entities.DateComparer;
...
public class BulkAdGroupReadFromRowValuesEndDateTest extends BulkAdGroupTest {
    ...
    public void testRead() {
        this.<Date>testReadProperty("End Date", this.datum, this.expectedResult, new Function<BulkAdGroup, Date>() {
            @Override
            public Date apply(BulkAdGroup c) {
                return c.getAdGroup().getEndDate();
            }
        }, new DateComparer());
    }
}
