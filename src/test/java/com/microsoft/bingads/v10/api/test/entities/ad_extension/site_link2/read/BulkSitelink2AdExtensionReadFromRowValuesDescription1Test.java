...
public class BulkSitelink2AdExtensionReadFromRowValuesDescription1Test extends BulkSitelink2AdExtensionTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Sitelink Extension Description1", this.datum, this.expectedResult, new Function<BulkSitelink2AdExtension, String>() {
            @Override
