...
public class BulkAdGroupRemarketingListAssociationReadFromRowValuesRemarketingListIdTest extends BulkAdGroupRemarketingListAssociationTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Remarketing List Id", this.datum, this.expectedResult, new Function<BulkAdGroupRemarketingListAssociation, Long>() {
            @Override
