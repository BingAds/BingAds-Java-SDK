...
public class BulkAdGroupRemarketingListAssociationReadFromRowValuesRemarketingListTest extends BulkAdGroupRemarketingListAssociationTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Remarketing List", this.datum, this.expectedResult, new Function<BulkAdGroupRemarketingListAssociation, String>() {
            @Override
