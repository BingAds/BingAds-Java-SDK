...
public class BulkLocationAdExtensionWriteFromRowValuesProvinceNameTest extends BulkLocationAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Province Name", this.datum, this.expectedResult, new BiConsumer<BulkLocationAdExtension, String>() {
            @Override
            public void accept(BulkLocationAdExtension c, String v) {
                c.getLocationAdExtension().getAddress().setProvinceName(v);
            }
        });
    }
}
