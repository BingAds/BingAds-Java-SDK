...
public class BulkLocationAdExtensionWriteFromRowValuesIconMediaIdTest extends BulkLocationAdExtensionTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Map Icon", this.datum, this.expectedResult, new BiConsumer<BulkLocationAdExtension, Long>() {
            @Override
            public void accept(BulkLocationAdExtension c, Long v) {
                c.getLocationAdExtension().setIconMediaId(v);
            }
        });
    }
}
