...
public class BulkCampaignRadiusTargetWriteToRowValuesCampaignNameTest extends BulkCampaignRadiusTargetBidTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Campaign", this.datum, this.expectedResult, new BiConsumer<BulkCampaignRadiusTargetBid, String>() {
            @Override
