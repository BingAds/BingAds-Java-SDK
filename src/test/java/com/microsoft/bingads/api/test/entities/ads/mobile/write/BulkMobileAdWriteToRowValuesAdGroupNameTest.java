...
public class BulkMobileAdWriteToRowValuesAdGroupNameTest extends BulkMobileAdTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Ad Group", this.datum, this.propertyValue, new BiConsumer<BulkMobileAd, String>() {
            @Override
