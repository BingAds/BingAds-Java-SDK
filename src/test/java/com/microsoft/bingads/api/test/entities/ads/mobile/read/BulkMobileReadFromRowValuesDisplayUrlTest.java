...
public class BulkMobileReadFromRowValuesDisplayUrlTest extends BulkMobileAdTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Display Url", this.datum, this.expectedResult, new Function<BulkMobileAd, String>() {
            @Override
            public String apply(BulkMobileAd c) {
                return c.getMobileAd().getDisplayUrl();
            }
        });
    }
}
