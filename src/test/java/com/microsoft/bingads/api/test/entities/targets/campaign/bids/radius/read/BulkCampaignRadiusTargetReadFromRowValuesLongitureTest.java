...
public class BulkCampaignRadiusTargetReadFromRowValuesLongitureTest extends BulkCampaignRadiusTargetBidTest {
    ...
    public void testRead() {
        this.<Double>testReadProperty("Longitude", this.datum, this.expectedResult, new Function<BulkCampaignRadiusTargetBid, Double>() {
            @Override
