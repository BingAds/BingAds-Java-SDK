...
public class BulkCampaignRadiusTargetWriteToRowValuesLongitureTest extends BulkCampaignRadiusTargetBidTest {
    ...
    public void testWrite() {
        this.<Double>testWriteProperty("Longitude", this.datum, this.expectedResult, new BiConsumer<BulkCampaignRadiusTargetBid, Double>() {
            @Override
            public void accept(BulkCampaignRadiusTargetBid c, Double v) {
                c.getRadiusTargetBid().setLongitudeDegrees(v);
            }
        });
    }
}
