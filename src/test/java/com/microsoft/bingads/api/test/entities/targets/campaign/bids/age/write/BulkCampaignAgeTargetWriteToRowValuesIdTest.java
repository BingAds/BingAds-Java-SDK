...
public class BulkCampaignAgeTargetWriteToRowValuesIdTest extends BulkCampaignAgeTargetBidTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Id", this.datum, this.expectedResult, new BiConsumer<BulkCampaignAgeTargetBid, Long>() {
            @Override
