...
public class BulkMobileReadFromRowValuesBusinessNameTest extends BulkMobileAdTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Business Name", this.datum, this.expectedResult, new Function<BulkMobileAd, String>() {
            @Override
            public String apply(BulkMobileAd c) {
                return c.getMobileAd().getBusinessName();
            }
        });
    }
}
