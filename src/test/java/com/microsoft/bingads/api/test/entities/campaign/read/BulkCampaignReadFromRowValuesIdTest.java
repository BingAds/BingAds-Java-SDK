...
public class BulkCampaignReadFromRowValuesIdTest extends BulkCampaignTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkCampaign, Long>() {
            @Override
