...
import com.microsoft.bingads.campaignmanagement.ArrayOfSetting;
import com.microsoft.bingads.campaignmanagement.CampaignType;
...
public class BulkCampaignWriteToRowValuesCountryCodeShoppingSettingTest extends BulkCampaignTest {
    ...
    public void testWrite() {
        testWriteProperty("COUNTRY_CODE", this.datum, this.propertyValue, new BiConsumer<BulkCampaign, String>() {
            @Override
