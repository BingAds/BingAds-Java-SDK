...
public class BulkCampaignDeviceOsTargetWriteToRowValuesIdTest extends BulkCampaignDeviceOsTargetBidTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Id", this.datum, this.expectedResult, new BiConsumer<BulkCampaignDeviceOsTargetBid, Long>() {
            @Override
