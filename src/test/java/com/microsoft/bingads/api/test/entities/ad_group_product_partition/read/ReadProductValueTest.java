...
public class ReadProductValueTest extends BulkAdGroupProductPartitionTest {
        ...
        testReadProperty(
                ...
                new Function<BulkAdGroupProductPartition, String>() {
                    ...
                    public String apply(BulkAdGroupProductPartition c) {
                        return ((ProductPartition) c.getAdGroupCriterion().getCriterion()).getCondition().getAttribute();
                    }
                }
        );
    }
