...
public class BulkImageAdExtensionReadFromRowValuesAccountIdTest extends BulkImageAdExtensionTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkImageAdExtension, Long>() {
            @Override
