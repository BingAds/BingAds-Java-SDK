...
public class BulkMobileReadFromRowValuesDestinationUrlTest extends BulkMobileAdTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Destination Url", this.datum, this.expectedResult, new Function<BulkMobileAd, String>() {
            @Override
            public String apply(BulkMobileAd c) {
                return c.getMobileAd().getDestinationUrl();
            }
        });
    }
}
