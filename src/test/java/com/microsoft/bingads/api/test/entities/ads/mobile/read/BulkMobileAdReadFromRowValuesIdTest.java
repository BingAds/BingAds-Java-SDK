...
public class BulkMobileAdReadFromRowValuesIdTest extends BulkMobileAdTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkMobileAd, Long>() {
            @Override
            public Long apply(BulkMobileAd c) {
                return c.getMobileAd().getId();
            }
        });
    }
}
