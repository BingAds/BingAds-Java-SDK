...
public class BulkMobileAdReadFromRowValuesTitleTest extends BulkMobileAdTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Title", this.datum, this.expectedResult, new Function<BulkMobileAd, String>() {
            @Override
            public String apply(BulkMobileAd c) {
                return c.getMobileAd().getTitle();
            }
        });
    }
}
