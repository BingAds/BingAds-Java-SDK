...
import com.microsoft.bingads.campaignmanagement.ProductPartition;
...
public class ReadProductConditionTest extends BulkAdGroupProductPartitionTest {
    ...
    public void testReadExcluded() {
        ...
        values.put("Product Condition 1", datum);
        ...
        testReadProperty(
                ...
                new Function<BulkAdGroupProductPartition, String>() {
                    ...
                    public String apply(BulkAdGroupProductPartition c) {
                        return ((ProductPartition) c.getAdGroupCriterion().getCriterion()).getCondition().getOperand();
                    }
                }
        );
    }
