...
public class BulkCampaignRadiusTargetReadFromRowValuesIdTest extends BulkCampaignRadiusTargetBidTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkCampaignRadiusTargetBid, Long>() {
            @Override
