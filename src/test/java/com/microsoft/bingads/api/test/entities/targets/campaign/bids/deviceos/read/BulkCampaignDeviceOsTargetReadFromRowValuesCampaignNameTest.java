...
public class BulkCampaignDeviceOsTargetReadFromRowValuesCampaignNameTest extends BulkCampaignDeviceOsTargetBidTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Campaign", this.datum, this.expectedResult, new Function<BulkCampaignDeviceOsTargetBid, String>() {
            @Override
