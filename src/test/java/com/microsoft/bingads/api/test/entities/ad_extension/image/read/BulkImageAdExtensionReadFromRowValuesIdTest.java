...
public class BulkImageAdExtensionReadFromRowValuesIdTest extends BulkImageAdExtensionTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkImageAdExtension, Long>() {
            @Override
            public Long apply(BulkImageAdExtension c) {
                return c.getImageAdExtension().getId();
            }
        });
    }
}
