...
public class BulkCampaignLocationTargetWriteToRowValuesCampaignNameTest extends BulkCampaignLocationTargetBidTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Campaign", this.datum, this.expectedResult, new BiConsumer<BulkCampaignLocationTargetBid, String>() {
            @Override
            public void accept(BulkCampaignLocationTargetBid c, String v) {
                c.setCampaignName(v);
            }
        });
    }
