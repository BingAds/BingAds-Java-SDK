...
public class BulkCampaignDayTimeTargetReadFromRowValuesCampaignNameTest extends BulkCampaignDayTimeTargetBidTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Campaign", this.datum, this.expectedResult, new Function<BulkCampaignDayTimeTargetBid, String>() {
            @Override
            public String apply(BulkCampaignDayTimeTargetBid c) {
