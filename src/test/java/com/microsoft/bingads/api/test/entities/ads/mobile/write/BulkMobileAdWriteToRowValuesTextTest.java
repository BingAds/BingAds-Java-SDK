...
public class BulkMobileAdWriteToRowValuesTextTest extends BulkMobileAdTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Text", this.datum, this.propertyValue, new BiConsumer<BulkMobileAd, String>() {
            @Override
            public void accept(BulkMobileAd c, String v) {
                c.getMobileAd().setText(v);
            }
        });
    }
}
