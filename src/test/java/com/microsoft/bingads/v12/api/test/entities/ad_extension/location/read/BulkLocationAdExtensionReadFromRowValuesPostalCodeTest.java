...
public class BulkLocationAdExtensionReadFromRowValuesPostalCodeTest extends BulkLocationAdExtensionTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Postal Code", this.datum, this.expectedResult, new Function<BulkLocationAdExtension, String>() {
            @Override
            public String apply(BulkLocationAdExtension c) {
                return c.getLocationAdExtension().getAddress().getPostalCode();
            }
        });
    }
}
