...
public class BulkActionAdExtensionReadFromRowValuesFinalMobileUrlTest extends BulkActionAdExtensionTest {
    ...
    public void testRead() {
        this.<ArrayOfstring>testReadProperty("Mobile Final Url", this.datum, this.expectedResult, new Function<BulkActionAdExtension, ArrayOfstring>() {
            @Override
            public ArrayOfstring apply(BulkActionAdExtension c) {
                return c.getActionAdExtension().getFinalMobileUrls();
            }
