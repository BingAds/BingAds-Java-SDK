...
public class BulkCampaignRemarketingListAssociationReadFromRowValuesAudienceIdTest extends BulkCampaignRemarketingListAssociationTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Audience Id", this.datum, this.expectedResult, new Function<BulkCampaignRemarketingListAssociation, Long>() {
            @Override
            public Long apply(BulkCampaignRemarketingListAssociation c) {
                return ((AudienceCriterion) c.getBiddableCampaignCriterion().getCriterion()).getAudienceId();
            }
        });
    }
}
