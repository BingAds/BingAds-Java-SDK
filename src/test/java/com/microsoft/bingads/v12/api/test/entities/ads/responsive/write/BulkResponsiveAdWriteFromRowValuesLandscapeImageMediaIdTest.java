...
public class BulkResponsiveAdWriteFromRowValuesLandscapeImageMediaIdTest extends BulkResponsiveAdTest {
    ...
    public void testWrite() {
        this.testWriteProperty("Landscape Image Media Id", this.datum, this.expectedResult, new BiConsumer<BulkResponsiveAd, Long>() {
            @Override
            public void accept(BulkResponsiveAd c, Long v) {
                c.getResponsiveAd().setLandscapeImageMediaId(v);
            }
        });
    }
}
