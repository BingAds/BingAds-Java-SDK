...
public class BulkSitelinkAdExtensionWriteToRowValuesDescription1Test extends BulkSitelinkAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Sitelink Extension Description1", this.datum, this.expectedResult, new BiConsumer<BulkSitelinkAdExtension, String>() {
            @Override
