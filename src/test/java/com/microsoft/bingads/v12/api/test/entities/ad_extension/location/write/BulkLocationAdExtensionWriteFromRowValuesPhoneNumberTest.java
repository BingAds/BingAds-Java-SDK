...
public class BulkLocationAdExtensionWriteFromRowValuesPhoneNumberTest extends BulkLocationAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Phone Number", this.datum, this.expectedResult, new BiConsumer<BulkLocationAdExtension, String>() {
            @Override
            public void accept(BulkLocationAdExtension c, String v) {
                c.getLocationAdExtension().setPhoneNumber(v);
            }
        });
    }
}
