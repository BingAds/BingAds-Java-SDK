...
public class BulkActionAdExtensionWriteToValuesUrlCustomParameters extends BulkActionAdExtensionTest {
    ...
    public void testWrite() {
        this.<CustomParameters>testWriteProperty("Custom Parameter", this.datum, this.propertyValue, new BiConsumer<BulkActionAdExtension, CustomParameters>() {
            @Override
            public void accept(BulkActionAdExtension c, CustomParameters v) {
                c.getActionAdExtension().setUrlCustomParameters(v);;
            }
        });
