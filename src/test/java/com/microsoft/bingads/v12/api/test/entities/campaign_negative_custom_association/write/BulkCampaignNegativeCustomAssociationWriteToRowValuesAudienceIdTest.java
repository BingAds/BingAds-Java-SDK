...
public class BulkCampaignNegativeCustomAssociationWriteToRowValuesAudienceIdTest extends BulkCampaignNegativeCustomAssociationTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Audience Id", this.datum, this.propertyValue, new BiConsumer<BulkCampaignNegativeCustomAudienceAssociation, Long>() {
            @Override
            public void accept(BulkCampaignNegativeCustomAudienceAssociation c, Long v) {
                ((AudienceCriterion)c.getNegativeCampaignCriterion().getCriterion()).setAudienceId(v);
            }
        });
    }
}
