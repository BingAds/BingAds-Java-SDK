...
public class BulkResponsiveAdWriteFromRowValuesSquareImageMediaIdTest extends BulkResponsiveAdTest {
    ...
    public void testWrite() {
        this.testWriteProperty("Square Image Media Id", this.datum, this.expectedResult, new BiConsumer<BulkResponsiveAd, Long>() {
            @Override
            public void accept(BulkResponsiveAd c, Long v) {
                c.getResponsiveAd().setSquareImageMediaId(v);
            }
        });
    }
}
