...
public class BulkExperimentReadFromRowValuesIdTest extends BulkExperimentTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkExperiment, Long>() {
            @Override
            public Long apply(BulkExperiment c) {
                return c.getExperiment().getId();
            }
        });
    }
}
