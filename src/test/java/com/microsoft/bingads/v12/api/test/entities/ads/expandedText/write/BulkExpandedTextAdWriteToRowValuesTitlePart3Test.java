...
public class BulkExpandedTextAdWriteToRowValuesTitlePart3Test extends BulkExpandedTextAdTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Title Part 3", this.datum, this.propertyValue, new BiConsumer<BulkExpandedTextAd, String>() {
            @Override
            public void accept(BulkExpandedTextAd c, String v) {
                c.getExpandedTextAd().setTitlePart3(v);
            }
        });
    }
}
