...
public class BulkAppAdExtensionReadFromRowValuesAccountIdTest extends BulkAppAdExtensionTest {
    ...
    public void testRead() {
        this.testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkAppAdExtension, Long>() {
            @Override
