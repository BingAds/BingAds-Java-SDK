...
public class BulkSitelinkAdExtensionReadFromRowValuesDescription1Test extends BulkSitelinkAdExtensionTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Sitelink Extension Description1", this.datum, this.expectedResult, new Function<BulkSitelinkAdExtension, String>() {
            @Override
