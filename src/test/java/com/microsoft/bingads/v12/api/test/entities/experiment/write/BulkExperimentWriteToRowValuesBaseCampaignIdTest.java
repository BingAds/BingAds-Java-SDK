...
public class BulkExperimentWriteToRowValuesBaseCampaignIdTest extends BulkExperimentTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Base Campaign Id", this.datum, this.propertyValue, new BiConsumer<BulkExperiment, Long>() {
            @Override
            public void accept(BulkExperiment c, Long v) {
                c.getExperiment().setBaseCampaignId(v);
            }
        });
    }
}
