...
public class BulkAdGroupSimilarRemarketingListAssociationReadIdTest extends BulkAdGroupSimilarRemarketingListAssociationTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkAdGroupSimilarRemarketingListAssociation, Long>() {
            @Override
