...
public class BulkCampaginRemarketingListAssociationReadFromRowValuesParentIdTest extends BulkCampaignRemarketingListAssociationTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkCampaignRemarketingListAssociation, Long>() {
            @Override
