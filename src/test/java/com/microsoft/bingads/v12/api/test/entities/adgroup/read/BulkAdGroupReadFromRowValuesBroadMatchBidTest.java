...
import com.microsoft.bingads.v12.api.test.entities.BidComparer;
...
public class BulkAdGroupReadFromRowValuesBroadMatchBidTest extends BulkAdGroupTest {
    ...
    public void testRead() {
        this.<Bid>testReadProperty("Cpc Bid", this.datum, this.expectedResult, new Function<BulkAdGroup, Bid>() {
            @Override
            public Bid apply(BulkAdGroup c) {
                return c.getAdGroup().getCpcBid();
            }
        }, new BidComparer());
    }
}
