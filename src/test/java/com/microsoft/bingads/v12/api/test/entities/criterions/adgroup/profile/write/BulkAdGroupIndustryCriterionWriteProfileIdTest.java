package com.microsoft.bingads.v12.api.test.entities.criterions.adgroup.profile.write;
...
public class BulkAdGroupIndustryCriterionWriteProfileIdTest extends BulkAdGroupProfileCriterionTest<BulkAdGroupIndustryCriterion> {
    ...
    public void testWrite() {
        testWriteProperty(
                ...
                datum,
                propertyValue,
                new BiConsumer<BulkAdGroupIndustryCriterion, Long>() {
                    @Override
                    public void accept(BulkAdGroupIndustryCriterion c, Long v) {
