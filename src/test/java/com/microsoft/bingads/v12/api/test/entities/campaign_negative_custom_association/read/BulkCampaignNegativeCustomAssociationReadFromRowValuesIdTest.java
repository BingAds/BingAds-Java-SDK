...
public class BulkCampaignNegativeCustomAssociationReadFromRowValuesIdTest extends BulkCampaignNegativeCustomAssociationTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkCampaignNegativeCustomAudienceAssociation, Long>() {
            @Override
