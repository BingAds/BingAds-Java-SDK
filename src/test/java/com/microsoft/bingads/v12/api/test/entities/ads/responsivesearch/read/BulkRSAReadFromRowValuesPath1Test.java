...
public class BulkRSAReadFromRowValuesPath1Test extends BulkResponsiveSearchAdTest {
    ...
    public void testRead() {
        this.testReadProperty("Path 1", this.datum, this.expectedResult, new Function<BulkResponsiveSearchAd, String>() {
            @Override
            public String apply(BulkResponsiveSearchAd c) {
                return c.getResponsiveSearchAd().getPath1();
            }
        });
    }
}
