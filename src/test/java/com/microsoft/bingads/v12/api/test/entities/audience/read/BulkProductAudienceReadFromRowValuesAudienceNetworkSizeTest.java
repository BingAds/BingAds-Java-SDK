...
public class BulkProductAudienceReadFromRowValuesAudienceNetworkSizeTest extends BulkProductAudienceTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Audience Network Size", this.datum, this.expectedResult, new Function<BulkProductAudience, Long>() {
            @Override
