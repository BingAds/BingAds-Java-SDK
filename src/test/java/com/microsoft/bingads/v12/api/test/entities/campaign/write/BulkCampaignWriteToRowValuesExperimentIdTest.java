...
public class BulkCampaignWriteToRowValuesExperimentIdTest extends BulkCampaignTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Experiment Id", this.datum, this.propertyValue, new BiConsumer<BulkCampaign, Long>() {
            @Override
            public void accept(BulkCampaign c, Long v) {
                c.getCampaign().setExperimentId(v);;
            }
        });
    }
}
