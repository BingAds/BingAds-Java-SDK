...
public class BulkAccountReadFromRowValuesFinalUrlSuffixTest extends BulkAccountTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Final Url Suffix", this.datum, this.expectedResult, new Function<BulkAccount, String>() {
            @Override
            public String apply(BulkAccount c) {
                return c.getFinalUrlSuffix();
            }
        });
    }
}
