...
public class BulkSitelinkAdExtensionWriteToRowValuesUrlCustomParameters extends BulkSitelinkAdExtensionTest {
    ...
    public void testWrite() {
        this.<CustomParameters>testWriteProperty("Custom Parameter", this.datum, this.propertyValue, new BiConsumer<BulkSitelinkAdExtension, CustomParameters>() {
            @Override
            public void accept(BulkSitelinkAdExtension c, CustomParameters v) {
                c.getSitelinkAdExtension().setUrlCustomParameters(v);;
            }
        });
