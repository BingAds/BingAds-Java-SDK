...
public class BulkAdGroupReadFromRowValuesIdTest extends BulkAdGroupTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkAdGroup, Long>() {
            @Override
