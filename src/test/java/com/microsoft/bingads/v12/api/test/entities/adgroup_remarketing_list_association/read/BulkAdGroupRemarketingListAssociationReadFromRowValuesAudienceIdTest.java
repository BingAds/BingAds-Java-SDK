...
public class BulkAdGroupRemarketingListAssociationReadFromRowValuesAudienceIdTest extends BulkAdGroupRemarketingListAssociationTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Audience Id", this.datum, this.expectedResult, new Function<BulkAdGroupRemarketingListAssociation, Long>() {
            @Override
