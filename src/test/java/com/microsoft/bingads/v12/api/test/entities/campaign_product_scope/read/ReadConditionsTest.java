...
import com.microsoft.bingads.v12.api.test.entities.ArrayOfProductConditionComparer;
...
import com.microsoft.bingads.v12.campaignmanagement.ProductScope;
        ...
        testReadProperty(
                ...
                new Function<BulkCampaignProductScope, ArrayOfProductCondition>() {
                    ...
                    public ArrayOfProductCondition apply(BulkCampaignProductScope c) {
                        return ((ProductScope) c.getBiddableCampaignCriterion().getCriterion()).getConditions();
                    }
                },
