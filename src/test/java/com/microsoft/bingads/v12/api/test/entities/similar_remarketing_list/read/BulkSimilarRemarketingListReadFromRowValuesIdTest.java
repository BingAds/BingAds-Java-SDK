...
public class BulkSimilarRemarketingListReadFromRowValuesIdTest extends BulkSimilarRemarketingListTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkSimilarRemarketingList, Long>() {
            @Override
