...
public class BulkSimilarRemarketingListReadFromRowValuesSourceIdTest extends BulkSimilarRemarketingListTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Source Id", this.datum, this.expectedResult, new Function<BulkSimilarRemarketingList, Long>() {
            @Override
