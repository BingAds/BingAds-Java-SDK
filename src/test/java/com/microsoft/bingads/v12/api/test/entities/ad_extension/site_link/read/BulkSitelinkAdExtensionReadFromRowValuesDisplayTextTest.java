...
public class BulkSitelinkAdExtensionReadFromRowValuesDisplayTextTest extends BulkSitelinkAdExtensionTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Sitelink Extension Link Text", this.datum, this.expectedResult, new Function<BulkSitelinkAdExtension, String>() {
            @Override
