...
public class BulkKeywordReadFromRowValuesParam1Test extends BulkKeywordTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Param1", this.datum, this.expectedResult, new Function<BulkKeyword, String>() {
            @Override
            public String apply(BulkKeyword c) {
                return c.getKeyword().getParam1();
            }
        });
    }
}
