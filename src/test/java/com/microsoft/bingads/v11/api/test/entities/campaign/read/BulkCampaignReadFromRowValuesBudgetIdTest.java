...
public class BulkCampaignReadFromRowValuesBudgetIdTest extends BulkCampaignTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Budget Id", this.datum, this.expectedResult, new Function<BulkCampaign, Long>() {
            @Override
            public Long apply(BulkCampaign c) {
                return c.getCampaign().getBudgetId();
            }
        });
    }
}
