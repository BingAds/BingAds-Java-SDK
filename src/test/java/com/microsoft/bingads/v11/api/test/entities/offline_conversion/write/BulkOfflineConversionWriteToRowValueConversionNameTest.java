...
public class BulkOfflineConversionWriteToRowValueConversionNameTest extends BulkOfflineConversionTest {
    ...
    public void testRead() {
        this.<String>testWriteProperty("Conversion Name", this.datum, this.expectedResult, new BiConsumer<BulkOfflineConversion, String>() {
            @Override
