...
public class BulkAppAdExtensionWriteFromRowValuesAccountIdTest extends BulkAppAdExtensionTest {
    ...
    public void testWrite() {
        this.testWriteProperty("Parent Id", this.datum, this.expectedResult, new BiConsumer<BulkAppAdExtension, Long>() {
            @Override
