...
public class BulkCalloutAdExtensionReadFromRowValuesAccountIdTest extends BulkCalloutAdExtensionTest {
    ...
    public void testRead() {
        this.testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkCalloutAdExtension, Long>() {
            @Override
