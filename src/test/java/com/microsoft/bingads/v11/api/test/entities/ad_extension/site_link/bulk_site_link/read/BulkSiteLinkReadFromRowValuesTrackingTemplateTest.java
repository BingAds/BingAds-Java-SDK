...
public class BulkSiteLinkReadFromRowValuesTrackingTemplateTest extends BulkSiteLinkTest{
	...
	public void testRead() {
		this.<String>testReadProperty("Tracking Template", this.datum, this.expectedResult, new Function<BulkSiteLink, String>() {
			@Override
			public String apply(BulkSiteLink c) {
				return c.getSiteLink().getTrackingUrlTemplate();
			}
		});
	}
}
