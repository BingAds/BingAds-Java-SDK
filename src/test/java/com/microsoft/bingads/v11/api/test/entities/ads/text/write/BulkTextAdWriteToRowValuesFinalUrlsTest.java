...
public class BulkTextAdWriteToRowValuesFinalUrlsTest extends BulkTextAdTest {
    ...
    public void testWrite() {
        this.<ArrayOfstring>testWriteProperty("Final Url", this.datum, this.propertyValue, new BiConsumer<BulkTextAd, ArrayOfstring>() {
            @Override
            public void accept(BulkTextAd c, ArrayOfstring v) {
                c.getTextAd().setFinalUrls(v);
            }
        });
    }
}
