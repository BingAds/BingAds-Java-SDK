...
public class BulkSiteLinkReadFromRowValuesDisplayTextTest extends BulkSiteLinkTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Sitelink Extension Link Text", this.datum, this.expectedResult, new Function<BulkSiteLink, String>() {
            @Override
