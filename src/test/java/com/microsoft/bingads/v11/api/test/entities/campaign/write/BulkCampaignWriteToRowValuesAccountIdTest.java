...
public class BulkCampaignWriteToRowValuesAccountIdTest extends BulkCampaignTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Parent Id", this.datum, this.propertyValue, new BiConsumer<BulkCampaign, Long>() {
            @Override
