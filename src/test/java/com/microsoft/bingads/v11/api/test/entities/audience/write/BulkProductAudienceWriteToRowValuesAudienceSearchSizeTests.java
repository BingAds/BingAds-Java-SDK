...
public class BulkProductAudienceWriteToRowValuesAudienceSearchSizeTests extends BulkProductAudienceTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Audience Search Size", this.datum, this.propertyValue, new BiConsumer<BulkProductAudience, Long>() {
            @Override
            public void accept(BulkProductAudience c, Long v) {
                c.getProductAudience().setSearchSize(v);
            }
        });
    }
}
