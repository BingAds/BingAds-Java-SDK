...
public class BulkSiteLinkWriteToRowValuesFinalUrlsTest extends BulkSiteLinkTest {
    ...
    public void testWrite() {
        this.<ArrayOfstring>testWriteProperty("Final Url", this.datum, this.propertyValue, new BiConsumer<BulkSiteLink, ArrayOfstring>() {
            @Override
            public void accept(BulkSiteLink c, ArrayOfstring v) {
                c.getSiteLink().setFinalUrls(v);
            }
        });
    }
}
