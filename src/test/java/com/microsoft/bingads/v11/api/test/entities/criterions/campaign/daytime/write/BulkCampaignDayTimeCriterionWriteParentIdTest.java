...
public class BulkCampaignDayTimeCriterionWriteParentIdTest extends BulkCampaignDayTimeCriterionTest {
    ...
    public void testWrite() {
        testWriteProperty(
                ...
                datum,
                propertyValue,
                new BiConsumer<BulkCampaignDayTimeCriterion, Long>() {
                    @Override
                    public void accept(BulkCampaignDayTimeCriterion c, Long v) {
