...
public class BulkSitelink2AdExtensionReadFromRowValuesUrlCustomParametersTest extends BulkSitelink2AdExtensionTest{
	...
	public void testRead() {	
		this.<CustomParameters>testReadProperty("Custom Parameter", this.datum, this.expectedResult, new Function<BulkSitelink2AdExtension, CustomParameters>() {
			@Override
			public CustomParameters apply(BulkSitelink2AdExtension c) {
				return c.getSitelink2AdExtension().getUrlCustomParameters();
			}
		});
