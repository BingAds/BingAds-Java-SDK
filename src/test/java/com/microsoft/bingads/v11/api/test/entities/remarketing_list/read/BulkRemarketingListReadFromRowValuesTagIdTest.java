...
public class BulkRemarketingListReadFromRowValuesTagIdTest extends BulkRemarketingListTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("UET Tag Id", this.datum, this.expectedResult, new Function<BulkRemarketingList, Long>() {
            @Override
