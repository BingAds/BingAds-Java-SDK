...
public class BulkRemarketingListWriteToRowValuesIdTest extends BulkRemarketingListTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Id", this.datum, this.propertyValue, new BiConsumer<BulkRemarketingList, Long>() {
            @Override
            public void accept(BulkRemarketingList c, Long v) {
                c.getRemarketingList().setId(v);
            }
        });
    }
}
