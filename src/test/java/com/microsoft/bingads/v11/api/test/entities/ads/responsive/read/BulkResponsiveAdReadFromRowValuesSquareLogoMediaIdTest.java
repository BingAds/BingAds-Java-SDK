...
public class BulkResponsiveAdReadFromRowValuesSquareLogoMediaIdTest extends BulkResponsiveAdTest {
    ...
    public void testRead() {
        this.testReadProperty("Square Logo Media Id", this.datum, this.expectedResult, new Function<BulkResponsiveAd, Long>() {
            @Override
            public Long apply(BulkResponsiveAd c) {
                return c.getResponsiveAd().getSquareLogoMediaId();
            }
        });
    }
}
