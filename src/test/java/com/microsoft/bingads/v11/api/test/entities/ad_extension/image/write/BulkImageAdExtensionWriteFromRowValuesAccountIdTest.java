...
public class BulkImageAdExtensionWriteFromRowValuesAccountIdTest extends BulkImageAdExtensionTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Parent Id", this.datum, this.expectedResult, new BiConsumer<BulkImageAdExtension, Long>() {
            @Override
