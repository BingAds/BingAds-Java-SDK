...
public class BulkSitelink2AdExtensionReadFromRowValuesDescription2Test extends BulkSitelink2AdExtensionTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Sitelink Extension Description2", this.datum, this.expectedResult, new Function<BulkSitelink2AdExtension, String>() {
            @Override
