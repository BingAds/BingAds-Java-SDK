...
public class BulkDisclaimerAdExtensionWriteToValuesLineTextTest extends BulkDisclaimerAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Disclaimer Line Text", this.datum, this.expectedResult, new BiConsumer<BulkDisclaimerAdExtension, String>() {
            @Override
            public void accept(BulkDisclaimerAdExtension c, String v) {
                c.getDisclaimerAdExtension().setLineText(v);
            }
        });
    }
}
