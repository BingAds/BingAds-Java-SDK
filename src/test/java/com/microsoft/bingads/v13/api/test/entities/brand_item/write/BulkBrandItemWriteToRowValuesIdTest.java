...
public class BulkBrandItemWriteToRowValuesIdTest extends BulkBrandItemTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Id", this.datum, this.propertyValue, new BiConsumer<BulkBrandItem, Long>() {
            @Override
