...
public class BulkDataExclusionReadFromRowValuesStartDateTest extends BulkDataExclusionTest {
    ...
    public void testRead() {
        this.<Calendar>testReadProperty("Start Date", this.datum, this.expectedResult, new Function<BulkDataExclusion, Calendar>() {
            @Override
            public Calendar apply(BulkDataExclusion c) {
                return c.getDataExclusion().getStartDate();
            }
        });
    }
}
