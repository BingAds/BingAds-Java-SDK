...
public class BulkVideoAdExtensionWriteToRowValuesVideoIdTest extends BulkVideoAdExtensionTest {
    ...
    public void testWrite() {
        this.testWriteProperty("Video Id", this.datum, this.expectedResult, new BiConsumer<BulkVideoAdExtension, Long>() {
            @Override
            public void accept(BulkVideoAdExtension c, Long v) {
                c.getVideoAdExtension().setVideoId(v);
            }
        });
    }
}
