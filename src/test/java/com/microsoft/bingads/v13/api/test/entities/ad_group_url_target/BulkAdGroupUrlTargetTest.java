...
public abstract class BulkAdGroupUrlTargetTest extends BulkEntityTest<BulkAdGroupUrlTarget> {
    ...
    @Override
    protected void onEntityCreation(BulkAdGroupUrlTarget entity) {
    ...
    protected <TProperty> void testWriteProperty(
            ...
            BiConsumer<BulkAdGroupUrlTarget, TProperty> setFunc
    ) {
        testWriteProperty(
                header,
                expectedRowValue,
    ...
    protected <TProperty> void testReadProperty(
            ...
            Function<BulkAdGroupUrlTarget, TProperty> actualValueFunc
    ) {
        testReadProperty(
                header,
                input,
