...
public class BulkAdGroupUrlTargetWriteConditionsTest extends BulkAdGroupUrlTargetTest {
    ...
    public void testRead() {
        ...
        for (Entry<String, String> entry : rowValues.entrySet()) {
            testWriteProperty(
                    ...
                    entry.getValue(),
                    expectedResult,
                    new BiConsumer<BulkAdGroupUrlTarget, ArrayOfWebpageCondition>() {
                        @Override
                        public void accept(BulkAdGroupUrlTarget c, ArrayOfWebpageCondition v) {
