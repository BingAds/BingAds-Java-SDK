...
public class BulkCampaignRemarketingListAssociationWriteToRowValuesRemarketingListIdTest extends BulkCampaignRemarketingListAssociationTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Audience Id", this.datum, this.propertyValue, new BiConsumer<BulkCampaignRemarketingListAssociation, Long>() {
            @Override
            public void accept(BulkCampaignRemarketingListAssociation c, Long v) {
                ((AudienceCriterion)c.getBiddableCampaignCriterion().getCriterion()).setAudienceId(v);
            }
        });
    }
}
