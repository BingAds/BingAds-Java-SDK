...
@SuiteClasses({
        ...
        BulkCampaignWriteToRowValuesAISearchEnabledTest.class,
        BulkCampaignWriteToRowValuesSearchTermMatchingOptOutTest.class,
        BulkCampaignWriteToRowValuesBidStrategyScopeTest.class,
        BulkCampaignWriteToRowValuesFinalUrlExpansionOptOutAISearchSettingTest.class,
        BulkCampaignWriteToRowValuesAutoGeneratedImageOptOutAISearchSettingTest.class,
        BulkCampaignWriteToRowValuesAutoGeneratedTextOptOutAISearchSettingTest.class,
})
