...
public class BulkImageAdExtensionWriteToRowValuesFinalMobileUrlsTest extends BulkImageAdExtensionTest {
    ...
    public void testWrite() {
        this.<ArrayOfstring>testWriteProperty("Mobile Final Url", this.datum, this.propertyValue, new BiConsumer<BulkImageAdExtension, ArrayOfstring>() {
            @Override
            public void accept(BulkImageAdExtension c, ArrayOfstring v) {
                c.getImageAdExtension().setFinalMobileUrls(v);
            }
        });
    }
}
