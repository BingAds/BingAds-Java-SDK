...
public class BulkPromotionAdExtensionReadFromRowValuesOrdersOverAmountTest extends BulkPromotionAdExtensionTest {
    ...
    public void testRead() {
        this.<Double>testReadProperty("Orders Over Amount", this.datum, this.expectedResult, new Function<BulkPromotionAdExtension, Double>() {
            @Override
            public Double apply(BulkPromotionAdExtension c) {
                return c.getPromotionAdExtension().getOrdersOverAmount();
            }
        });
    }
}
