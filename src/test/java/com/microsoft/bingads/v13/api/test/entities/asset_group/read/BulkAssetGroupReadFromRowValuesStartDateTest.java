...
public class BulkAssetGroupReadFromRowValuesStartDateTest extends BulkAssetGroupTest {
    ...
    public void testRead() {
        this.<Date>testReadProperty("Start Date", this.datum, this.expectedResult, new Function<BulkAssetGroup, Date>() {
            @Override
            public Date apply(BulkAssetGroup c) {
                return c.getAssetGroup().getStartDate();
            }
        }, new DateComparer());
    }
}
