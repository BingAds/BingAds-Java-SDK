...
public class BulkAudienceGroupAssetGroupAssociationReadFromRowValuesAssetGroupTest extends BulkAudienceGroupAssetGroupAssociationTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Asset Group", this.datum, this.expectedResult, new Function<BulkAudienceGroupAssetGroupAssociation, String>() {
            @Override
