...
public class BulkAssetGroupWriteToRowValuesFinalUrlSuffixTest extends BulkAssetGroupTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Final Url Suffix", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroup, String>() {
            @Override
            public void accept(BulkAssetGroup c, String v) {
                c.getAssetGroup().setFinalUrlSuffix(v);
            }
        });
    }
}
