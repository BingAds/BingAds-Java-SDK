...
public class BulkCampaignReadFromRowValuesIsPoliticalTest extends BulkCampaignTest {
    ...
    public void testRead() {
        this.<Boolean>testReadProperty("Is Political", this.datum, this.expectedResult, new Function<BulkCampaign, Boolean>() {
            @Override
            public Boolean apply(BulkCampaign c) {
                return c.getCampaign().getIsPolitical();
            }
        });
    }
}
