...
public class BulkRSAWriteFromRowValuesPath2Test extends BulkResponsiveSearchAdTest {
    ...
    public void testWrite() {
        this.testWriteProperty("Path 2", this.datum, this.expectedResult, new BiConsumer<BulkResponsiveSearchAd, String>() {
            @Override
            public void accept(BulkResponsiveSearchAd c, String v) {
                c.getResponsiveSearchAd().setPath2(v);
            }
        });
    }
}
