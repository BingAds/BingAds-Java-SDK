...
public class BulkImageReadFromRowValuesHeightTest extends BulkImageTest {
    ...
    public void testRead() {
        this.<Integer>testReadProperty("Height", this.datum, this.expectedResult, new Function<BulkImage, Integer>() {
            @Override
