...
public class BulkFlyerAdExtensionReadFromRowValuesAccountIdTest extends BulkFlyerAdExtensionTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkFlyerAdExtension, Long>() {
            @Override
