...
public class BulkPromotionAdExtensionWriteToValuesPromotionEndTest extends BulkPromotionAdExtensionTest {
    ...
    public void testWrite() {
    	this.testWriteProperty("Promotion End", this.datum, this.propertyValue, new BiConsumer<BulkPromotionAdExtension, Date>() {
            @Override
            public void accept(BulkPromotionAdExtension c, Date v) {
            	c.getPromotionAdExtension().setPromotionEndDate(new Date());
            }
        });
        ...
        this.testWriteProperty("Promotion End", this.datum, this.propertyValue, new BiConsumer<BulkPromotionAdExtension, Date>() {
            @Override
            public void accept(BulkPromotionAdExtension c, Date v) {
                c.getPromotionAdExtension().setPromotionEndDate(v);
            }
        });
