...
public class BulkAudienceGroupAssetGroupAssociationReadFromRowValuesIdTest extends BulkAudienceGroupAssetGroupAssociationTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkAudienceGroupAssetGroupAssociation, Long>() {
            @Override
