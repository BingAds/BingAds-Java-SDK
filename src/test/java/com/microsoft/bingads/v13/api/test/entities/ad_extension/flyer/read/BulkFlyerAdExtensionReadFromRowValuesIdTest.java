...
public class BulkFlyerAdExtensionReadFromRowValuesIdTest extends BulkFlyerAdExtensionTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkFlyerAdExtension, Long>() {
            @Override
            public Long apply(BulkFlyerAdExtension c) {
                return c.getFlyerAdExtension().getId();
            }
        });
    }
}
