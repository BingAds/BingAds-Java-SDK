...
public class BulkAudienceGroupWriteToRowValuesIdTest extends BulkAudienceGroupTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Id", this.datum, this.propertyValue, new BiConsumer<BulkAudienceGroup, Long>() {
            @Override
            public void accept(BulkAudienceGroup c, Long v) {
                c.getAudienceGroup().setId(v);
            }
        });
    }
}
