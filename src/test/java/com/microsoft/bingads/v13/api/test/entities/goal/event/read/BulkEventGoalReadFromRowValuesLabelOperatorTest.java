...
public class BulkEventGoalReadFromRowValuesLabelOperatorTest extends BulkEventGoalTest {
    ...
    public void testRead() {
        this.<ExpressionOperator>testReadProperty("Label Operator", this.datum, this.expectedResult, new Function<BulkEventGoal, ExpressionOperator>() {
            @Override
            public ExpressionOperator apply(BulkEventGoal c) {
                return c.getEventGoal().getLabelOperator();
            }
        });
    }
}
