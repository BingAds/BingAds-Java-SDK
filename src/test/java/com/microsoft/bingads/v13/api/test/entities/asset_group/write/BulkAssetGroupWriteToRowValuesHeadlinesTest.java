...
public class BulkAssetGroupWriteToRowValuesHeadlinesTest extends BulkAssetGroupTest {
    ...
    public void testWrite() {
        this.testWriteProperty("Headlines", this.datum, this.expectedResult, new BiConsumer<BulkAssetGroup, String>() {
            @Override
