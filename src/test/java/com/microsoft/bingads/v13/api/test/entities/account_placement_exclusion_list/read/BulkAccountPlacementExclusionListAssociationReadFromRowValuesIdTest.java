...
public class BulkAccountPlacementExclusionListAssociationReadFromRowValuesIdTest extends BulkAccountPlacementExclusionListAssociationTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkAccountPlacementExclusionListAssociation, Long>() {
            @Override
