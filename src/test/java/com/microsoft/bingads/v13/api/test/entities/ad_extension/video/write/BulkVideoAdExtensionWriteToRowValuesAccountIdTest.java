...
public class BulkVideoAdExtensionWriteToRowValuesAccountIdTest extends BulkVideoAdExtensionTest {
    ...
    public void testWrite() {
        this.testWriteProperty("Parent Id", this.datum, this.expectedResult, new BiConsumer<BulkVideoAdExtension, Long>() {
            @Override
