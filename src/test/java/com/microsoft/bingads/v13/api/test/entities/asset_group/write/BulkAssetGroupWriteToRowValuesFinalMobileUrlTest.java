...
public class BulkAssetGroupWriteToRowValuesFinalMobileUrlTest extends BulkAssetGroupTest {
    ...
    public void testWrite() {
        this.<ArrayOfstring>testWriteProperty("Mobile Final Url", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroup, ArrayOfstring>() {
            @Override
            public void accept(BulkAssetGroup c, ArrayOfstring v) {
                c.getAssetGroup().setFinalMobileUrls(v);
            }
        });
    }
}
