...
public class BulkVideoAdExtensionReadFromRowValuesEndDateTest extends BulkVideoAdExtensionTest {
    ...
    public void testRead() {         	
    	this.<Date>testReadProperty("End Date", this.datum, this.expectedResult, new Function<BulkVideoAdExtension, Date>() {
            @Override
            public Date apply(BulkVideoAdExtension c) {
                return c.getVideoAdExtension().getScheduling().getEndDate();
            }
