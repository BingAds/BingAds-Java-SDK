...
public class BulkAssetGroupUrlTargetWriteToRowValuesAssetGroupTargetCondition2Test extends BulkAssetGroupUrlTargetTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Asset Group Target Condition 2", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroupUrlTarget, String>() {
            @Override
