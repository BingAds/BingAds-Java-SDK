...
public class BulkLocationAdExtensionWriteFromRowValuesPostalCodeTest extends BulkLocationAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Postal Code", this.datum, this.expectedResult, new BiConsumer<BulkLocationAdExtension, String>() {
            @Override
            public void accept(BulkLocationAdExtension c, String v) {
                c.getLocationAdExtension().getAddress().setPostalCode(v);
            }
        });
    }
}
