...
public class BulkFilterLinkAdExtensionReadFromRowValuesCustomParametersTest extends BulkFilterLinkAdExtensionTest{
	...
	public void testRead() {	
		this.<CustomParameters>testReadProperty("Custom Parameter", this.datum, this.expectedResult, new Function<BulkFilterLinkAdExtension, CustomParameters>() {
			@Override
			public CustomParameters apply(BulkFilterLinkAdExtension c) {
				return c.getFilterLinkAdExtension().getUrlCustomParameters();
			}
		});
