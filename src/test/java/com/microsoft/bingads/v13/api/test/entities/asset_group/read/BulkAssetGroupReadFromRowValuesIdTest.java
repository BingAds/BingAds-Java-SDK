...
public class BulkAssetGroupReadFromRowValuesIdTest extends BulkAssetGroupTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkAssetGroup, Long>() {
            @Override
