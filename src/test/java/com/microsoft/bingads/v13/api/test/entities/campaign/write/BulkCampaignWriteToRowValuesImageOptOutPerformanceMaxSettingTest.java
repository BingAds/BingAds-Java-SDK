...
public class BulkCampaignWriteToRowValuesImageOptOutPerformanceMaxSettingTest extends BulkCampaignTest {
    ...
    public void testWrite() {
        testWriteProperty("Auto Generated Image Assets Opt Out", this.datum, this.propertyValue, new BiConsumer<BulkCampaign, Boolean>() {
            @Override
