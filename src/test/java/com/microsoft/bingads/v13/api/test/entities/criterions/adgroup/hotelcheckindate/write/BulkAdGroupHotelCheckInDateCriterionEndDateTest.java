...
public class BulkAdGroupHotelCheckInDateCriterionEndDateTest extends BulkAdGroupHotelCheckInDateTest {
        ...
        testWriteProperty(
                ...
                new BiConsumer<BulkAdGroupHotelCheckInDateCriterion, Calendar>() {
                    ...
                    public void accept(BulkAdGroupHotelCheckInDateCriterion c, Calendar v) {
                        ((HotelCheckInDateCriterion)c.getBiddableAdGroupCriterion().getCriterion()).setEndDate(v);
                    }
                }
        );
    }
