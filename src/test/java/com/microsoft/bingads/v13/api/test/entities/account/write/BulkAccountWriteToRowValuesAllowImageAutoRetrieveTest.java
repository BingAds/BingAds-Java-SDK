...
public class BulkAccountWriteToRowValuesAllowImageAutoRetrieveTest extends BulkAccountTest {
    ...
    public void testWrite() {
        this.<Boolean>testWriteProperty("Allow Image Auto Retrieve", this.datum, this.propertyValue, new BiConsumer<BulkAccount, Boolean>() {
            @Override
            public void accept(BulkAccount c, Boolean v) {
                c.setAllowImageAutoRetrieve(v);
            }
        });
    }
}
