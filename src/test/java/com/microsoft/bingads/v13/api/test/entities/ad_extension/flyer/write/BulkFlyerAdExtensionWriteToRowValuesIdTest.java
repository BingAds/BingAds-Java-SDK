...
public class BulkFlyerAdExtensionWriteToRowValuesIdTest extends BulkFlyerAdExtensionTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Id", this.datum, this.expectedResult, new BiConsumer<BulkFlyerAdExtension, Long>() {
            @Override
            public void accept(BulkFlyerAdExtension c, Long v) {
                c.getFlyerAdExtension().setId(v);
            }
        });
    }
}
