...
public class BulkAssetGroupUrlTargetReadFromRowValuesAssetGroupTargetConditionOperator3Test extends BulkAssetGroupUrlTargetTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Asset Group Target Condition Operator 3", this.datum, this.expectedResult, new Function<BulkAssetGroupUrlTarget, String>() {
            @Override
