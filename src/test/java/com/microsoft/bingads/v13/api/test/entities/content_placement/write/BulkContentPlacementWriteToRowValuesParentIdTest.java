...
public class BulkContentPlacementWriteToRowValuesParentIdTest extends BulkContentPlacementTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Parent Id", this.datum, this.propertyValue, new BiConsumer<BulkContentPlacement, Long>() {
            @Override
