...
public class BulkContentPlacementReadFromRowValuesStatusTest extends BulkContentPlacementTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Status", this.datum, this.expectedResult, new Function<BulkContentPlacement, String>() {
            @Override
