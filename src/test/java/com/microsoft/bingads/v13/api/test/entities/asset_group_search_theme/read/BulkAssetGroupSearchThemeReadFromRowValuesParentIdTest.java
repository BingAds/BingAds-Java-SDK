...
public class BulkAssetGroupSearchThemeReadFromRowValuesParentIdTest extends BulkAssetGroupSearchThemeTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkAssetGroupSearchTheme, Long>() {
            @Override
