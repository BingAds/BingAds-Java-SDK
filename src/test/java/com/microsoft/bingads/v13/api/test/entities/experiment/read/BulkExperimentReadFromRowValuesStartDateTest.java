...
public class BulkExperimentReadFromRowValuesStartDateTest extends BulkExperimentTest {
    ...
    public void testRead() {
        this.<Date>testReadProperty("Start Date", this.datum, this.expectedResult, new Function<BulkExperiment, Date>() {
            @Override
            public Date apply(BulkExperiment c) {
                return c.getExperiment().getStartDate();
            }
        }, new DateComparer());
    }
}
