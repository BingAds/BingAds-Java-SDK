...
public class BulkSharedNegativeSiteReadFromRowValuesIdTest extends BulkSharedNegativeSiteTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkSharedNegativeSite, Long>() {
            @Override
