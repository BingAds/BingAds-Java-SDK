...
public class BulkSitelinkAdExtensionWriteToRowValuesFinalMobileUrlsTest extends BulkSitelinkAdExtensionTest {
    ...
    public void testWrite() {
        this.<ArrayOfstring>testWriteProperty("Mobile Final Url", this.datum, this.propertyValue, new BiConsumer<BulkSitelinkAdExtension, ArrayOfstring>() {
            @Override
            public void accept(BulkSitelinkAdExtension c, ArrayOfstring v) {
                c.getSitelinkAdExtension().setFinalMobileUrls(v);
            }
        });
    }
}
