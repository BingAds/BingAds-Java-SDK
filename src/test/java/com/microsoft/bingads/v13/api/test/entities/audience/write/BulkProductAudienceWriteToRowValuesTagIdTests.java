...
public class BulkProductAudienceWriteToRowValuesTagIdTests extends BulkProductAudienceTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("UET Tag Id", this.datum, this.propertyValue, new BiConsumer<BulkProductAudience, Long>() {
            @Override
            public void accept(BulkProductAudience c, Long v) {
                c.getProductAudience().setTagId(v);
            }
        });
    }
}
