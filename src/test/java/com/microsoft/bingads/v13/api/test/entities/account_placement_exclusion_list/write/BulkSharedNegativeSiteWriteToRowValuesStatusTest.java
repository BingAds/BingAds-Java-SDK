...
public class BulkSharedNegativeSiteWriteToRowValuesStatusTest extends BulkSharedNegativeSiteTest {
    ...
    public void testWrite() {
        this.<Status>testWriteProperty("Status", this.datum, this.propertyValue, new BiConsumer<BulkSharedNegativeSite, Status>() {
            @Override
            public void accept(BulkSharedNegativeSite c, Status v) {
                c.setStatus(v);
            }
        });
    }
