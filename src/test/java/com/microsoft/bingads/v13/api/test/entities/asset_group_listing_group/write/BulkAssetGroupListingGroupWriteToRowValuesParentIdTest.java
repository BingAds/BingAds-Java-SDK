...
public class BulkAssetGroupListingGroupWriteToRowValuesParentIdTest extends BulkAssetGroupListingGroupTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Parent Id", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroupListingGroup, Long>() {
            @Override
            public void accept(BulkAssetGroupListingGroup c, Long v) {
                c.getAssetGroupListingGroup().setAssetGroupId(v);
            }
        });
    }
}
