...
public class BulkFeedItemReadFromRowValuesTargetTest extends BulkFeedItemTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Target", this.datum, this.expectedResult, new Function<BulkFeedItem, Long>() {
            @Override
