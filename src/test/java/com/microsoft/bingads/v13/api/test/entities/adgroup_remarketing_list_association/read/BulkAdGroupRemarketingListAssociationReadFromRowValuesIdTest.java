...
public class BulkAdGroupRemarketingListAssociationReadFromRowValuesIdTest extends BulkAdGroupRemarketingListAssociationTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkAdGroupRemarketingListAssociation, Long>() {
            @Override
