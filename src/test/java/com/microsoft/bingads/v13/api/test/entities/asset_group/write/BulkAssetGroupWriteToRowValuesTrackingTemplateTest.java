...
public class BulkAssetGroupWriteToRowValuesTrackingTemplateTest extends BulkAssetGroupTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Tracking Template", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroup, String>() {
            @Override
            public void accept(BulkAssetGroup c, String v) {
                c.getAssetGroup().setTrackingUrlTemplate(v);
            }
        });
    }
}
