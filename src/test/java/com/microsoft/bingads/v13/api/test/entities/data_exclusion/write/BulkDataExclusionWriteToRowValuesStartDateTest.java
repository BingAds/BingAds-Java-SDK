...
public class BulkDataExclusionWriteToRowValuesStartDateTest extends BulkDataExclusionTest {
    ...
    public void testWrite() {
        this.<Calendar>testWriteProperty("Start Date", this.datum, this.propertyValue, new BiConsumer<BulkDataExclusion, Calendar>() {
            @Override
            public void accept(BulkDataExclusion c, Calendar v) {
                c.getDataExclusion().setStartDate(v);
            }
        });
    }
}
