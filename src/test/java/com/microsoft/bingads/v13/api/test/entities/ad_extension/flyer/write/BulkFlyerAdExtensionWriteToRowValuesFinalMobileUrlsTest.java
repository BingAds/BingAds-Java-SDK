...
public class BulkFlyerAdExtensionWriteToRowValuesFinalMobileUrlsTest extends BulkFlyerAdExtensionTest {
    ...
    public void testWrite() {
        this.<ArrayOfstring>testWriteProperty("Mobile Final Url", this.datum, this.propertyValue, new BiConsumer<BulkFlyerAdExtension, ArrayOfstring>() {
            @Override
            public void accept(BulkFlyerAdExtension c, ArrayOfstring v) {
                c.getFlyerAdExtension().setFinalMobileUrls(v);
            }
        });
    }
}
