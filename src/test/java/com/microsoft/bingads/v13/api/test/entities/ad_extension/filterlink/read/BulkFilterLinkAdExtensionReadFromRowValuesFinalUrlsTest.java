...
public class BulkFilterLinkAdExtensionReadFromRowValuesFinalUrlsTest extends BulkFilterLinkAdExtensionTest{
	...
	public void testRead() {
		this.<ArrayOfstring>testReadProperty("Final Url", this.datum, this.expectedResult, new Function<BulkFilterLinkAdExtension, ArrayOfstring>() {
			@Override
			public ArrayOfstring apply(BulkFilterLinkAdExtension c) {
				return c.getFilterLinkAdExtension().getFinalUrls();
			}
