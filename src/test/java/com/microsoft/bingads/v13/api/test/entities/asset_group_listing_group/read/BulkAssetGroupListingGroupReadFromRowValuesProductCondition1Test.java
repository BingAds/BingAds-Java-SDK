...
public class BulkAssetGroupListingGroupReadFromRowValuesProductCondition1Test extends BulkAssetGroupListingGroupTest {
        ...
        testReadProperty(
                ...
                new Function<BulkAssetGroupListingGroup, String>() {
                    ...
                    public String apply(BulkAssetGroupListingGroup c) {
                        return c.getAssetGroupListingGroup().getDimension().getOperand();
                    }
                }
        );
    }
