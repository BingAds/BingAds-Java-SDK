...
public class BulkAssetGroupWriteToRowValuesPath2Test extends BulkAssetGroupTest {
    ...
    public void testWrite() {
        this.testWriteProperty("Path 2", this.datum, this.expectedResult, new BiConsumer<BulkAssetGroup, String>() {
            @Override
            public void accept(BulkAssetGroup c, String v) {
                c.getAssetGroup().setPath2(v);
            }
        });
    }
}
