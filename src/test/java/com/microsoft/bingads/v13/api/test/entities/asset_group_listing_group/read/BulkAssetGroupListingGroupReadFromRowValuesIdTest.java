...
public class BulkAssetGroupListingGroupReadFromRowValuesIdTest extends BulkAssetGroupListingGroupTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkAssetGroupListingGroup, Long>() {
            @Override
