...
public class BulkSharedSiteReadFromRowValuesParentIdTest extends BulkSharedSiteTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkSharedSite, Long>() {
            @Override
