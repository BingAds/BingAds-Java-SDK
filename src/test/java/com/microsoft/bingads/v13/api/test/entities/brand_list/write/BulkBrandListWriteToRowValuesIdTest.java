...
public class BulkBrandListWriteToRowValuesIdTest extends BulkBrandListTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Id", this.datum, this.propertyValue, new BiConsumer<BulkBrandList, Long>() {
            @Override
            public void accept(BulkBrandList c, Long v) {
                c.getBrandList().setId(v);
            }
        });
    }
}
