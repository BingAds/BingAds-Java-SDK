...
public class BulkImageAdExtensionReadFromRowValuesFinalMobileUrlsTest extends BulkImageAdExtensionTest{
	...
	public void testRead() {
		this.<ArrayOfstring>testReadProperty("Mobile Final Url", this.datum, this.expectedResult, new Function<BulkImageAdExtension, ArrayOfstring>() {
			@Override
			public ArrayOfstring apply(BulkImageAdExtension c) {
				return c.getImageAdExtension().getFinalMobileUrls();
			}
