...
public class BulkFlyerAdExtensionReadFromRowValuesStoreIdTest extends BulkFlyerAdExtensionTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Store Id", this.datum, this.expectedResult, new Function<BulkFlyerAdExtension, Long>() {
            @Override
