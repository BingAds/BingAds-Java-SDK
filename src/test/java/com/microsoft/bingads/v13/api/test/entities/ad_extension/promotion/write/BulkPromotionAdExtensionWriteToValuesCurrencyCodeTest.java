...
public class BulkPromotionAdExtensionWriteToValuesCurrencyCodeTest extends BulkPromotionAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Currency Code", this.datum, this.propertyValue, new BiConsumer<BulkPromotionAdExtension, String>() {
            @Override
            public void accept(BulkPromotionAdExtension c, String v) {
                c.getPromotionAdExtension().setCurrencyCode(v);
            }
        });
    }
}
