...
public class BulkAssetGroupWriteToRowValuesBusinessNameTest extends BulkAssetGroupTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Business Name", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroup, String>() {
            @Override
