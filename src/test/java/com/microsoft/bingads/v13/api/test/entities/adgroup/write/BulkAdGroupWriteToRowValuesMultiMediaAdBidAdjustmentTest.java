...
public class BulkAdGroupWriteToRowValuesMultiMediaAdBidAdjustmentTest extends BulkAdGroupTest {
    ...
    public void testWrite() {
        testWriteProperty("MultiMediaAdBidAdjustment", this.datum, this.propertyValue, new BiConsumer<BulkAdGroup, Integer>() {
            @Override
            public void accept(BulkAdGroup c, Integer v) {
                c.getAdGroup().setMultimediaAdsBidAdjustment(v);
            }
        });
    }
}
