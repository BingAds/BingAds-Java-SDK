...
public class BulkVideoWriteToRowValuesUrlTest extends BulkVideoTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Url", this.datum, this.propertyValue, new BiConsumer<BulkVideo, String>() {
            @Override
