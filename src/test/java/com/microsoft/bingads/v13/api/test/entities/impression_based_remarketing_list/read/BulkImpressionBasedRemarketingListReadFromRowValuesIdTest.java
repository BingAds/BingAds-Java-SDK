...
public class BulkImpressionBasedRemarketingListReadFromRowValuesIdTest extends BulkImpressionBasedRemarketingListTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkImpressionBasedRemarketingList, Long>() {
            @Override
            public Long apply(BulkImpressionBasedRemarketingList c) {
                return c.getImpressionBasedRemarketingList().getId();
            }
        });
    }
}
