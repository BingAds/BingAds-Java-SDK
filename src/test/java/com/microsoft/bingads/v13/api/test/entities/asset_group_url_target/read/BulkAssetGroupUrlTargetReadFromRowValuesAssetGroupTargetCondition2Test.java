...
public class BulkAssetGroupUrlTargetReadFromRowValuesAssetGroupTargetCondition2Test extends BulkAssetGroupUrlTargetTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Asset Group Target Condition 2", this.datum, this.expectedResult, new Function<BulkAssetGroupUrlTarget, String>() {
            @Override
