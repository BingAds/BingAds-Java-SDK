...
public class BulkAudienceGroupAssetGroupAssociationWriteToRowValuesAssetGroupTest extends BulkAudienceGroupAssetGroupAssociationTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Asset Group", this.datum, this.propertyValue, new BiConsumer<BulkAudienceGroupAssetGroupAssociation, String>() {
            @Override
