...
public class BulkVideoAdExtensionReadFromRowValuesThumbnailIdTest extends BulkVideoAdExtensionTest {
    ...
    public void testRead() {
        this.testReadProperty("Thumbnail Id", this.datum, this.expectedResult, new Function<BulkVideoAdExtension, Long>() {
            @Override
            public Long apply(BulkVideoAdExtension c) {
                return c.getVideoAdExtension().getThumbnailId();
            }
        });
    }
}
