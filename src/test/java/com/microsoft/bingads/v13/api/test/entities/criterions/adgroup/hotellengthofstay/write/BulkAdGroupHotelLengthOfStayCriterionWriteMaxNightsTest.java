...
public class BulkAdGroupHotelLengthOfStayCriterionWriteMaxNightsTest extends BulkAdGroupHotelLengthOfStayCriterionTest {
        ...
        testWriteProperty(
                ...
                new BiConsumer<BulkAdGroupHotelLengthOfStayCriterion, Integer>() {
                    ...
                    public void accept(BulkAdGroupHotelLengthOfStayCriterion c, Integer v) {
                        ((HotelLengthOfStayCriterion)c.getBiddableAdGroupCriterion().getCriterion()).setMaxNights(v);
                    }
                }
        );
    }
