...
public class BulkDisclaimerAdExtensionReadFromRowValuesLineTextTest extends BulkDisclaimerAdExtensionTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Disclaimer Line Text", this.datum, this.expectedResult, new Function<BulkDisclaimerAdExtension, String>() {
            @Override
            public String apply(BulkDisclaimerAdExtension c) {
                return c.getDisclaimerAdExtension().getLineText();
            }
        });
    }
}
