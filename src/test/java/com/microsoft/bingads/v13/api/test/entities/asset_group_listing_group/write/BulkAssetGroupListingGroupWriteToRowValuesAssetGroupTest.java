...
public class BulkAssetGroupListingGroupWriteToRowValuesAssetGroupTest extends BulkAssetGroupListingGroupTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Asset Group", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroupListingGroup, String>() {
            @Override
