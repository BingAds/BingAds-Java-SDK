...
public class BulkAssetGroupUrlTargetWriteToRowValuesAssetGroupTargetConditionOperator2Test extends BulkAssetGroupUrlTargetTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Asset Group Target Condition Operator 2", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroupUrlTarget, String>() {
            @Override
