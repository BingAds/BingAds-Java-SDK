...
public class BulkBrandListReadFromRowValuesIdTest extends BulkBrandListTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkBrandList, Long>() {
            @Override
