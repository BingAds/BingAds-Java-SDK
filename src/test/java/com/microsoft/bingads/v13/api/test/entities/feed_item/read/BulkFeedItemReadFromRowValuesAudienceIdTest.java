...
public class BulkFeedItemReadFromRowValuesAudienceIdTest extends BulkFeedItemTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Audience Id", this.datum, this.expectedResult, new Function<BulkFeedItem, Long>() {
            @Override
