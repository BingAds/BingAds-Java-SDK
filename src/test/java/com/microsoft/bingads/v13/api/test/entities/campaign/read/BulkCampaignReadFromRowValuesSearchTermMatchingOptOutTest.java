...
public class BulkCampaignReadFromRowValuesSearchTermMatchingOptOutTest extends BulkCampaignTest {

    @Parameterized.Parameter(value = 1)
    public String searchTermMatchingOptOut;
    ...
    public static Collection<Object[]> data() {
        ...
        setting1.setSearchTermMatchingOptOut(true);
    ...
    public void testRead() {
        ...
        values.put("AI Search Enabled", "true");
        values.put("Search Term Matching Opt Out", searchTermMatchingOptOut);
