...
public class BulkAdGroupSimilarRemarketingListAssociationReadAdGroupNameTest extends BulkAdGroupSimilarRemarketingListAssociationTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Ad Group", this.datum, this.expectedResult, new Function<BulkAdGroupSimilarRemarketingListAssociation, String>() {
            @Override
