...
public class BulkEventGoalWriteToRowValuesConversionWindowInMinutesTest extends BulkEventGoalTest {
    ...
    public void testWrite() {
        this.<Integer>testWriteProperty("Conversion Window In Minutes", this.datum, this.propertyValue, new BiConsumer<BulkEventGoal, Integer>() {
            @Override
            public void accept(BulkEventGoal c, Integer v) {
                c.getEventGoal().setConversionWindowInMinutes(v);
            }
        });
    }
}
