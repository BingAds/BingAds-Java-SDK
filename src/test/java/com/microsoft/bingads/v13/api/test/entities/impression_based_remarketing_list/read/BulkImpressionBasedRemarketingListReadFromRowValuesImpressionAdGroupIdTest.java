...
public class BulkImpressionBasedRemarketingListReadFromRowValuesImpressionAdGroupIdTest extends BulkImpressionBasedRemarketingListTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Impression Ad Group Id", this.datum, this.expectedResult, new Function<BulkImpressionBasedRemarketingList, Long>() {
            @Override
