...
public class BulkResponsiveAdReadFromRowValuesLongHeadlinesTest extends BulkResponsiveAdTest {
    ...
    public void testRead() {
        this.testReadProperty("Long Headlines", this.datum, this.expectedResult, new Function<BulkResponsiveAd, String>() {
            @Override
            public String apply(BulkResponsiveAd c) {
                return StringExtensions.toTextAssetLinksBulkString(c.getResponsiveAd().getLongHeadlines());
            }
        });
    }
}
