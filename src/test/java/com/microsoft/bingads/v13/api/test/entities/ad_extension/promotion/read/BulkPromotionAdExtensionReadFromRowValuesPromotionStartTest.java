...
public class BulkPromotionAdExtensionReadFromRowValuesPromotionStartTest extends BulkPromotionAdExtensionTest {
    ...
    public void testRead() {         	
    	this.<Date>testReadProperty("Promotion Start", this.datum, this.expectedResult, new Function<BulkPromotionAdExtension, Date>() {
            @Override
            public Date apply(BulkPromotionAdExtension c) {
                return c.getPromotionAdExtension().getPromotionStartDate();
            }
