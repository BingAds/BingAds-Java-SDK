...
public class BulkDisclaimerAdExtensionWriteToValuesFinalMobileUrlsTest extends BulkDisclaimerAdExtensionTest {
    ...
    public void testWrite() {
        this.<ArrayOfstring>testWriteProperty("Mobile Final Url", this.datum, this.propertyValue, new BiConsumer<BulkDisclaimerAdExtension, ArrayOfstring>() {
            @Override
            public void accept(BulkDisclaimerAdExtension c, ArrayOfstring v) {
                c.getDisclaimerAdExtension().setFinalMobileUrls(v);
            }
        });
    }
}
