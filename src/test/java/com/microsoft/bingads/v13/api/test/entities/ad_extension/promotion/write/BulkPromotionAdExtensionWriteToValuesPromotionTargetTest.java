...
public class BulkPromotionAdExtensionWriteToValuesPromotionTargetTest extends BulkPromotionAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Promotion Target", this.datum, this.propertyValue, new BiConsumer<BulkPromotionAdExtension, String>() {
            @Override
            public void accept(BulkPromotionAdExtension c, String v) {
                c.getPromotionAdExtension().setPromotionItem(v);
            }
        });
    }
}
