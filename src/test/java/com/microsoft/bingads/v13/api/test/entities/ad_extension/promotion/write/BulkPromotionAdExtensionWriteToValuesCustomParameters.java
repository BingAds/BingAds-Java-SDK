...
public class BulkPromotionAdExtensionWriteToValuesCustomParameters extends BulkPromotionAdExtensionTest {
    ...
    public void testWrite() {
        this.<CustomParameters>testWriteProperty("Custom Parameter", this.datum, this.propertyValue, new BiConsumer<BulkPromotionAdExtension, CustomParameters>() {
            @Override
            public void accept(BulkPromotionAdExtension c, CustomParameters v) {
                c.getPromotionAdExtension().setUrlCustomParameters(v);;
            }
        });
