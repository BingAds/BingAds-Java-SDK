...
public class BulkOfflineConversionWriteToRowValueHashedPhoneNumberTest extends BulkOfflineConversionTest {
    ...
    public void testRead() {
        this.<String>testWriteProperty("Hashed Phone Number", this.datum, this.expectedResult, new BiConsumer<BulkOfflineConversion, String>() {
            @Override
