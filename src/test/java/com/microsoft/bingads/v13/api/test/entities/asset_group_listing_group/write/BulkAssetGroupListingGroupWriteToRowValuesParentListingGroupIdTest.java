...
public class BulkAssetGroupListingGroupWriteToRowValuesParentListingGroupIdTest extends BulkAssetGroupListingGroupTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Parent Listing Group Id", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroupListingGroup, Long>() {
            @Override
            public void accept(BulkAssetGroupListingGroup c, Long v) {
                c.getAssetGroupListingGroup().setParentListingGroupId(v);
            }
        });
    }
}
