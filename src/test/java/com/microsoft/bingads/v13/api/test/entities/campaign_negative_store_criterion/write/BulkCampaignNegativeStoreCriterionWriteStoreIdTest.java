...
public class BulkCampaignNegativeStoreCriterionWriteStoreIdTest extends BulkCampaignNegativeStoreCriterionTest {
        ...
        testWriteProperty(
                ...
                new BiConsumer<BulkCampaignNegativeStoreCriterion, Long>() {
                    ...
                    public void accept(BulkCampaignNegativeStoreCriterion c, Long v) {
                        ((StoreCriterion)c.getNegativeCampaignCriterion().getCriterion()).setStoreId(v);
                    }
                }
        );
    }
