...
public class BulkFeedReadFromRowValuesNameTest extends BulkFeedTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Feed Name", this.datum, this.expectedResult, new Function<BulkFeed, String>() {
            @Override
