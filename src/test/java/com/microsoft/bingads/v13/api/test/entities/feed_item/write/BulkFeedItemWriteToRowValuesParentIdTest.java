...
public class BulkFeedItemWriteToRowValuesParentIdTest extends BulkFeedItemTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Parent Id", this.datum, this.propertyValue, new BiConsumer<BulkFeedItem, Long>() {
            @Override
