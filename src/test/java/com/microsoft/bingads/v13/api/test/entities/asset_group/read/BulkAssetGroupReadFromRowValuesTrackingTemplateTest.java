...
public class BulkAssetGroupReadFromRowValuesTrackingTemplateTest extends BulkAssetGroupTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Tracking Template", this.datum, this.expectedResult, new Function<BulkAssetGroup, String>() {
            @Override
            public String apply(BulkAssetGroup c) {
                return c.getAssetGroup().getTrackingUrlTemplate();
            }
        });
    }
}
