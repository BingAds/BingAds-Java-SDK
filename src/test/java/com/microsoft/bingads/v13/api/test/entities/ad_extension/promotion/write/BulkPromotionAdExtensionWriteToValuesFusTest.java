...
public class BulkPromotionAdExtensionWriteToValuesFusTest extends BulkPromotionAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Final Url Suffix", this.datum, this.propertyValue, new BiConsumer<BulkPromotionAdExtension, String>() {
            @Override
            public void accept(BulkPromotionAdExtension c, String v) {
                c.getPromotionAdExtension().setFinalUrlSuffix(v);
            }
        });
    }
}
