...
public class BulkVideoAdExtensionWriteToRowValuesDisplayTextTest extends BulkVideoAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Display Text", this.datum, this.propertyValue, new BiConsumer<BulkVideoAdExtension, String>() {
            @Override
            public void accept(BulkVideoAdExtension c, String v) {
                c.getVideoAdExtension().setDisplayText(v);
            }
        });
    }
}
