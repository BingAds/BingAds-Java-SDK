...
public class BulkVideoAdExtensionReadFromRowValuesIdTest extends BulkVideoAdExtensionTest {
    ...
    public void testRead() {
        this.testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkVideoAdExtension, Long>() {
            @Override
            public Long apply(BulkVideoAdExtension c) {
                return c.getVideoAdExtension().getId();
            }
        });
    }
}
