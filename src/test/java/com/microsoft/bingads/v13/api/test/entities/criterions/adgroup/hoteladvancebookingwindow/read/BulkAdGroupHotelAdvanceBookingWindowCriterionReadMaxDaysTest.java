...
public class BulkAdGroupHotelAdvanceBookingWindowCriterionReadMaxDaysTest extends BulkAdGroupHotelAdvanceBookingWindowCriterionTest {
    ...
    public void testRead() {
        testReadProperty("Max Target Value", datum, expectedResult, new Function<BulkAdGroupHotelAdvanceBookingWindowCriterion, Integer>() {
            @Override
            public Integer apply(BulkAdGroupHotelAdvanceBookingWindowCriterion c) {
                return ((HotelAdvanceBookingWindowCriterion) c.getBiddableAdGroupCriterion().getCriterion()).getMaxDays();
            }
        });
    }
}
