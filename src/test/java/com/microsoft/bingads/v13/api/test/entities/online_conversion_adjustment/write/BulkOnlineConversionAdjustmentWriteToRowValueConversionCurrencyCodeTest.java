...
public class BulkOnlineConversionAdjustmentWriteToRowValueConversionCurrencyCodeTest extends BulkOnlineConversionAdjustmentTest {
    ...
    public void testRead() {
        this.<String>testWriteProperty("Conversion Currency Code", this.datum, this.expectedResult, new BiConsumer<BulkOnlineConversionAdjustment, String>() {
            @Override
