...
public class BulkPromotionAdExtensionReadFromRowValuesFinalUrlTest extends BulkPromotionAdExtensionTest {
    ...
    public void testRead() {
        this.<ArrayOfstring>testReadProperty("Final Url", this.datum, this.expectedResult, new Function<BulkPromotionAdExtension, ArrayOfstring>() {
            @Override
            public ArrayOfstring apply(BulkPromotionAdExtension c) {
                return c.getPromotionAdExtension().getFinalUrls();
            }
