...
public class BulkImageReadFromRowValuesSubTypeTest extends BulkImageTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Sub Type", this.datum, this.expectedResult, new Function<BulkImage, String>() {
            @Override
