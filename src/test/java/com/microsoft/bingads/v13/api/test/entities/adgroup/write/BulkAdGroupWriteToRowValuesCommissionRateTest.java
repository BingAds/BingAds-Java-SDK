...
public class BulkAdGroupWriteToRowValuesCommissionRateTest extends BulkAdGroupTest {
    ...
    public void testWrite() {
        this.<RateBid>testWriteProperty("Commission Rate", this.datum, this.propertyValue, new BiConsumer<BulkAdGroup, RateBid>() {
            @Override
            public void accept(BulkAdGroup c, RateBid v) {
                c.getAdGroup().setCommissionRate(v);
            }
        });
    }
}
