...
public class BulkBidStrategyReadFromRowValuesIdTest extends BulkBidStrategyTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkBidStrategy, Long>() {
            @Override
            public Long apply(BulkBidStrategy c) {
                return c.getBidStrategy().getId();
            }
        });
    }
}
