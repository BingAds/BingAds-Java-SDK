...
public class BulkEventGoalReadFromRowValuesRevenueValueTest extends BulkEventGoalTest {
    ...
    public void testRead() {
        this.<BigDecimal>testReadProperty("Revenue Value", this.datum, this.expectedResult, new Function<BulkEventGoal, BigDecimal>() {
            @Override
            public BigDecimal apply(BulkEventGoal c) {
            	return c.getEventGoal().getRevenue() != null ? c.getEventGoal().getRevenue().getValue() : null;
            }
        });
    }
}
