...
public class BulkOfflineConversionReadFromRowValueAdjustmentTimeTest extends BulkOfflineConversionTest {
    ...
    public void testRead() {
        this.<Calendar>testReadProperty("Adjustment Time", this.datum, this.expectedResult, new Function<BulkOfflineConversion, Calendar>() {
            @Override
            public Calendar apply(BulkOfflineConversion c) {
                return c.getAdjustmentTime();
            }
        });
    }
}
