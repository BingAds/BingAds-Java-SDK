...
public class BulkEventGoalReadFromRowValuesCategoryOperatorTest extends BulkEventGoalTest {
    ...
    public void testRead() {
        this.<ExpressionOperator>testReadProperty("Category Operator", this.datum, this.expectedResult, new Function<BulkEventGoal, ExpressionOperator>() {
            @Override
            public ExpressionOperator apply(BulkEventGoal c) {
                return c.getEventGoal().getCategoryOperator();
            }
        });
    }
}
