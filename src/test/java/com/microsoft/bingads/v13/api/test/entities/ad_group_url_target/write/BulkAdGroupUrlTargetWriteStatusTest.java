...
public class BulkAdGroupUrlTargetWriteStatusTest extends BulkAdGroupUrlTargetTest {
    ...
    public void testWrite() {
        testWriteProperty(
                ...
                datum,
                propertyValue,
                new BiConsumer<BulkAdGroupUrlTarget, AdGroupCriterionStatus>() {
                    @Override
                    public void accept(BulkAdGroupUrlTarget c, AdGroupCriterionStatus v) {
