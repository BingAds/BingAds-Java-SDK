...
public class BulkFeedItemReadFromRowValuesAdGroupTest extends BulkFeedItemTest {
    ...
    public void testRead() {
        this.testReadProperty("Ad Group", this.datum, this.expectedResult, new Function<BulkFeedItem, String>() {
            @Override
