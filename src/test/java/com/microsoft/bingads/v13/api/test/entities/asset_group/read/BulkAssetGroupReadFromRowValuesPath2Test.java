...
public class BulkAssetGroupReadFromRowValuesPath2Test extends BulkAssetGroupTest {
    ...
    public void testRead() {
        this.testReadProperty("Path 2", this.datum, this.expectedResult, new Function<BulkAssetGroup, String>() {
            @Override
            public String apply(BulkAssetGroup c) {
                return c.getAssetGroup().getPath2();
            }
        });
    }
}
