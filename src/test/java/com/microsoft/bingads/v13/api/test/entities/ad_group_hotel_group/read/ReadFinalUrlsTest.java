...
public class ReadFinalUrlsTest extends BulkAdGroupHotelListingGroupTest{
        ...
        testReadProperty(
                ...
                new Function<BulkAdGroupHotelListingGroup, ArrayOfstring>() {
                    ...
                    public ArrayOfstring apply(BulkAdGroupHotelListingGroup c) {
                        return ((BiddableAdGroupCriterion) c.getAdGroupCriterion()).getFinalUrls();
                    }
