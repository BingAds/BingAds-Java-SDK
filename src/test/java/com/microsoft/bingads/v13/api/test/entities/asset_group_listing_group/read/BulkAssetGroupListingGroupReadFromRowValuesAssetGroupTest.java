...
public class BulkAssetGroupListingGroupReadFromRowValuesAssetGroupTest extends BulkAssetGroupListingGroupTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Asset Group", this.datum, this.expectedResult, new Function<BulkAssetGroupListingGroup, String>() {
            @Override
