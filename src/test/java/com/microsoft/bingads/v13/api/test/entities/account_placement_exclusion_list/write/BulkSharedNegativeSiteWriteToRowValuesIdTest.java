...
public class BulkSharedNegativeSiteWriteToRowValuesIdTest extends BulkSharedNegativeSiteTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Id", this.datum, this.propertyValue, new BiConsumer<BulkSharedNegativeSite, Long>() {
            @Override
            public void accept(BulkSharedNegativeSite c, Long v) {
                c.getNegativeSite().setId(v);
            }
        });
    }
}
