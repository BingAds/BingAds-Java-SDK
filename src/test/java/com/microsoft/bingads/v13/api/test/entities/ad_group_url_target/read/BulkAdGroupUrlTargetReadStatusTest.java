...
public class BulkAdGroupUrlTargetReadStatusTest extends BulkAdGroupUrlTargetTest {
    ...
    public void testRead() {
        testReadProperty(
                ...
                datum,
                expectedResult,
                new Function<BulkAdGroupUrlTarget, AdGroupCriterionStatus>() {
                    @Override
                    public AdGroupCriterionStatus apply(BulkAdGroupUrlTarget c) {
