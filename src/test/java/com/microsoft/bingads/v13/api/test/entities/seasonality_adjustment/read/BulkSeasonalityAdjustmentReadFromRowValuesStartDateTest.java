...
public class BulkSeasonalityAdjustmentReadFromRowValuesStartDateTest extends BulkSeasonalityAdjustmentTest {
    ...
    public void testRead() {
        this.<Calendar>testReadProperty("Start Date", this.datum, this.expectedResult, new Function<BulkSeasonalityAdjustment, Calendar>() {
            @Override
            public Calendar apply(BulkSeasonalityAdjustment c) {
                return c.getSeasonalityAdjustment().getStartDate();
            }
        });
    }
}
