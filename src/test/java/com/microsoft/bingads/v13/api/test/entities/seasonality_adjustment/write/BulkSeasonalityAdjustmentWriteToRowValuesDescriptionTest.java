...
public class BulkSeasonalityAdjustmentWriteToRowValuesDescriptionTest extends BulkSeasonalityAdjustmentTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Description", this.datum, this.propertyValue, new BiConsumer<BulkSeasonalityAdjustment, String>() {
            @Override
