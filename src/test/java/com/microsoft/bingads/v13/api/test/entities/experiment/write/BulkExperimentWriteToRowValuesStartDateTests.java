...
public class BulkExperimentWriteToRowValuesStartDateTests extends BulkExperimentTest {
    ...
    public void testWrite() {
        this.<Date>testWriteProperty("Start Date", this.datum, this.propertyValue, new BiConsumer<BulkExperiment, Date>() {
            @Override
            public void accept(BulkExperiment c, Date v) {
                c.getExperiment().setStartDate(v);
            }
        });
    }
}
