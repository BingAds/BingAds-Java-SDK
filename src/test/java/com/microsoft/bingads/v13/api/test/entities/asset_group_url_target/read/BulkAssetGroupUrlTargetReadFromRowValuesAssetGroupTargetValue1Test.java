...
public class BulkAssetGroupUrlTargetReadFromRowValuesAssetGroupTargetValue1Test extends BulkAssetGroupUrlTargetTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Asset Group Target Value 1", this.datum, this.expectedResult, new Function<BulkAssetGroupUrlTarget, String>() {
            @Override
