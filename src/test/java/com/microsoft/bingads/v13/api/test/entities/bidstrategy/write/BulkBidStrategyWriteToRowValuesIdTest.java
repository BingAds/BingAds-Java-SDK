...
public class BulkBidStrategyWriteToRowValuesIdTest extends BulkBidStrategyTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Id", this.datum, this.propertyValue, new BiConsumer<BulkBidStrategy, Long>() {
            @Override
            public void accept(BulkBidStrategy c, Long v) {
                c.getBidStrategy().setId(v);;
            }
        });
    }
}
