...
public class BulkVideoAdExtensionWriteToRowValuesActionTextTest extends BulkVideoAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Action Text", this.datum, this.propertyValue, new BiConsumer<BulkVideoAdExtension, String>() {
            @Override
            public void accept(BulkVideoAdExtension c, String v) {
                c.getVideoAdExtension().setActionText(v);
            }
        });
    }
}
