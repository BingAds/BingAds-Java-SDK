...
public class BulkPromotionAdExtensionWriteToValuesMoneyAmountOffTest extends BulkPromotionAdExtensionTest {
    @Parameter(value = 1)
    ...
    public void testWrite() {
        this.<Double>testWriteProperty("Money Amount Off", this.datum, this.propertyValue, new BiConsumer<BulkPromotionAdExtension, Double>() {
            @Override
            public void accept(BulkPromotionAdExtension c, Double v) {
                c.getPromotionAdExtension().setMoneyAmountOff(v);
            }
        });
    }
}
