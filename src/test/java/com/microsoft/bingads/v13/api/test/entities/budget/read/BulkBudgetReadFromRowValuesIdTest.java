...
public class BulkBudgetReadFromRowValuesIdTest extends BulkBudgetTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkBudget, Long>() {
            @Override
            public Long apply(BulkBudget c) {
                return c.getBudget().getId();
            }
        });
    }
}
