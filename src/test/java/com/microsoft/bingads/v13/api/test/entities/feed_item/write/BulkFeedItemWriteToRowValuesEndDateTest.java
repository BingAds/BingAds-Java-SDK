...
public class BulkFeedItemWriteToRowValuesEndDateTest extends BulkFeedItemTest {
    ...
    public void testWrite() {
        this.<Calendar>testWriteProperty("End Date", this.datum, this.propertyValue, new BiConsumer<BulkFeedItem, Calendar>() {
            @Override
