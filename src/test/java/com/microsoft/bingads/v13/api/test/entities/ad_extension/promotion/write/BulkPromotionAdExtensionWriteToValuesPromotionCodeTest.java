...
public class BulkPromotionAdExtensionWriteToValuesPromotionCodeTest extends BulkPromotionAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Promotion Code", this.datum, this.propertyValue, new BiConsumer<BulkPromotionAdExtension, String>() {
            @Override
            public void accept(BulkPromotionAdExtension c, String v) {
                c.getPromotionAdExtension().setPromotionCode(v);
            }
        });
    }
}
