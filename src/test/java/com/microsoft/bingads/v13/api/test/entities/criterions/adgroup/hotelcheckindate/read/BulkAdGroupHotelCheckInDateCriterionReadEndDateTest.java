...
public class BulkAdGroupHotelCheckInDateCriterionReadEndDateTest extends BulkAdGroupHotelCheckInDateTest {
    ...
    public void testRead() {
        testReadProperty("Max Target Value", datum, expectedResult, new Function<BulkAdGroupHotelCheckInDateCriterion, Calendar>() {
            @Override
            public Calendar apply(BulkAdGroupHotelCheckInDateCriterion c) {
                return ((HotelCheckInDateCriterion) c.getBiddableAdGroupCriterion().getCriterion()).getEndDate();
            }
        });
    }
}
