...
public class BulkAdGroupHotelAdvanceBookingWindowCriterionMaxDaysTest extends BulkAdGroupHotelAdvanceBookingWindowCriterionTest {
        ...
        testWriteProperty(
                ...
                new BiConsumer<BulkAdGroupHotelAdvanceBookingWindowCriterion, Integer>() {
                    ...
                    public void accept(BulkAdGroupHotelAdvanceBookingWindowCriterion c, Integer v) {
                        ((HotelAdvanceBookingWindowCriterion)c.getBiddableAdGroupCriterion().getCriterion()).setMaxDays(v);
                    }
                }
        );
    }
