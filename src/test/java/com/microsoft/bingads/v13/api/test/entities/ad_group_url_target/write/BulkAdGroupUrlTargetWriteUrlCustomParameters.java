...
public class BulkAdGroupUrlTargetWriteUrlCustomParameters extends BulkAdGroupUrlTargetTest {
	@Parameter(value = 1)
    ...
    public void testWrite() {
	    testWriteProperty(
                ...
                datum,
                propertyValue,
                new BiConsumer<BulkAdGroupUrlTarget, CustomParameters>() {
                    @Override
                    public void accept(BulkAdGroupUrlTarget c, CustomParameters v) {
