...
public class BulkFilterLinkAdExtensionWriteToRowValuesFinalMobileUrlsTest extends BulkFilterLinkAdExtensionTest {
    ...
    public void testWrite() {
        this.<ArrayOfstring>testWriteProperty("Mobile Final Url", this.datum, this.propertyValue, new BiConsumer<BulkFilterLinkAdExtension, ArrayOfstring>() {
            @Override
            public void accept(BulkFilterLinkAdExtension c, ArrayOfstring v) {
                c.getFilterLinkAdExtension().setFinalMobileUrls(v);
            }
        });
    }
}
