...
public class BulkFeedItemWriteToRowValuesIdTest extends BulkFeedItemTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Id", this.datum, this.propertyValue, new BiConsumer<BulkFeedItem, Long>() {
            @Override
