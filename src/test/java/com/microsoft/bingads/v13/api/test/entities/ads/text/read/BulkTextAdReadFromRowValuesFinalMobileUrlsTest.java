...
public class BulkTextAdReadFromRowValuesFinalMobileUrlsTest extends BulkTextAdTest{
	...
	public void testRead() {
		this.<ArrayOfstring>testReadProperty("Mobile Final Url", this.datum, this.expectedResult, new Function<BulkTextAd, ArrayOfstring>() {
			@Override
			public ArrayOfstring apply(BulkTextAd c) {
				return c.getTextAd().getFinalMobileUrls();
			}
