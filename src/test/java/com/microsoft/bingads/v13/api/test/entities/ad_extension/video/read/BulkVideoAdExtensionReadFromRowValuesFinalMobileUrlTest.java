...
public class BulkVideoAdExtensionReadFromRowValuesFinalMobileUrlTest extends BulkVideoAdExtensionTest {
    ...
    public void testRead() {
        this.<ArrayOfstring>testReadProperty("Mobile Final Url", this.datum, this.expectedResult, new Function<BulkVideoAdExtension, ArrayOfstring>() {
            @Override
            public ArrayOfstring apply(BulkVideoAdExtension c) {
                return c.getVideoAdExtension().getFinalMobileUrls();
            }
