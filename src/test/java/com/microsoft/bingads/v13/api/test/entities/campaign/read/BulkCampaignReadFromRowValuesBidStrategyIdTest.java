...
public class BulkCampaignReadFromRowValuesBidStrategyIdTest extends BulkCampaignTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Bid Strategy Id", this.datum, this.expectedResult, new Function<BulkCampaign, Long>() {
            @Override
            public Long apply(BulkCampaign c) {
                return c.getCampaign().getBidStrategyId();
            }
        });
    }
}
