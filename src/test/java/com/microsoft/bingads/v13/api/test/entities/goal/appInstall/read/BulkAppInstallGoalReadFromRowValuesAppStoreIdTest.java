...
public class BulkAppInstallGoalReadFromRowValuesAppStoreIdTest extends BulkAppInstallGoalTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("App Id", this.datum, this.expectedResult, new Function<BulkAppInstallGoal, String>() {
            @Override
