...
public class BulkAccountContentNegativeKeywordListWriteToRowValuesStatusTest extends BulkAccountContentNegativeKeywordListTest {
    ...
    public void testWrite() {
        this.<Status>testWriteProperty("Status", this.datum, this.propertyValue, new BiConsumer<BulkAccountContentNegativeKeywordList, Status>() {
            @Override
            public void accept(BulkAccountContentNegativeKeywordList c, Status v) {
                c.setStatus(v);
            }
        });
    }
