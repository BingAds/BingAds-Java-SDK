...
public class BulkFilterLinkAdExtensionWriteToRowValuesFusTest extends BulkFilterLinkAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Final Url Suffix", this.datum, this.propertyValue, new BiConsumer<BulkFilterLinkAdExtension, String>() {
            @Override
            public void accept(BulkFilterLinkAdExtension c, String v) {
                c.getFilterLinkAdExtension().setFinalUrlSuffix(v);
            }
        });
    }
}
