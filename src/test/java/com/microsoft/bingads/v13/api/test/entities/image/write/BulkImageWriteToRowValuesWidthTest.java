...
public class BulkImageWriteToRowValuesWidthTest extends BulkImageTest {
    ...
    public void testWrite() {
        this.<Integer>testWriteProperty("Width", this.datum, this.propertyValue, new BiConsumer<BulkImage, Integer>() {
            @Override
