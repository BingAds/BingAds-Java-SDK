...
public class BulkAssetGroupUrlTargetWriteToRowValuesParentIdTest extends BulkAssetGroupUrlTargetTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Parent Id", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroupUrlTarget, Long>() {
            @Override
