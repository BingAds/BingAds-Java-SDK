...
public class BulkAssetGroupListingGroupReadFromRowValuesParentIdTest extends BulkAssetGroupListingGroupTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkAssetGroupListingGroup, Long>() {
            @Override
