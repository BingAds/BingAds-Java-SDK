...
public class BulkCampaignConversionGoalWriteToRowValuesSubTypeTest extends BulkCampaignConversionGoalTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Sub Type", this.datum, this.propertyValue, new BiConsumer<BulkCampaignConversionGoal, String>() {
            @Override
