...
public class BulkAccountContentNKListAssociationReadFromRowValuesSharedEntityIdTest extends BulkAccountContentNKListAssociationTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkAccountContentNegativeKeywordListAssociation, Long>() {
            @Override
