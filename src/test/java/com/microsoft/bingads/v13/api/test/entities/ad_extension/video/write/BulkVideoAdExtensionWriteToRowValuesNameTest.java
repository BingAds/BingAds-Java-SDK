...
public class BulkVideoAdExtensionWriteToRowValuesNameTest extends BulkVideoAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Name", this.datum, this.expectedResult, new BiConsumer<BulkVideoAdExtension, String>() {
            @Override
            public void accept(BulkVideoAdExtension c, String v) {
                c.getVideoAdExtension().setName(v);
            }
        });
    }
}
