...
public class BulkAccountProfileExpansionEnabledTest extends BulkAccountTest {
    ...
    public void testRead() {
        this.<Boolean>testReadProperty("Profile Expansion Enabled", this.datum, this.expectedResult, new Function<BulkAccount, Boolean>() {
            @Override
            public Boolean apply(BulkAccount c) {
                return c.getProfileExpansionEnabled();
            }
        });
    }
}
