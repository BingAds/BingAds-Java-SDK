...
public class BulkImageAdExtensionWriteToRowValuesUrlCustomParameters extends BulkImageAdExtensionTest {
    ...
    public void testWrite() {
        this.<CustomParameters>testWriteProperty("Custom Parameter", this.datum, this.propertyValue, new BiConsumer<BulkImageAdExtension, CustomParameters>() {
            @Override
            public void accept(BulkImageAdExtension c, CustomParameters v) {
                c.getImageAdExtension().setUrlCustomParameters(v);;
            }
        });
