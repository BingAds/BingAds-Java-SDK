...
public class BulkAudienceGroupReadFromRowValuesParentIdTest extends BulkAudienceGroupTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkAudienceGroup, Long>() {
            @Override
