...
public class BulkTopicReadFromRowValuesTopicParentIdTest extends BulkTopicTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Topic Parent Id", this.datum, this.expectedResult, new Function<BulkTopic, Long>() {
            @Override
