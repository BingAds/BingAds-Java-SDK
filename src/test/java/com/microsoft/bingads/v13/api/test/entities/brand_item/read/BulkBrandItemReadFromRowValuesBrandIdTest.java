...
public class BulkBrandItemReadFromRowValuesBrandIdTest extends BulkBrandItemTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Brand Id", this.datum, this.expectedResult, new Function<BulkBrandItem, Long>() {
            @Override
