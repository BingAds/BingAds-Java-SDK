...
public class BulkVideoAdExtensionWriteToRowValuesFinalMobileUrlsTest extends BulkVideoAdExtensionTest {
    ...
    public void testWrite() {
        this.<ArrayOfstring>testWriteProperty("Mobile Final Url", this.datum, this.propertyValue, new BiConsumer<BulkVideoAdExtension, ArrayOfstring>() {
            @Override
            public void accept(BulkVideoAdExtension c, ArrayOfstring v) {
                c.getVideoAdExtension().setFinalMobileUrls(v);
            }
        });
    }
}
