...
public class BulkFlyerAdExtensionWriteToRowValuesAccountIdTest extends BulkFlyerAdExtensionTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Parent Id", this.datum, this.expectedResult, new BiConsumer<BulkFlyerAdExtension, Long>() {
            @Override
