...
public class BulkFeedItemReadFromRowValuesParentIdTest extends BulkFeedItemTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkFeedItem, Long>() {
            @Override
