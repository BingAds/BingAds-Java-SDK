...
public class BulkFeedItemWriteToRowValuesAdGroupTest extends BulkFeedItemTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Ad Group", this.datum, this.propertyValue, new BiConsumer<BulkFeedItem, String>() {
            @Override
