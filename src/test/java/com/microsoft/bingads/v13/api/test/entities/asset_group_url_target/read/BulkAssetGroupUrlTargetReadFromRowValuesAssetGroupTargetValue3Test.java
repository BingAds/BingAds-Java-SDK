...
public class BulkAssetGroupUrlTargetReadFromRowValuesAssetGroupTargetValue3Test extends BulkAssetGroupUrlTargetTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Asset Group Target Value 3", this.datum, this.expectedResult, new Function<BulkAssetGroupUrlTarget, String>() {
            @Override
