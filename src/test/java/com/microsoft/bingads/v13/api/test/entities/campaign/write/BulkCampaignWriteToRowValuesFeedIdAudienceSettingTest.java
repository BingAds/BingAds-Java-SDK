...
public class BulkCampaignWriteToRowValuesFeedIdAudienceSettingTest extends BulkCampaignTest {
        ...
        testWriteProperty(
                ...
                new BiConsumer<BulkCampaign, Long>() {
                    ...
                    public void accept(BulkCampaign c, Long v) {
                        c.getCampaign().setCampaignType(Collections.singletonList(CampaignType.AUDIENCE));

                        c.getCampaign().setSettings(new ArrayOfSetting());

                        DynamicFeedSetting setting = new DynamicFeedSetting();
