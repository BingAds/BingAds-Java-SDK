...
public class BulkPromotionAdExtensionWriteToValuesFinalUrlsTest extends BulkPromotionAdExtensionTest {
    ...
    public void testWrite() {
        this.<ArrayOfstring>testWriteProperty("Final Url", this.datum, this.propertyValue, new BiConsumer<BulkPromotionAdExtension, ArrayOfstring>() {
            @Override
            public void accept(BulkPromotionAdExtension c, ArrayOfstring v) {
                c.getPromotionAdExtension().setFinalUrls(v);
            }
        });
    }
}
