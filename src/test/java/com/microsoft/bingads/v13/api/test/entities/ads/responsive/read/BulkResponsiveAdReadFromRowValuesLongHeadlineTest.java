...
public class BulkResponsiveAdReadFromRowValuesLongHeadlineTest extends BulkResponsiveAdTest {
    ...
    public void testRead() {
        this.testReadProperty("Long Headline", this.datum, this.expectedResult, new Function<BulkResponsiveAd, String>() {
            @Override
            public String apply(BulkResponsiveAd c) {
                return c.getResponsiveAd().getLongHeadlineString();
            }
        });
    }
}
