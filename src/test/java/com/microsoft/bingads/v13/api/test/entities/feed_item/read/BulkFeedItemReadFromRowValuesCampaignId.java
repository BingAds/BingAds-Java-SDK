...
public class BulkFeedItemReadFromRowValuesCampaignId extends BulkFeedItemTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Target Campaign Id", this.datum, this.expectedResult, new Function<BulkFeedItem, String>() {
            @Override
