...
public class BulkAdGroupReadFromRowValuesCpmBidTest extends BulkAdGroupTest {
    ...
    public void testRead() {
        this.<Bid>testReadProperty("Cpm Bid", this.datum, this.expectedResult, new Function<BulkAdGroup, Bid>() {
            @Override
            public Bid apply(BulkAdGroup c) {
                return c.getAdGroup().getCpmBid();
            }
        }, new BidComparer());
    }
}
