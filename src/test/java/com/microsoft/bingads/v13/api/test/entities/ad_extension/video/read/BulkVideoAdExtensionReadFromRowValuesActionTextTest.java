...
public class BulkVideoAdExtensionReadFromRowValuesActionTextTest extends BulkVideoAdExtensionTest {
    ...
    public void testRead() {
        this.testReadProperty("Action Text", this.datum, this.expectedResult, new Function<BulkVideoAdExtension, String>() {
            @Override
            public String apply(BulkVideoAdExtension c) {
                return c.getVideoAdExtension().getActionText();
            }
        });
    }
}
