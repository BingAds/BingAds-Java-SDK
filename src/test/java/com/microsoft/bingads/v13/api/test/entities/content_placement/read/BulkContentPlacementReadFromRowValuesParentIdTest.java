...
public class BulkContentPlacementReadFromRowValuesParentIdTest extends BulkContentPlacementTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkContentPlacement, Long>() {
            @Override
