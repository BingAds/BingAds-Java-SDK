...
public class BulkImageWriteToRowValuesUrlTest extends BulkImageTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Url", this.datum, this.propertyValue, new BiConsumer<BulkImage, String>() {
            @Override
