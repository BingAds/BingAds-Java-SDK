...
public class BulkOfflineConversionWriteToRowValueHashedEmailAddressTest extends BulkOfflineConversionTest {
    ...
    public void testRead() {
        this.<String>testWriteProperty("Hashed Email Address", this.datum, this.expectedResult, new BiConsumer<BulkOfflineConversion, String>() {
            @Override
