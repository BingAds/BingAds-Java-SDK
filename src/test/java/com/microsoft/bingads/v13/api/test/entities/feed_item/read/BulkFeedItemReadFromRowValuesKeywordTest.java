...
public class BulkFeedItemReadFromRowValuesKeywordTest extends BulkFeedItemTest {
    ...
    public void testRead() {
        this.testReadProperty("Keyword", this.datum, this.expectedResult, new Function<BulkFeedItem, String>() {
            @Override
