...
@RunWith(Suite.class)
@SuiteClasses({
	BulkExpandedTextAdReadFromRowValuesFinalMobileUrlsTest.class,
	BulkExpandedTextAdReadFromRowValuesFinalUrlsTest.class,
	BulkExpandedTextAdReadFromRowValuesTrackingTemplateTest.class,
	BulkExpandedTextAdReadFromRowValuesUrlCustomParametersTest.class,
