...
public class BulkImpressionBasedRemarketingListReadFromRowValuesParentIdTest extends BulkImpressionBasedRemarketingListTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkImpressionBasedRemarketingList, Long>() {
            @Override
            public Long apply(BulkImpressionBasedRemarketingList c) {
                return c.getImpressionBasedRemarketingList().getParentId();
            }
        });
    }
}
