...
public class BulkAssetGroupUrlTargetReadFromRowValuesParentIdTest extends BulkAssetGroupUrlTargetTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkAssetGroupUrlTarget, Long>() {
            @Override
