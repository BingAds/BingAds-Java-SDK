...
public class BulkFeedItemReadFromRowValuesIdTest extends BulkFeedItemTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkFeedItem, Long>() {
            @Override
