...
public class BulkImageWriteToRowValuesStatusTest extends BulkImageTest {
    ...
    public void testWrite() {
        this.<Status>testWriteProperty("Status", this.datum, this.propertyValue, new BiConsumer<BulkImage, Status>() {
            @Override
            public void accept(BulkImage c, Status v) {
                c.setStatus(v);
            }
        });
    }
