...
public class BulkAssetGroupUrlTargetWriteToRowValuesAssetGroupTargetConditionOperator1Test extends BulkAssetGroupUrlTargetTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Asset Group Target Condition Operator 1", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroupUrlTarget, String>() {
            @Override
