...
public class BulkOfflineConversionWriteToRowValueAdjustmentTimeTest extends BulkOfflineConversionTest {
    ...
    public void testWrite() {
        this.<Calendar>testWriteProperty("Adjustment Time", this.datum, this.propertyValue, new BiConsumer<BulkOfflineConversion, Calendar>() {
            @Override
            public void accept(BulkOfflineConversion c, Calendar v) {
                c.setAdjustmentTime(v);
            }
        });
    }
}
