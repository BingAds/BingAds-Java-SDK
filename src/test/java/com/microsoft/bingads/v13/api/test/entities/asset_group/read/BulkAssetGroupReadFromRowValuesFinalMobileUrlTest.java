...
public class BulkAssetGroupReadFromRowValuesFinalMobileUrlTest extends BulkAssetGroupTest{
	...
	public void testRead() {
		this.<ArrayOfstring>testReadProperty("Mobile Final Url", this.datum, this.expectedResult, new Function<BulkAssetGroup, ArrayOfstring>() {
			@Override
			public ArrayOfstring apply(BulkAssetGroup c) {
				return c.getAssetGroup().getFinalMobileUrls();
			}
