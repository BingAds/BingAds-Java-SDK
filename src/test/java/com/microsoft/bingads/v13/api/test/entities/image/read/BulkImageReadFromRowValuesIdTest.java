...
public class BulkImageReadFromRowValuesIdTest extends BulkImageTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkImage, Long>() {
            @Override
