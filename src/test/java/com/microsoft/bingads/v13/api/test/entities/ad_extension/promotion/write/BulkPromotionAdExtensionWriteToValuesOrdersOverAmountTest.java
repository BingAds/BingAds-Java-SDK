...
public class BulkPromotionAdExtensionWriteToValuesOrdersOverAmountTest extends BulkPromotionAdExtensionTest {
    @Parameter(value = 1)
    ...
    public void testWrite() {
        this.<Double>testWriteProperty("Orders Over Amount", this.datum, this.propertyValue, new BiConsumer<BulkPromotionAdExtension, Double>() {
            @Override
            public void accept(BulkPromotionAdExtension c, Double v) {
                c.getPromotionAdExtension().setOrdersOverAmount(v);
            }
        });
    }
}
