...
public class BulkSharedSiteWriteToRowValuesIdTest extends BulkSharedSiteTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Id", this.datum, this.propertyValue, new BiConsumer<BulkSharedSite, Long>() {
            @Override
