...
public class BulkAccountPlacementExclusionListAssociationWriteToRowValuesParentIdTest extends BulkAccountPlacementExclusionListAssociationTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Parent Id", this.datum, this.propertyValue, new BiConsumer<BulkAccountPlacementExclusionListAssociation, Long>() {
            @Override
