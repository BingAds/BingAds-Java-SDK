...
public class BulkSeasonalityAdjustmentWriteToRowValuesStartDateTest extends BulkSeasonalityAdjustmentTest {
    ...
    public void testWrite() {
        this.<Calendar>testWriteProperty("Start Date", this.datum, this.propertyValue, new BiConsumer<BulkSeasonalityAdjustment, Calendar>() {
            @Override
            public void accept(BulkSeasonalityAdjustment c, Calendar v) {
                c.getSeasonalityAdjustment().setStartDate(v);
            }
        });
    }
}
