...
public class BulkDisclaimerAdExtensionReadFromRowValuesFinalUrlsTest extends BulkDisclaimerAdExtensionTest {
    ...
    public void testRead() {
        this.<ArrayOfstring>testReadProperty("Final Url", this.datum, this.expectedResult, new Function<BulkDisclaimerAdExtension, ArrayOfstring>() {
            @Override
            public ArrayOfstring apply(BulkDisclaimerAdExtension c) {
                return c.getDisclaimerAdExtension().getFinalUrls();
            }
