...
public class BulkFlyerAdExtensionReadFromRowValuesTrackingTemplateTest extends BulkFlyerAdExtensionTest{
	...
	public void testRead() {
		this.<String>testReadProperty("Tracking Template", this.datum, this.expectedResult, new Function<BulkFlyerAdExtension, String>() {
			@Override
			public String apply(BulkFlyerAdExtension c) {
				return c.getFlyerAdExtension().getTrackingUrlTemplate();
			}
		});
	}
}
