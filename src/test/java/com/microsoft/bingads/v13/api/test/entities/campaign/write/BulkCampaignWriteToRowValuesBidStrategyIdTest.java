...
public class BulkCampaignWriteToRowValuesBidStrategyIdTest extends BulkCampaignTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Bid Strategy Id", this.datum, this.propertyValue, new BiConsumer<BulkCampaign, Long>() {
            @Override
            public void accept(BulkCampaign c, Long v) {
                c.getCampaign().setBidStrategyId(v);;
            }
        });
    }
}
