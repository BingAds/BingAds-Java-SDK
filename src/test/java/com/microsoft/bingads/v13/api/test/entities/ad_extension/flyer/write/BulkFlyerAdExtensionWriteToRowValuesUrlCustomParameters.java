...
public class BulkFlyerAdExtensionWriteToRowValuesUrlCustomParameters extends BulkFlyerAdExtensionTest {
    ...
    public void testWrite() {
        this.<CustomParameters>testWriteProperty("Custom Parameter", this.datum, this.propertyValue, new BiConsumer<BulkFlyerAdExtension, CustomParameters>() {
            @Override
            public void accept(BulkFlyerAdExtension c, CustomParameters v) {
                c.getFlyerAdExtension().setUrlCustomParameters(v);;
            }
        });
