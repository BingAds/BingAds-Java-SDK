...
public class BulkOfflineConversionReadFromRowValueAdjustmentValueTest extends BulkOfflineConversionTest {
    ...
    public void testRead() {
        this.<Double>testReadProperty("Adjustment Value", this.datum, this.expectedResult, new Function<BulkOfflineConversion, Double>() {
            @Override
