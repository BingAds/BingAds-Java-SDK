...
public class BulkAssetGroupUrlTargetWriteToRowValuesAssetGroupTargetCondition3Test extends BulkAssetGroupUrlTargetTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Asset Group Target Condition 3", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroupUrlTarget, String>() {
            @Override
