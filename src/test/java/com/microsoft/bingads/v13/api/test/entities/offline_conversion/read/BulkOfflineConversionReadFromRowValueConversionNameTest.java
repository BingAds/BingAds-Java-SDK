...
public class BulkOfflineConversionReadFromRowValueConversionNameTest extends BulkOfflineConversionTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Conversion Name", this.datum, this.expectedResult, new Function<BulkOfflineConversion, String>() {
            @Override
