...
public class BulkAdGroupReadFromRowValuesPercentCpcBidTest extends BulkAdGroupTest {
    ...
    public void testRead() {
        this.<RateBid>testReadProperty("Percent Cpc Bid", this.datum, this.expectedResult, new Function<BulkAdGroup, RateBid>() {
            @Override
            public RateBid apply(BulkAdGroup c) {
                return c.getAdGroup().getPercentCpcBid();
            }
        }, new RateBidComparer());
    }
}
