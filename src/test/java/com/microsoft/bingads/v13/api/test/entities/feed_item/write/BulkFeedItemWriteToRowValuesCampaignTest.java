...
public class BulkFeedItemWriteToRowValuesCampaignTest extends BulkFeedItemTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Campaign", this.datum, this.propertyValue, new BiConsumer<BulkFeedItem, String>() {
            @Override
