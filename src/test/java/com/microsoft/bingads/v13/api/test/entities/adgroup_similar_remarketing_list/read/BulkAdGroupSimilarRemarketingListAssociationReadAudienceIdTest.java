...
public class BulkAdGroupSimilarRemarketingListAssociationReadAudienceIdTest extends BulkAdGroupSimilarRemarketingListAssociationTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Audience Id", this.datum, this.expectedResult, new Function<BulkAdGroupSimilarRemarketingListAssociation, Long>() {
            @Override
            public Long apply(BulkAdGroupSimilarRemarketingListAssociation c) {
                return ((AudienceCriterion) c.getBiddableAdGroupCriterion().getCriterion()).getAudienceId();
            }
        });
    }
}
