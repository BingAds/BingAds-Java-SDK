...
public class BulkOfflineConversionWriteToRowValueAdjustmentValueTest extends BulkOfflineConversionTest {
    ...
    public void testRead() {
        this.<Double>testWriteProperty("Adjustment Value", this.datum, this.expectedResult, new BiConsumer<BulkOfflineConversion, Double>() {
            @Override
            public void accept(BulkOfflineConversion c, Double v) {
                c.setAdjustmentValue(v);
            }
        });
    }
}
