...
public class BulkFeedItemWriteToRowValuesTargetTest extends BulkFeedItemTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Target", this.datum, this.propertyValue, new BiConsumer<BulkFeedItem, Long>() {
            @Override
