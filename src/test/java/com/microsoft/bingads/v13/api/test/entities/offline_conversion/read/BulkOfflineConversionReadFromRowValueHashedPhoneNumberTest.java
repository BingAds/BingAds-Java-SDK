...
public class BulkOfflineConversionReadFromRowValueHashedPhoneNumberTest extends BulkOfflineConversionTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Hashed Phone Number", this.datum, this.expectedResult, new Function<BulkOfflineConversion, String>() {
            @Override
