...
public class BulkCampaignNegativeAgeCriterionReadParentIdTest extends BulkCampaignNegativeAgeCriterionTest {
    ...
    public void testRead() {
        testReadProperty(
                ...
                datum,
                expectedResult,
                new Function<BulkCampaignNegativeAgeCriterion, Long>() {
                    @Override
                    public Long apply(BulkCampaignNegativeAgeCriterion c) {
