...
public class BulkSeasonalityAdjustmentReadFromRowValuesDescriptionTest extends BulkSeasonalityAdjustmentTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Description", this.datum, this.expectedResult, new Function<BulkSeasonalityAdjustment, String>() {
            @Override
