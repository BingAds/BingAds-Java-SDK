...
public class BulkVideoAdExtensionReadFromRowValuesVideoIdTest extends BulkVideoAdExtensionTest {
    ...
    public void testRead() {
        this.testReadProperty("Video Id", this.datum, this.expectedResult, new Function<BulkVideoAdExtension, Long>() {
            @Override
            public Long apply(BulkVideoAdExtension c) {
                return c.getVideoAdExtension().getVideoId();
            }
        });
    }
}
