...
public class BulkRSAReadFromRowValuesHeadlineTest extends BulkResponsiveSearchAdTest {
    ...
    public void testRead() {
        this.testReadProperty("Headline", this.datum, this.expectedResult, new Function<BulkResponsiveSearchAd, String>() {
            @Override
            public String apply(BulkResponsiveSearchAd c) {
                return StringExtensions.toTextAssetLinksBulkString(c.getResponsiveSearchAd().getHeadlines());
            }
        });
    }
}
