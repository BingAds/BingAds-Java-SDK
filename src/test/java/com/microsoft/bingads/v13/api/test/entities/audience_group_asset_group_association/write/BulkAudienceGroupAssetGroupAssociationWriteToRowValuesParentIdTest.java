...
public class BulkAudienceGroupAssetGroupAssociationWriteToRowValuesParentIdTest extends BulkAudienceGroupAssetGroupAssociationTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Parent Id", this.datum, this.propertyValue, new BiConsumer<BulkAudienceGroupAssetGroupAssociation, Long>() {
            @Override
            public void accept(BulkAudienceGroupAssetGroupAssociation c, Long v) {
                c.getAudienceGroupAssetGroupAssociation().setAssetGroupId(v);
            }
        });
    }
}
