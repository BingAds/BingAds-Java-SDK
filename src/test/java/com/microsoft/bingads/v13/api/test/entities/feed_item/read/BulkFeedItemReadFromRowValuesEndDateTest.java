...
public class BulkFeedItemReadFromRowValuesEndDateTest extends BulkFeedItemTest {
    ...
    public void testRead() {
        this.<Calendar>testReadProperty("End Date", this.datum, this.expectedResult, new Function<BulkFeedItem, Calendar>() {
            @Override
