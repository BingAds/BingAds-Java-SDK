...
public class BulkKeywordReadFromRowValuesTextTest extends BulkKeywordTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Keyword", this.datum, this.expectedResult, new Function<BulkKeyword, String>() {
            @Override
