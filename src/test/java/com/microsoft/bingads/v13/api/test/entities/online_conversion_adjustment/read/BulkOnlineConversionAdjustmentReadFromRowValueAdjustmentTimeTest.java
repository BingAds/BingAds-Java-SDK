...
public class BulkOnlineConversionAdjustmentReadFromRowValueAdjustmentTimeTest extends BulkOnlineConversionAdjustmentTest {
    ...
    public void testRead() {
        this.<Calendar>testReadProperty("Adjustment Time", this.datum, this.expectedResult, new Function<BulkOnlineConversionAdjustment, Calendar>() {
            @Override
            public Calendar apply(BulkOnlineConversionAdjustment c) {
                return c.getOnlineConversionAdjustment().getAdjustmentTime();
            }
        });
    }
}
