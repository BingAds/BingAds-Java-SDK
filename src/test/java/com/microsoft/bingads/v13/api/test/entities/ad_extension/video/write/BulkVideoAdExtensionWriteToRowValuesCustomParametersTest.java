...
public class BulkVideoAdExtensionWriteToRowValuesCustomParametersTest extends BulkVideoAdExtensionTest {
    ...
    public void testWrite() {
        this.<CustomParameters>testWriteProperty("Custom Parameter", this.datum, this.propertyValue, new BiConsumer<BulkVideoAdExtension, CustomParameters>() {
            @Override
            public void accept(BulkVideoAdExtension c, CustomParameters v) {
                c.getVideoAdExtension().setUrlCustomParameters(v);;
            }
        });
