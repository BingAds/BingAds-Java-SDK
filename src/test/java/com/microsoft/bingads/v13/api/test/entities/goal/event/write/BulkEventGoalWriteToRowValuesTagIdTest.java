...
public class BulkEventGoalWriteToRowValuesTagIdTest extends BulkEventGoalTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("UET Tag Id", this.datum, this.propertyValue, new BiConsumer<BulkEventGoal, Long>() {
            @Override
            public void accept(BulkEventGoal c, Long v) {
                c.getEventGoal().setTagId(v);
            }
        });
    }
}
