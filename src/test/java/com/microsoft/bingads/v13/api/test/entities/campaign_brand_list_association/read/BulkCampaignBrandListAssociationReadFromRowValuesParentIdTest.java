...
public class BulkCampaignBrandListAssociationReadFromRowValuesParentIdTest extends BulkCampaignBrandListAssociationTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkCampaignBrandListAssociation, Long>() {
            @Override
