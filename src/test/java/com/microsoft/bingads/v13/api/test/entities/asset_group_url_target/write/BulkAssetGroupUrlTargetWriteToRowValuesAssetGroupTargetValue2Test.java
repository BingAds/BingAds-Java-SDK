...
public class BulkAssetGroupUrlTargetWriteToRowValuesAssetGroupTargetValue2Test extends BulkAssetGroupUrlTargetTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Asset Group Target Value 2", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroupUrlTarget, String>() {
            @Override
