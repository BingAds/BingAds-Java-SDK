...
public class BulkFeedItemWriteToRowValuesAdGroupIdTest extends BulkFeedItemTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Target Ad Group Id", this.datum, this.propertyValue, new BiConsumer<BulkFeedItem, String>() {
            @Override
