...
public class BulkVideoAdExtensionReadFromRowValuesAlternativeTextTest extends BulkVideoAdExtensionTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Alternative Text", this.datum, this.expectedResult, new Function<BulkVideoAdExtension, String>() {
            @Override
            public String apply(BulkVideoAdExtension c) {
                return c.getVideoAdExtension().getAlternativeText();
            }
        });
    }
}
