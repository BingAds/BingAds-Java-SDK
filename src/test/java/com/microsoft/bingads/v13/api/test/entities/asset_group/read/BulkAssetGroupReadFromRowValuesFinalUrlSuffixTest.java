...
public class BulkAssetGroupReadFromRowValuesFinalUrlSuffixTest extends BulkAssetGroupTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Final Url Suffix", this.datum, this.expectedResult, new Function<BulkAssetGroup, String>() {
            @Override
            public String apply(BulkAssetGroup c) {
                return c.getAssetGroup().getFinalUrlSuffix();
            }
        });
    }
}
