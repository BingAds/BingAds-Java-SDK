...
import com.microsoft.bingads.v13.api.test.entities.BidComparer;
...
public class BulkAdGroupReadFromRowValuesCpvBidTest extends BulkAdGroupTest {
    ...
    public void testRead() {
        this.<Bid>testReadProperty("Cpv Bid", this.datum, this.expectedResult, new Function<BulkAdGroup, Bid>() {
            @Override
            public Bid apply(BulkAdGroup c) {
                return c.getAdGroup().getCpvBid();
            }
        }, new BidComparer());
    }
}
