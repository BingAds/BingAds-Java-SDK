...
public class BulkVideoAdExtensionWriteToRowValuesEndDateTest extends BulkVideoAdExtensionTest {
    ...
    public void testWrite() {
    	this.testWriteProperty("End Date", this.datum, this.propertyValue, new BiConsumer<BulkVideoAdExtension, Date>() {
            @Override
            public void accept(BulkVideoAdExtension c, Date v) {
            	c.getVideoAdExtension().setScheduling(new Schedule());
                c.getVideoAdExtension().getScheduling().setEndDate(new Date());
            }
        });
        ...
        this.testWriteProperty("End Date", this.datum, this.propertyValue, new BiConsumer<BulkVideoAdExtension, Date>() {
            ...
            public void accept(BulkVideoAdExtension c, Date v) {
            	c.getVideoAdExtension().setScheduling(new Schedule());
                c.getVideoAdExtension().getScheduling().setEndDate(v);
            }
        });
