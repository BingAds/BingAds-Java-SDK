...
public class BulkBidStrategyReadFromRowValuesTimeZoneTest extends BulkBidStrategyTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Time Zone", this.datum, this.expectedResult, new Function<BulkBidStrategy, String>() {
            @Override
