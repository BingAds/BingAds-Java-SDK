...
public class BulkEventGoalWriteToRowValuesCategoryExpressionTest extends BulkEventGoalTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Category Expression", this.datum, this.propertyValue, new BiConsumer<BulkEventGoal, String>() {
            @Override
