...
public class BulkCampaignWriteToRowValuesBidStrategyNameTest extends BulkCampaignTest {
    ...
    public static Collection<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
            {"Test Bid Strategy  Name 1", "Test Bid Strategy  Name 1"},
            {"", ""},
            {null, null}
        });
    }
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Bid Strategy Name", this.datum, this.propertyValue, new BiConsumer<BulkCampaign, String>() {
            @Override
