...
public class BulkImageAdExtensionReadFromRowValuesTrackingTemplateTest extends BulkImageAdExtensionTest{
	...
	public void testRead() {
		this.<String>testReadProperty("Tracking Template", this.datum, this.expectedResult, new Function<BulkImageAdExtension, String>() {
			@Override
			public String apply(BulkImageAdExtension c) {
				return c.getImageAdExtension().getTrackingUrlTemplate();
			}
		});
	}
}
