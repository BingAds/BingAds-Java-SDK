...
public class BulkCampaignBrandListAssociationWriteToRowValuesParentIdTest extends BulkCampaignBrandListAssociationTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Parent Id", this.datum, this.propertyValue, new BiConsumer<BulkCampaignBrandListAssociation, Long>() {
            @Override
