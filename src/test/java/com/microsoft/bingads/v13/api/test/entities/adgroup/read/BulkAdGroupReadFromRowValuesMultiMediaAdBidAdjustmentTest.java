...
public class BulkAdGroupReadFromRowValuesMultiMediaAdBidAdjustmentTest extends BulkAdGroupTest {
    ...
    public void testRead() {
        testReadProperty("MultiMediaAdBidAdjustment", datum, expectedResult, new Function<BulkAdGroup, Integer>() {
            @Override
