...
public class BulkDisclaimerAdExtensionReadFromRowValuesTitleTest extends BulkDisclaimerAdExtensionTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Disclaimer Title", this.datum, this.expectedResult, new Function<BulkDisclaimerAdExtension, String>() {
            @Override
            public String apply(BulkDisclaimerAdExtension c) {
                return c.getDisclaimerAdExtension().getTitle();
            }
        });
    }
}
