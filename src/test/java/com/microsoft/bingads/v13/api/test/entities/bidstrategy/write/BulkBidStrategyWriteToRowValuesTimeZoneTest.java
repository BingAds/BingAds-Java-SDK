...
public class BulkBidStrategyWriteToRowValuesTimeZoneTest extends BulkBidStrategyTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Time Zone", this.datum, this.propertyValue, new BiConsumer<BulkBidStrategy, String>() {
            @Override
