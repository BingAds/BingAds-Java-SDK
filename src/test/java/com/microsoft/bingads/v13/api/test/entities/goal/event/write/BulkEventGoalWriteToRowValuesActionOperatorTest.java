...
public class BulkEventGoalWriteToRowValuesActionOperatorTest extends BulkEventGoalTest {
    ...
    public void testWrite() {
        this.<ExpressionOperator>testWriteProperty("Action Operator", this.datum, this.propertyValue, new BiConsumer<BulkEventGoal, ExpressionOperator>() {
            @Override
            public void accept(BulkEventGoal c, ExpressionOperator v) {
                c.getEventGoal().setActionOperator(v);
            }
        });
    }
}
