...
public class BulkImpressionBasedRemarketingListWriteToRowValuesImpressionAdGroupIdTest extends BulkImpressionBasedRemarketingListTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Impression Ad Group Id", this.datum, this.propertyValue, new BiConsumer<BulkImpressionBasedRemarketingList, Long>() {
            @Override
            public void accept(BulkImpressionBasedRemarketingList c, Long v) {
                c.getImpressionBasedRemarketingList().setAdGroupId(v);
            }
        });
    }
}
