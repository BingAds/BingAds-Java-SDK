...
public class BulkAccountProfileExpansionEnabledTest extends BulkAccountTest {
    ...
    public void testWrite() {
        this.<Boolean>testWriteProperty("Profile Expansion Enabled", this.datum, this.propertyValue, new BiConsumer<BulkAccount, Boolean>() {
            @Override
            public void accept(BulkAccount c, Boolean v) {
                c.setProfileExpansionEnabled(v);
            }
        });
    }
}
