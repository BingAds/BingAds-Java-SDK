...
public class BulkAdGroupUrlTargetReadUrlCustomParametersTest extends BulkAdGroupUrlTargetTest{
	...
	public void testRead() {	
        ...
        testReadProperty(
                values,
                expectedResult,
                new Function<BulkAdGroupUrlTarget, CustomParameters>() {
                    @Override
                    public CustomParameters apply(BulkAdGroupUrlTarget c) {
