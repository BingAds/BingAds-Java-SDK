...
public class BulkDisclaimerAdExtensionReadFromRowValuesTrackingTemplateTest extends BulkDisclaimerAdExtensionTest{
	...
	public void testRead() {
		this.<String>testReadProperty("Tracking Template", this.datum, this.expectedResult, new Function<BulkDisclaimerAdExtension, String>() {
			@Override
			public String apply(BulkDisclaimerAdExtension c) {
				return c.getDisclaimerAdExtension().getTrackingUrlTemplate();
			}
		});
	}
}
