...
public class BulkAccountPlacementInclusionListAssociationWriteToRowValuesParentIdTest extends BulkAccountPlacementInclusionListAssociationTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Parent Id", this.datum, this.propertyValue, new BiConsumer<BulkAccountPlacementInclusionListAssociation, Long>() {
            @Override
