...
public class BulkFlyerAdExtensionReadFromRowValuesFinalUrlsTest extends BulkFlyerAdExtensionTest{
	...
	public void testRead() {
		this.<ArrayOfstring>testReadProperty("Final Url", this.datum, this.expectedResult, new Function<BulkFlyerAdExtension, ArrayOfstring>() {
			@Override
			public ArrayOfstring apply(BulkFlyerAdExtension c) {
				return c.getFlyerAdExtension().getFinalUrls();
			}
