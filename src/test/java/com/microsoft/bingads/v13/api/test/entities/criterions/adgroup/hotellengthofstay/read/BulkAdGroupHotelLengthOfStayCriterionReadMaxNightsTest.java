...
public class BulkAdGroupHotelLengthOfStayCriterionReadMaxNightsTest extends BulkAdGroupHotelLengthOfStayCriterionTest {
    ...
    public void testRead() {
        testReadProperty("Max Target Value", datum, expectedResult, new Function<BulkAdGroupHotelLengthOfStayCriterion, Integer>() {
            @Override
            public Integer apply(BulkAdGroupHotelLengthOfStayCriterion c) {
                return ((HotelLengthOfStayCriterion) c.getBiddableAdGroupCriterion().getCriterion()).getMaxNights();
            }
        });
    }
}
