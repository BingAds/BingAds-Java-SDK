...
public class BulkImageAdExtensionReadFromRowValuesCustomParametersTest extends BulkImageAdExtensionTest{
	...
	public void testRead() {	
		this.<CustomParameters>testReadProperty("Custom Parameter", this.datum, this.expectedResult, new Function<BulkImageAdExtension, CustomParameters>() {
			@Override
			public CustomParameters apply(BulkImageAdExtension c) {
				return c.getImageAdExtension().getUrlCustomParameters();
			}
		});
