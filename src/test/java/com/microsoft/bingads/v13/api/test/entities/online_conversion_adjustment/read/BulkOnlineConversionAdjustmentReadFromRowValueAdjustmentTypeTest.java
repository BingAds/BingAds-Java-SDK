...
public class BulkOnlineConversionAdjustmentReadFromRowValueAdjustmentTypeTest extends BulkOnlineConversionAdjustmentTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Adjustment Type", this.datum, this.expectedResult, new Function<BulkOnlineConversionAdjustment, String>() {
            @Override
