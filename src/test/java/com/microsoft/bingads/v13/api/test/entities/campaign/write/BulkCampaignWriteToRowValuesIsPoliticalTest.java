...
public class BulkCampaignWriteToRowValuesIsPoliticalTest extends BulkCampaignTest {
    ...
    public void testWrite() {
        this.<Boolean>testWriteProperty("Is Political", this.datum, this.propertyValue, new BiConsumer<BulkCampaign, Boolean>() {
            @Override
            public void accept(BulkCampaign c, Boolean v) {
                c.getCampaign().setIsPolitical(v);
            }
        });
    }
}
