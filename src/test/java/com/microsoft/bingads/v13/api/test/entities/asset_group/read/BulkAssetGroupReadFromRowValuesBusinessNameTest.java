...
public class BulkAssetGroupReadFromRowValuesBusinessNameTest extends BulkAssetGroupTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Business Name", this.datum, this.expectedResult, new Function<BulkAssetGroup, String>() {
            @Override
