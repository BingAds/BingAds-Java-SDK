...
public class BulkSitelinkAdExtensionReadFromRowValuesFinalUrlsTest extends BulkSitelinkAdExtensionTest{
	...
	public void testRead() {
		this.<ArrayOfstring>testReadProperty("Final Url", this.datum, this.expectedResult, new Function<BulkSitelinkAdExtension, ArrayOfstring>() {
			@Override
			public ArrayOfstring apply(BulkSitelinkAdExtension c) {
				return c.getSitelinkAdExtension().getFinalUrls();
			}
