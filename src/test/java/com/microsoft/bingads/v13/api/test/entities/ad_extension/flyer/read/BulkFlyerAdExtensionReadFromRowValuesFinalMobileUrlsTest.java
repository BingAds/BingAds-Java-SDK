...
public class BulkFlyerAdExtensionReadFromRowValuesFinalMobileUrlsTest extends BulkFlyerAdExtensionTest{
	...
	public void testRead() {
		this.<ArrayOfstring>testReadProperty("Mobile Final Url", this.datum, this.expectedResult, new Function<BulkFlyerAdExtension, ArrayOfstring>() {
			@Override
			public ArrayOfstring apply(BulkFlyerAdExtension c) {
				return c.getFlyerAdExtension().getFinalMobileUrls();
			}
