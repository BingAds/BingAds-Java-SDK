...
public class BulkDisclaimerAdExtensionReadFromRowValuesPopupTextTest extends BulkDisclaimerAdExtensionTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Disclaimer Popup Text", this.datum, this.expectedResult, new Function<BulkDisclaimerAdExtension, String>() {
            @Override
            public String apply(BulkDisclaimerAdExtension c) {
                return c.getDisclaimerAdExtension().getPopupText();
            }
        });
    }
}
