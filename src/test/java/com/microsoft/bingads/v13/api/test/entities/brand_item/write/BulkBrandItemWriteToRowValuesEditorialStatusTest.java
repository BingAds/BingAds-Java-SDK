...
public class BulkBrandItemWriteToRowValuesEditorialStatusTest extends BulkBrandItemTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Editorial Status", this.datum, this.propertyValue, new BiConsumer<BulkBrandItem, String>() {
            @Override
