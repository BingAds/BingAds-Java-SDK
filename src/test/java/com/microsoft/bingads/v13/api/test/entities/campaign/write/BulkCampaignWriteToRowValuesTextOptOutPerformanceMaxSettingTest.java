...
public class BulkCampaignWriteToRowValuesTextOptOutPerformanceMaxSettingTest extends BulkCampaignTest {
    ...
    public void testWrite() {
        testWriteProperty("Auto Generated Text Assets Opt Out", this.datum, this.propertyValue, new BiConsumer<BulkCampaign, Boolean>() {
            @Override
            public void accept(BulkCampaign c, Boolean v) {
                ...
                setting.setAutoGeneratedTextOptOut(v);
