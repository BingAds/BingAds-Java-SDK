...
public class BulkAssetGroupReadFromRowValuesCampaignTest extends BulkAssetGroupTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Campaign", this.datum, this.expectedResult, new Function<BulkAssetGroup, String>() {
            @Override
