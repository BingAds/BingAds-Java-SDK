...
public class BulkAssetGroupUrlTargetWriteToRowValuesAssetGroupTargetValue1Test extends BulkAssetGroupUrlTargetTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Asset Group Target Value 1", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroupUrlTarget, String>() {
            @Override
