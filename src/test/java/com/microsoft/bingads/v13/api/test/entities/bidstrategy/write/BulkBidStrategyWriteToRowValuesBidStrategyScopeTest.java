...
public class BulkBidStrategyWriteToRowValuesBidStrategyScopeTest extends BulkBidStrategyTest {
    ...
    public void testWrite() {
        this.<EntityScope>testWriteProperty("Bid Strategy Scope", this.datum, this.propertyValue, new BiConsumer<BulkBidStrategy, EntityScope>() {
            @Override
            public void accept(BulkBidStrategy c, EntityScope v) {
                c.getBidStrategy().setScope(v);
            }
        });
    }
}
