...
public class BulkKeywordReadFromRowValuesDestinationUrlTest extends BulkKeywordTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Destination Url", this.datum, this.expectedResult, new Function<BulkKeyword, String>() {
            @Override
