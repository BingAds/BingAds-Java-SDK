...
public class BulkAccountIncludeViewThroughConversionsTest extends BulkAccountTest {
    ...
    public void testWrite() {
        this.<Boolean>testWriteProperty("Include View Through Conversions", this.datum, this.propertyValue, new BiConsumer<BulkAccount, Boolean>() {
            @Override
            public void accept(BulkAccount c, Boolean v) {
                c.setIncludeViewThroughConversions(v);
            }
        });
    }
}
