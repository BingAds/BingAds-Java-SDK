...
public class BulkSitelinkAdExtensionReadFromRowValuesDescription2Test extends BulkSitelinkAdExtensionTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Sitelink Extension Description2", this.datum, this.expectedResult, new Function<BulkSitelinkAdExtension, String>() {
            @Override
