...
public class BulkVideoReadFromRowValuesIdTest extends BulkVideoTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkVideo, Long>() {
            @Override
            public Long apply(BulkVideo c) {
                return c.getVideo().getId();
            }
        });
    }
}
