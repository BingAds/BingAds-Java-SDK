...
public class BulkEventGoalReadFromRowValuesLabelExpressionTest extends BulkEventGoalTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Label Expression", this.datum, this.expectedResult, new Function<BulkEventGoal, String>() {
            @Override
