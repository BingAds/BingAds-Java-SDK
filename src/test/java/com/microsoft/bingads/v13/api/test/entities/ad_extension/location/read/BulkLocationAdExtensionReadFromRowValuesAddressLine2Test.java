...
public class BulkLocationAdExtensionReadFromRowValuesAddressLine2Test extends BulkLocationAdExtensionTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Address Line 2", this.datum, this.expectedResult, new Function<BulkLocationAdExtension, String>() {
            @Override
            public String apply(BulkLocationAdExtension c) {
                return c.getLocationAdExtension().getAddress().getStreetAddress2();
            }
        });
    }
}
