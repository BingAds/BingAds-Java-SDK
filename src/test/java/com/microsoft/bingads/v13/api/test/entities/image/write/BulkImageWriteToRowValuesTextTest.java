...
public class BulkImageWriteToRowValuesTextTest extends BulkImageTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Text", this.datum, this.propertyValue, new BiConsumer<BulkImage, String>() {
            @Override
