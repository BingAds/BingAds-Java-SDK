...
public class BulkFeedReadFromRowValuesIdTest extends BulkFeedTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Id", this.datum, this.expectedResult, new Function<BulkFeed, Long>() {
            @Override
