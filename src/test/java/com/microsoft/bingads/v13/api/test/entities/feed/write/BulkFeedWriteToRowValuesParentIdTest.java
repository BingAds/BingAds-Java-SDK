...
public class BulkFeedWriteToRowValuesParentIdTest extends BulkFeedTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Parent Id", this.datum, this.propertyValue, new BiConsumer<BulkFeed, Long>() {
            @Override
