...
public class BulkImageReadFromRowValuesUrlTest extends BulkImageTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Url", this.datum, this.expectedResult, new Function<BulkImage, String>() {
            @Override
