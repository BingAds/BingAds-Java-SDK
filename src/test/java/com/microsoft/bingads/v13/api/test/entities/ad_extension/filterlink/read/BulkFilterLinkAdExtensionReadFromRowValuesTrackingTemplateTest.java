...
public class BulkFilterLinkAdExtensionReadFromRowValuesTrackingTemplateTest extends BulkFilterLinkAdExtensionTest{
	...
	public void testRead() {
		this.<String>testReadProperty("Tracking Template", this.datum, this.expectedResult, new Function<BulkFilterLinkAdExtension, String>() {
			@Override
			public String apply(BulkFilterLinkAdExtension c) {
				return c.getFilterLinkAdExtension().getTrackingUrlTemplate();
			}
		});
	}
}
