...
public class BulkProductAudienceReadFromRowValuesAudienceSearchSizeTest extends BulkProductAudienceTest {
    ...
    public void testRead() {
        this.<Long>testReadProperty("Audience Search Size", this.datum, this.expectedResult, new Function<BulkProductAudience, Long>() {
            @Override
