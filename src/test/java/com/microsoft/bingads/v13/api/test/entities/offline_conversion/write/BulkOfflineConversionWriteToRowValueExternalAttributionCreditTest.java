...
public class BulkOfflineConversionWriteToRowValueExternalAttributionCreditTest extends BulkOfflineConversionTest {
    ...
    public void testRead() {
        this.<Double>testWriteProperty("External Attribution Credit", this.datum, this.expectedResult, new BiConsumer<BulkOfflineConversion, Double>() {
            @Override
            public void accept(BulkOfflineConversion c, Double v) {
                c.setExternalAttributionCredit(v);
            }
        });
    }
}
