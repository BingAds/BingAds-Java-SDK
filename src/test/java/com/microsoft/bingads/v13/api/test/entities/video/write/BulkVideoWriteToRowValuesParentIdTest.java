...
public class BulkVideoWriteToRowValuesParentIdTest extends BulkVideoTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Parent Id", this.datum, this.propertyValue, new BiConsumer<BulkVideo, Long>() {
            @Override
