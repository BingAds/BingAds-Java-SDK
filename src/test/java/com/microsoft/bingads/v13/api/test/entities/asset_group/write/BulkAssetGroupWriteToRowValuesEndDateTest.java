...
public class BulkAssetGroupWriteToRowValuesEndDateTest extends BulkAssetGroupTest {
    ...
    public void testWrite() {
        this.<Date>testWriteProperty("End Date", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroup, Date>() {
            @Override
            public void accept(BulkAssetGroup c, Date v) {
                c.getAssetGroup().setEndDate(v);
            }
        });
    }
}
