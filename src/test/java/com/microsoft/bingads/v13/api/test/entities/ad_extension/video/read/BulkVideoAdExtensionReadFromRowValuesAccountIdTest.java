...
public class BulkVideoAdExtensionReadFromRowValuesAccountIdTest extends BulkVideoAdExtensionTest {
    ...
    public void testRead() {
        this.testReadProperty("Parent Id", this.datum, this.expectedResult, new Function<BulkVideoAdExtension, Long>() {
            @Override
