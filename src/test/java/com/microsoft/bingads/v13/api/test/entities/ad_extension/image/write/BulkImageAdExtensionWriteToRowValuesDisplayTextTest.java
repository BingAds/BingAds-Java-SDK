...
public class BulkImageAdExtensionWriteToRowValuesDisplayTextTest extends BulkImageAdExtensionTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("Display Text", this.datum, this.propertyValue, new BiConsumer<BulkImageAdExtension, String>() {
            @Override
            public void accept(BulkImageAdExtension c, String v) {
                c.getImageAdExtension().setDisplayText(v);
            }
        });
    }
}
