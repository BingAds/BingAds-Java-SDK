...
public class BulkVideoAdExtensionReadFromRowValuesCustomParameterTest extends BulkVideoAdExtensionTest {
    @Parameter(value = 1)
    ...
    public void testRead() {    
        this.<CustomParameters>testReadProperty("Custom Parameter", this.datum, this.expectedResult, new Function<BulkVideoAdExtension, CustomParameters>() {
            @Override
            public CustomParameters apply(BulkVideoAdExtension c) {
                return c.getVideoAdExtension().getUrlCustomParameters();
            }
        });
