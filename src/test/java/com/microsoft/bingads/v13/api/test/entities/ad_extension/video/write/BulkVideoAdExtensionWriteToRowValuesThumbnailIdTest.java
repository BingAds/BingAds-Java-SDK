...
public class BulkVideoAdExtensionWriteToRowValuesThumbnailIdTest extends BulkVideoAdExtensionTest {
    ...
    public void testWrite() {
        this.testWriteProperty("Thumbnail Id", this.datum, this.expectedResult, new BiConsumer<BulkVideoAdExtension, Long>() {
            @Override
            public void accept(BulkVideoAdExtension c, Long v) {
                c.getVideoAdExtension().setThumbnailId(v);
            }
        });
    }
}
