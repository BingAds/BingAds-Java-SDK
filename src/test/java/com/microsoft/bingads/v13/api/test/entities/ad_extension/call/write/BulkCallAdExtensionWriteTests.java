...
@RunWith(Suite.class)
@SuiteClasses({
    BulkCallAdExtensionWriteFromRowValuesAccountIdTest.class,
    BulkCallAdExtensionWriteFromRowValuesIdTest.class,
    BulkCallAdExtensionWriteFromRowValuesIsCallOnlyTest.class,
