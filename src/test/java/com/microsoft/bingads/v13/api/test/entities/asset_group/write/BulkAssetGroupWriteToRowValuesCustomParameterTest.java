...
public class BulkAssetGroupWriteToRowValuesCustomParameterTest extends BulkAssetGroupTest {
    ...
    public void testWrite() {
        this.<CustomParameters>testWriteProperty("Custom Parameter", this.datum, this.propertyValue, new BiConsumer<BulkAssetGroup, CustomParameters>() {
            @Override
            public void accept(BulkAssetGroup c, CustomParameters v) {
                c.getAssetGroup().setUrlCustomParameters(v);;
            }
        });
