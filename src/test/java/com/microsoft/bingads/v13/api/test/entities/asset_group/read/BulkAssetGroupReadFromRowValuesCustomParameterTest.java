...
public class BulkAssetGroupReadFromRowValuesCustomParameterTest extends BulkAssetGroupTest{
	...
	public void testRead() {	
		this.<CustomParameters>testReadProperty("Custom Parameter", this.datum, this.expectedResult, new Function<BulkAssetGroup, CustomParameters>() {
			@Override
			public CustomParameters apply(BulkAssetGroup c) {
				return c.getAssetGroup().getUrlCustomParameters();
			}
		});
