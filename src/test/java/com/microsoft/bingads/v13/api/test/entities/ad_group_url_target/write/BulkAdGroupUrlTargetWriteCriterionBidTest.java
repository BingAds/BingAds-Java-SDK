...
public class BulkAdGroupUrlTargetWriteCriterionBidTest extends BulkAdGroupUrlTargetTest {
    ...
    public void testWrite() {
        testWriteProperty(
                ...
                datum,
                propertyValue,
                new BiConsumer<BulkAdGroupUrlTarget, FixedBid>() {
                    @Override
                    public void accept(BulkAdGroupUrlTarget c, FixedBid v) {
