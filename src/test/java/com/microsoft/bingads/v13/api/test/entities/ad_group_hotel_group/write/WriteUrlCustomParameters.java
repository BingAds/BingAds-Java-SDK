...
public class WriteUrlCustomParameters extends BulkAdGroupHotelListingGroupTest {
	@Parameter(value = 1)
    ...
    public void testWrite() {
	    testWriteProperty(
                ...
                datum,
                propertyValue,
                new BiConsumer<BulkAdGroupHotelListingGroup, CustomParameters>() {
                    @Override
                    public void accept(BulkAdGroupHotelListingGroup c, CustomParameters v) {
