...
public class BulkAdGroupWriteToRowValuesCpmBidTest extends BulkAdGroupTest {
    ...
    public void testWrite() {
        this.<Bid>testWriteProperty("Cpm Bid", this.datum, this.propertyValue, new BiConsumer<BulkAdGroup, Bid>() {
            @Override
            public void accept(BulkAdGroup c, Bid v) {
                c.getAdGroup().setCpmBid(v);
            }
        });
    }
}
