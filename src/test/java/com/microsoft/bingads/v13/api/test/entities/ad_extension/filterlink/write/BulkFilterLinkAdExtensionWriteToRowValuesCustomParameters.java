...
public class BulkFilterLinkAdExtensionWriteToRowValuesCustomParameters extends BulkFilterLinkAdExtensionTest {
    ...
    public void testWrite() {
        this.<CustomParameters>testWriteProperty("Custom Parameter", this.datum, this.propertyValue, new BiConsumer<BulkFilterLinkAdExtension, CustomParameters>() {
            @Override
            public void accept(BulkFilterLinkAdExtension c, CustomParameters v) {
                c.getFilterLinkAdExtension().setUrlCustomParameters(v);;
            }
        });
