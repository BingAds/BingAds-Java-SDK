...
public class BulkAppDownloadGoalWriteToRowValuesAppPlatformTest extends BulkAppDownloadGoalTest {
    ...
    public void testWrite() {
        this.<String>testWriteProperty("App Platform", this.datum, this.propertyValue, new BiConsumer<BulkAppDownloadGoal, String>() {
            @Override
