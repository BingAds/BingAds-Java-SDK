...
public class BulkImageAdExtensionReadFromRowValuesDisplayTextTest extends BulkImageAdExtensionTest {
    ...
    public void testRead() {
        this.testReadProperty("Display Text", this.datum, this.expectedResult,
                new Function<BulkImageAdExtension, String>() {
                    @Override
                    public String apply(BulkImageAdExtension c) {
                        return c.getImageAdExtension().getDisplayText();
                    }
                });
    }
