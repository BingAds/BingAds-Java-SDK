...
public class BulkAssetGroupReadFromRowValuesHeadlinesTest extends BulkAssetGroupTest {
    ...
    public void testRead() {
        this.testReadProperty("Headlines", this.datum, this.expectedResult, new Function<BulkAssetGroup, String>() {
            @Override
