...
public class BulkVideoReadFromRowValuesUrlTest extends BulkVideoTest {
    ...
    public void testRead() {
        this.<String>testReadProperty("Url", this.datum, this.expectedResult, new Function<BulkVideo, String>() {
            @Override
            public String apply(BulkVideo c) {
                return c.getVideo().getUrl();
            }
        });
    }
}
