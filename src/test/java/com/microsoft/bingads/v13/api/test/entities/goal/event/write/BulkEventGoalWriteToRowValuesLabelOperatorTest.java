...
public class BulkEventGoalWriteToRowValuesLabelOperatorTest extends BulkEventGoalTest {
    ...
    public void testWrite() {
        this.<ExpressionOperator>testWriteProperty("Label Operator", this.datum, this.propertyValue, new BiConsumer<BulkEventGoal, ExpressionOperator>() {
            @Override
            public void accept(BulkEventGoal c, ExpressionOperator v) {
                c.getEventGoal().setLabelOperator(v);
            }
        });
    }
}
