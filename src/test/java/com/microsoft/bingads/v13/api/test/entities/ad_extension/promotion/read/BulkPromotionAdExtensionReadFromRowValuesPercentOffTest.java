...
public class BulkPromotionAdExtensionReadFromRowValuesPercentOffTest extends BulkPromotionAdExtensionTest {
    ...
    public void testRead() {
        this.<Double>testReadProperty("Percent Off", this.datum, this.expectedResult, new Function<BulkPromotionAdExtension, Double>() {
            @Override
            public Double apply(BulkPromotionAdExtension c) {
                return c.getPromotionAdExtension().getPercentOff();
            }
        });
    }
}
