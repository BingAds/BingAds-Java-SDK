...
public class BulkImpressionBasedRemarketingListWriteToRowValuesImpressionCampaignIdTest extends BulkImpressionBasedRemarketingListTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Impression Campaign Id", this.datum, this.propertyValue, new BiConsumer<BulkImpressionBasedRemarketingList, Long>() {
            @Override
            public void accept(BulkImpressionBasedRemarketingList c, Long v) {
                c.getImpressionBasedRemarketingList().setCampaignId(v);
            }
        });
    }
}
