...
public class BulkBrandItemWriteToRowValuesBrandIdTest extends BulkBrandItemTest {
    ...
    public void testWrite() {
        this.<Long>testWriteProperty("Brand Id", this.datum, this.propertyValue, new BiConsumer<BulkBrandItem, Long>() {
            @Override
            public void accept(BulkBrandItem c, Long v) {
                c.getBrandItem().setBrandId(v);
            }
        });
    }
}
