...
public class BulkAdGroupUrlTargetReadCriterionBidTest extends BulkAdGroupUrlTargetTest {
    ...
    public void testRead() {
        ...
        testReadProperty(
                values,
                expectedResult,
                new Function<BulkAdGroupUrlTarget, FixedBid>() {
                    @Override
                    public FixedBid apply(BulkAdGroupUrlTarget c) {
