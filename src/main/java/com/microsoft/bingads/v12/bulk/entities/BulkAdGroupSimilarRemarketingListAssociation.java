 ...
 * that can be used to read and write fields of the Ad Group Similar Remarketing List Association record in a bulk file.
 * <p/>
 * <p>
 * For more information, see Ad Group Similar Remarketing List Association at
 ...
 * @see BulkFileWriter
 */
public class BulkAdGroupSimilarRemarketingListAssociation extends SingleRecordBulkEntity {
    ...
    static {
        List<BulkMapping<BulkAdGroupSimilarRemarketingListAssociation>> m = new ArrayList<BulkMapping<BulkAdGroupSimilarRemarketingListAssociation>>();

        m.add(new SimpleBulkMapping<BulkAdGroupSimilarRemarketingListAssociation, String>(StringTable.Status,
                new Function<BulkAdGroupSimilarRemarketingListAssociation, String>() {
                    @Override
        ...
        m.add(new SimpleBulkMapping<BulkAdGroupSimilarRemarketingListAssociation, Long>(StringTable.Id,
                new Function<BulkAdGroupSimilarRemarketingListAssociation, Long>() {
                    @Override
        ...
        m.add(new SimpleBulkMapping<BulkAdGroupSimilarRemarketingListAssociation, Long>(StringTable.ParentId,
                new Function<BulkAdGroupSimilarRemarketingListAssociation, Long>() {
                    @Override
                    public Long apply(BulkAdGroupSimilarRemarketingListAssociation c) {
        ...
        m.add(new SimpleBulkMapping<BulkAdGroupSimilarRemarketingListAssociation, String>(StringTable.Campaign,
                new Function<BulkAdGroupSimilarRemarketingListAssociation, String>() {
                    @Override
                    public String apply(BulkAdGroupSimilarRemarketingListAssociation c) {
        ...
        m.add(new SimpleBulkMapping<BulkAdGroupSimilarRemarketingListAssociation, String>(StringTable.AdGroup,
                new Function<BulkAdGroupSimilarRemarketingListAssociation, String>() {
                    @Override
                    public String apply(BulkAdGroupSimilarRemarketingListAssociation c) {
        ...
        m.add(new SimpleBulkMapping<BulkAdGroupSimilarRemarketingListAssociation, String>(StringTable.Audience,
                new Function<BulkAdGroupSimilarRemarketingListAssociation, String>() {
                    @Override
                    public String apply(BulkAdGroupSimilarRemarketingListAssociation c) {
        ...
        m.add(new SimpleBulkMapping<BulkAdGroupSimilarRemarketingListAssociation, String>(StringTable.BidAdjustment,
                new Function<BulkAdGroupSimilarRemarketingListAssociation, String>() {
                    @Override
                    public String apply(BulkAdGroupSimilarRemarketingListAssociation c) {
        ...
        m.add(new SimpleBulkMapping<BulkAdGroupSimilarRemarketingListAssociation, Long>(StringTable.AudienceId,
                new Function<BulkAdGroupSimilarRemarketingListAssociation, Long>() {
                    @Override
                    public Long apply(BulkAdGroupSimilarRemarketingListAssociation c) {
                        if (c.getBiddableAdGroupCriterion() instanceof BiddableAdGroupCriterion) {
