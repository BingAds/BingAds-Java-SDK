...
/**
 * Represents an Industry criterion that is assigned to a campaign. Each age
 * criterion can be read or written in a bulk file.
 *
 * <p>
 * For more information, see Campaign Industry Criterion at <a
 ...
 * @see BulkFileWriter
 */
public class BulkCampaignIndustryCriterion extends BulkCampaignProfileCriterion {
