...
public class BulkCampaign extends SingleRecordBulkEntity {
    ...
    static {
        ...
        m.add(new SimpleBulkMapping<BulkCampaign, Boolean>(StringTable.AIMaxEnabled,
                new Function<BulkCampaign, Boolean>() {
                    @Override
                    public Boolean apply(BulkCampaign t) {
                        Setting setting = t.getCampaignSetting(AISearchSetting.class, false);
                        if (setting == null) {
                            return null;
                        }
                        return ((AISearchSetting)setting).getAISearchEnabled();
                    }
                },
                new BiConsumer<String, BulkCampaign>() {
                    @Override
                    public void accept(String v, BulkCampaign c) {
                        ...
                        AISearchSetting aiMaxSetting = (AISearchSetting) c.getCampaignSetting(AISearchSetting.class, false);
                        if (aiMaxSetting == null) {
                            aiMaxSetting = new AISearchSetting();
                            if (c.getCampaign().getSettings() == null) {
                                ArrayOfSetting settings = new ArrayOfSetting();
                                settings.getSettings().add(aiMaxSetting);
                                c.getCampaign().setSettings(settings);
                            } else {
                                c.getCampaign().getSettings().getSettings().add(aiMaxSetting);
                            }
                        }
                        aiMaxSetting.setAISearchEnabled(Boolean.parseBoolean(v));
                    }
                }
        ));
        ...
        m.add(new SimpleBulkMapping<BulkCampaign, Boolean>(StringTable.FinalUrlExpansionOptOut,
                new Function<BulkCampaign, Boolean>() {
                    @Override
                    public Boolean apply(BulkCampaign c) {
                        Setting aiMaxSetting = c.getCampaignSetting(AISearchSetting.class, false);
                        if (aiMaxSetting != null) {
                            return ((AISearchSetting)aiMaxSetting).getFinalUrlExpansionOptOut();
                        }
                ...
                new BiConsumer<String, BulkCampaign>() {
                    ...
                    public void accept(String v, BulkCampaign c) {
                        ...
                        if (aiMaxSetting != null) {
                            if (v != null && !v.isEmpty()) {
                                ((AISearchSetting)aiMaxSetting).setFinalUrlExpansionOptOut(Boolean.parseBoolean(v));
                            }
                            return;
                        }
        ...
        m.add(new SimpleBulkMapping<BulkCampaign, Boolean>(StringTable.AutoGeneratedImageOptOut,
                new Function<BulkCampaign, Boolean>() {
                    @Override
                    public Boolean apply(BulkCampaign t) {
                        Setting aiMaxSetting = t.getCampaignSetting(AISearchSetting.class, false);
                        if (aiMaxSetting != null) {
                            return ((AISearchSetting)aiMaxSetting).getAutoGeneratedImageOptOut();
                        }
                ...
                new BiConsumer<String, BulkCampaign>() {
                    ...
                    public void accept(String v, BulkCampaign c) {
                        ...
                        if (aiMaxSetting != null) {
                            if (v != null && !v.isEmpty()) {
                                ((AISearchSetting)aiMaxSetting).setAutoGeneratedImageOptOut(Boolean.parseBoolean(v));
                            }
                            return;
                        }
        ...
        m.add(new SimpleBulkMapping<BulkCampaign, Boolean>(StringTable.AutoGeneratedTextOptOut,
                new Function<BulkCampaign, Boolean>() {
                    ...
                    public Boolean apply(BulkCampaign t) {
                        Setting aiMaxSetting = t.getCampaignSetting(AISearchSetting.class, false);
                        if (aiMaxSetting != null) {
                            return ((AISearchSetting)aiMaxSetting).getAutoGeneratedTextOptOut();
                        }
                ...
                new BiConsumer<String, BulkCampaign>() {
                    ...
                    public void accept(String v, BulkCampaign c) {
                        ...
                        if (aiMaxSetting != null) {
                            if (v != null && !v.isEmpty()) {
                                ((AISearchSetting)aiMaxSetting).setAutoGeneratedTextOptOut(Boolean.parseBoolean(v));
                            }
                            return;
                        }
        ...
        m.add(new SimpleBulkMapping<BulkCampaign, Boolean>(StringTable.CostPerSaleOptOut,
                new Function<BulkCampaign, Boolean>() {
                    @Override
                    public Boolean apply(BulkCampaign t) {
                    	 Setting setting = t.getCampaignSetting(PerformanceMaxSetting.class, false);
        ...
        m.add(new SimpleBulkMapping<BulkCampaign, Boolean>(StringTable.SearchTermMatchingOptOut,
                new Function<BulkCampaign, Boolean>() {
                    @Override
                    public Boolean apply(BulkCampaign t) {
                        Setting setting = t.getCampaignSetting(AISearchSetting.class, false);
                        ...
                        return ((AISearchSetting)setting).getSearchTermMatchingOptOut();
                    }
                },
                new BiConsumer<String, BulkCampaign>() {
                    @Override
                    public void accept(String v, BulkCampaign c) {
                        Setting setting = c.getCampaignSetting(AISearchSetting.class, false);
                        if (setting == null || v == null || v.isEmpty()) {
                            return;
                        }
                        ((AISearchSetting)setting).setSearchTermMatchingOptOut(Boolean.parseBoolean(v));
                    }
                }
        ));
