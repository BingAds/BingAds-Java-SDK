...
/**
 * Represents an Job Function criterion that is assigned to a campaign. Each age
 * criterion can be read or written in a bulk file.
 *
 * <p>
 * For more information, see Campaign Job Function Criterion at <a
 ...
 * @see BulkFileWriter
 */
public class BulkCampaignJobFunctionCriterion extends BulkCampaignProfileCriterion {
