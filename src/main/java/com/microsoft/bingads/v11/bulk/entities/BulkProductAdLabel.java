...
/**
 * Represents a label that is applied to a ProductAd. Each label can be read or written in a bulk file.
 *
 * <p>
 ...
 * @see BulkFileWriter
 */
public class BulkProductAdLabel extends BulkLabelAssociation {
}
