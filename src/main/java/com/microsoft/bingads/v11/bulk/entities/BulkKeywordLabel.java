...
/**
 * Represents a label that is applied to a Keyword. Each label can be read or written in a bulk file.
 *
 * <p>
 ...
 * @see BulkFileWriter
 */
public class BulkKeywordLabel extends BulkLabelAssociation {
}
