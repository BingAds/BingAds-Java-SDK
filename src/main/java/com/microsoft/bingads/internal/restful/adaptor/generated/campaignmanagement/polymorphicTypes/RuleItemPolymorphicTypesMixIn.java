...
@JsonTypeInfo(
	    ...
	    @JsonSubTypes({
			...
			@JsonSubTypes.Type(value = StringRuleItem.class, name = "String"),
						
			@JsonSubTypes.Type(value = NumberRuleItem.class, name = "Number"),
				    })
@JsonInclude(JsonInclude.Include.NON_NULL)

public interface RuleItemPolymorphicTypesMixIn{
