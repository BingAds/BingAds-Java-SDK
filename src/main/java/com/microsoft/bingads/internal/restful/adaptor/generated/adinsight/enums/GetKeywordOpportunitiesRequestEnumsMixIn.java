...
public interface GetKeywordOpportunitiesRequestEnumsMixIn{
		
	@JsonSerialize(using = EnumListSerializer.class)
	@JsonDeserialize(using = KeywordOpportunityTypeDeserializer.class)
	Collection<KeywordOpportunityType> getOpportunityType();
