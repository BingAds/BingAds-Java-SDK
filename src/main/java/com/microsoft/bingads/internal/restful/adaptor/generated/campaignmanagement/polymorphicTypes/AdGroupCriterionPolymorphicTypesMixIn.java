...
@JsonTypeInfo(
	    ...
	    @JsonSubTypes({
			...
			@JsonSubTypes.Type(value = BiddableAdGroupCriterion.class, name = "BiddableAdGroupCriterion"),
						
			@JsonSubTypes.Type(value = NegativeAdGroupCriterion.class, name = "NegativeAdGroupCriterion"),
				    })
@JsonInclude(JsonInclude.Include.NON_NULL)

public interface AdGroupCriterionPolymorphicTypesMixIn{
