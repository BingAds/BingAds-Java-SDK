...
public class AddMixInForComplexTypesWithEnumList {
	public static void AddMixInForComplexTypesWithEnumList() {
		AdaptorUtil.mapper
				...
				.addMixIn(MMMPerformanceReportFilter.class, MMMPerformanceReportFilterEnumsMixIn.class)
				.addMixIn(SearchTermLandingPageReportFilter.class, SearchTermLandingPageReportFilterEnumsMixIn.class)
				;
	}
}