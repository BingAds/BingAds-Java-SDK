...
@JsonTypeInfo(
	    ...
	    @JsonSubTypes({
			...
			@JsonSubTypes.Type(value = GoogleImportJob.class, name = "GoogleImportJob"),
						
			@JsonSubTypes.Type(value = FileImportJob.class, name = "FileImportJob"),
				    })
@JsonInclude(JsonInclude.Include.NON_NULL)

public interface ImportJobPolymorphicTypesMixIn{
