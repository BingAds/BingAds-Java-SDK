...
@JsonTypeInfo(
	    ...
	    @JsonSubTypes({
			...
			@JsonSubTypes.Type(value = GoogleImportOption.class, name = "GoogleImportOption"),
						
			@JsonSubTypes.Type(value = FileImportOption.class, name = "FileImportOption"),
				    })
@JsonInclude(JsonInclude.Include.NON_NULL)

public interface ImportOptionPolymorphicTypesMixIn{
