...
public interface GetImportJobsByIdsRequestEnumsMixIn{
		
	@JsonSerialize(using = EnumListSerializer.class)
	@JsonDeserialize(using = ImportAdditionalFieldDeserializer.class)
	Collection<ImportAdditionalField> getReturnAdditionalFields();
