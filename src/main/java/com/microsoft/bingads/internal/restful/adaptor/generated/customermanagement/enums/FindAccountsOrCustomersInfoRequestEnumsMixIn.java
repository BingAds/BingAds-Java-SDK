...
public interface FindAccountsOrCustomersInfoRequestEnumsMixIn{
		
	@JsonSerialize(using = EnumListSerializer.class)
	@JsonDeserialize(using = AccountAdditionalFieldDeserializer.class)
	Collection<AccountAdditionalField> getReturnAdditionalFields();
