...
@JsonTypeInfo(
	    ...
	    @JsonSubTypes({
			...
			@JsonSubTypes.Type(value = TextAsset.class, name = "TextAsset"),
						
			@JsonSubTypes.Type(value = ImageAsset.class, name = "ImageAsset"),
						
			@JsonSubTypes.Type(value = VideoAsset.class, name = "VideoAsset"),
				    })
@JsonInclude(JsonInclude.Include.NON_NULL)

public interface AssetPolymorphicTypesMixIn{
