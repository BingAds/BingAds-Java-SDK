...
public interface GetAdsByEditorialStatusRequestEnumsMixIn{
		
	@JsonSerialize(using = EnumListSerializer.class)
	@JsonDeserialize(using = AdAdditionalFieldDeserializer.class)
	Collection<AdAdditionalField> getReturnAdditionalFields();
