...
public interface GetLinkedInSegmentsRequestEnumsMixIn{
		
	@JsonSerialize(using = EnumListSerializer.class)
	@JsonDeserialize(using = LinkedInSegmentTypeDeserializer.class)
	Collection<LinkedInSegmentType> getType();
