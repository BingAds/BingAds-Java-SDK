...
public interface GetUetTagsByIdsRequestEnumsMixIn{
		
	@JsonSerialize(using = EnumListSerializer.class)
	@JsonDeserialize(using = UetTagAdditionalFieldDeserializer.class)
	Collection<UetTagAdditionalField> getReturnAdditionalFields();
