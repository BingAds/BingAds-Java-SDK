...
public class CampaignManagementService extends RestfulServiceClient implements ICampaignManagementService {
	...
	public CampaignManagementService(Authentication authentication, Map<String, String> headers, ApiEnvironment env, Supplier<ICampaignManagementService> fallbackService) {
        super(authentication, headers, env, ICampaignManagementService.class);
