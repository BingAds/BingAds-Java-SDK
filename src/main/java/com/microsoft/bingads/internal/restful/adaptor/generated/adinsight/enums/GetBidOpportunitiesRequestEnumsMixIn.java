...
public interface GetBidOpportunitiesRequestEnumsMixIn{
		
	@JsonSerialize(using = EnumListSerializer.class)
	@JsonDeserialize(using = BidOpportunityTypeDeserializer.class)
	Collection<BidOpportunityType> getOpportunityType();
