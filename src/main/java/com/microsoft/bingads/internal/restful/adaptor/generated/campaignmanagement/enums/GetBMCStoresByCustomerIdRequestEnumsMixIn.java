...
public interface GetBMCStoresByCustomerIdRequestEnumsMixIn{
		
	@JsonSerialize(using = EnumListSerializer.class)
	@JsonDeserialize(using = BMCStoreAdditionalFieldDeserializer.class)
	Collection<BMCStoreAdditionalField> getReturnAdditionalFields();
