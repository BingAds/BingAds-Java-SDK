...
public class AddMixInForArrayOfTypes {
	public static void AddMixInForArrayOfTypes() {
		AdaptorUtil.mapper
				...
				.addMixIn(ArrayOfCampaignBidLandscape.class, ArrayOfTypesMixIn.class)
				.addMixIn(ArrayOfCampaignBidLandscapePoint.class, ArrayOfTypesMixIn.class)
				...
				.addMixIn(ArrayOfDeviceEnum.class, ArrayOfTypesMixIn.class)
