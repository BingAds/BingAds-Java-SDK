...
public interface GetKeywordsByEditorialStatusRequestEnumsMixIn{
		
	@JsonSerialize(using = EnumListSerializer.class)
	@JsonDeserialize(using = KeywordAdditionalFieldDeserializer.class)
	Collection<KeywordAdditionalField> getReturnAdditionalFields();
