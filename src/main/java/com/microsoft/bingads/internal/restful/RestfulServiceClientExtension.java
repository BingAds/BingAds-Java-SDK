...
public class RestfulServiceClientExtension {
	...
	protected void throwException(String ns, HttpResponse<String> response) 
    		throws Exception {
    	...
    	try {
			...
			errorRes = AdaptorUtil.mapper.readValue(response.body(), Class.forName(ns + "ApplicationFault"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	protected void throwExecutionException(String ns, HttpResponse<String> response) throws ExecutionException
    {
    	Object errorRes = null;
    	Class<?> clazz = null;
    	String message = "";
