...
public interface GetExperimentsByIdsRequestEnumsMixIn{
		
	@JsonSerialize(using = EnumListSerializer.class)
	@JsonDeserialize(using = ExperimentAdditionalFieldDeserializer.class)
	Collection<ExperimentAdditionalField> getReturnAdditionalFields();
