...
public interface ProductAudienceEnumsMixIn{
		
	@JsonSerialize(using = EnumListSerializer.class)
	@JsonDeserialize(using = ProductAudienceTypeDeserializer.class)
	Collection<ProductAudienceType> getProductAudienceType();
