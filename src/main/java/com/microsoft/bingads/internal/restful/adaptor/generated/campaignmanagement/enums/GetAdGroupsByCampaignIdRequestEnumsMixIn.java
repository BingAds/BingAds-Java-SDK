...
public interface GetAdGroupsByCampaignIdRequestEnumsMixIn{
		
	@JsonSerialize(using = EnumListSerializer.class)
	@JsonDeserialize(using = AdGroupAdditionalFieldDeserializer.class)
	Collection<AdGroupAdditionalField> getReturnAdditionalFields();
