...
public class AddMixInForComplexTypesWithEnumList {
	public static void AddMixInForComplexTypesWithEnumList() {
		AdaptorUtil.mapper
				...
				.addMixIn(GetKeywordsByAssetGroupIdRequest.class, GetKeywordsByAssetGroupIdRequestEnumsMixIn.class)
				...
				.addMixIn(GetLinkedInSegmentsRequest.class, GetLinkedInSegmentsRequestEnumsMixIn.class)
