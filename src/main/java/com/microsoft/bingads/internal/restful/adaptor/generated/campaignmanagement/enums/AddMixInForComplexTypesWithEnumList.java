...
public class AddMixInForComplexTypesWithEnumList {
	public static void AddMixInForComplexTypesWithEnumList() {
		AdaptorUtil.mapper
				...
				.addMixIn(GetBrandKitsByAccountIdRequest.class, GetBrandKitsByAccountIdRequestEnumsMixIn.class)
				.addMixIn(GetBrandKitsByIdsRequest.class, GetBrandKitsByIdsRequestEnumsMixIn.class)
