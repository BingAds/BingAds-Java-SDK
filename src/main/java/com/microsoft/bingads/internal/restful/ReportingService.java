...
public class ReportingService extends RestfulServiceClient implements IReportingService {
	...
	public ReportingService(Authentication authentication, Map<String, String> headers, ApiEnvironment env, Supplier<IReportingService> fallbackService) {
        super(authentication, headers, env, IReportingService.class);
