...
@JsonTypeInfo(
	    ...
	    @JsonSubTypes({
			...
			@JsonSubTypes.Type(value = ResponsiveSearchAdsRecommendation.class, name = "ResponsiveSearchAdsRecommendation"),
				    })
@JsonInclude(JsonInclude.Include.NON_NULL)

public interface RecommendationPolymorphicTypesMixIn{
