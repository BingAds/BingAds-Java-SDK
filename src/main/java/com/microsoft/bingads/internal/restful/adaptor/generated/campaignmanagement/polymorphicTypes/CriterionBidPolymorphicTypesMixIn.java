...
@JsonTypeInfo(
	    ...
	    @JsonSubTypes({
			...
			@JsonSubTypes.Type(value = RateBid.class, name = "RateBid"),
						
			@JsonSubTypes.Type(value = FixedBid.class, name = "FixedBid"),
						
			@JsonSubTypes.Type(value = BidMultiplier.class, name = "BidMultiplier"),
				    })
@JsonInclude(JsonInclude.Include.NON_NULL)

public interface CriterionBidPolymorphicTypesMixIn{
