...
public interface GetBrandKitsByAccountIdRequestEnumsMixIn{
		
	@JsonSerialize(using = EnumListSerializer.class)
	@JsonDeserialize(using = BrandKitAdditionalFieldDeserializer.class)
	Collection<BrandKitAdditionalField> getReturnAdditionalFields();
