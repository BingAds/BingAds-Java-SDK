...
import com.microsoft.bingads.internal.bulk.file.Creator;
import com.microsoft.bingads.internal.bulk.file.EntityInfo;
...
public class StaticBulkObjectFactory implements BulkObjectFactory {
    ...
    static {
        ...
        m.put(StringTable.MobileAd, new EntityInfo(new Creator<SingleRecordBulkEntity>() {
            @Override
            public SingleRecordBulkEntity create() {
        ...
        m.put(StringTable.ProductAdExtension, new EntityInfo(new Creator<SingleRecordBulkEntity>() {
            @Override
            public SingleRecordBulkEntity create() {
                return new BulkProductConditionCollection();
            }
        }, StringTable.BingMerchantCenterId, new Creator<BulkEntityIdentifier>() {
            @Override
            public BulkEntityIdentifier create() {
                return new BulkProductAdExtensionIdentifier();
            }
        }));
        m.put(StringTable.CampaignProductAdExtension, new EntityInfo(new Creator<SingleRecordBulkEntity>() {
            @Override
            public SingleRecordBulkEntity create() {
        ...
        m.put(StringTable.AdGroupProductTarget, new EntityInfo(new Creator<SingleRecordBulkEntity>() {
            @Override
            public SingleRecordBulkEntity create() {
