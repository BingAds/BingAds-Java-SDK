...
class ReportingExampleHelper
{
    ...
    static void outputLanguageReportFilter(LanguageReportFilter valueSet)
    {
        outputStatusMessage(String.format("Values in %s", valueSet.toString()));
        for (LanguageReportFilter value : LanguageReportFilter.values())
        {
            outputStatusMessage(value.toString());
        }
    }
    static void outputArrayOfLanguageReportFilter(ArrayList<LanguageReportFilter> valueSets)
    {
        if (null != valueSets)
        {
            for (LanguageReportFilter valueSet : valueSets)
            {
