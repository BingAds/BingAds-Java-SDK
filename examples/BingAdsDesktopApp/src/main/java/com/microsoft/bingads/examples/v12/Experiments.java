...
public class Experiments extends ExampleBase {
    ...
    public static void main(java.lang.String[] args) {
        ...
        try
        {
            ...
            experiment.setEndDate(new com.microsoft.bingads.v12.campaignmanagement.Date());
            ...
            experiment.setStartDate(new com.microsoft.bingads.v12.campaignmanagement.Date());
