...
public class Targets {
     ...
     public static void main(java.lang.String[] args) {
         ...
         try
         {
             ...
             ArrayOfstring osNames = new ArrayOfstring();
             osNames.getStrings().add("Other");
             deviceOSTargetBid.setOSNames(osNames);
     ...
     static void printTarget(Target target)
     {
         ...
         if (target.getDeviceOS() != null)
         {
             ...
             for (DeviceOSTargetBid bid : target.getDeviceOS().getBids().getDeviceOSTargetBids())
             {
                 ...
                 if (bid.getOSNames() != null)
                 {
                     System.out.println("\tOSNames:");
                     for (java.lang.String osname : bid.getOSNames().getStrings())
                     {
                         System.out.printf("\t\t%s\n", osname);
                     }
                 }
