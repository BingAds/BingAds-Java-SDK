    ...
    public static void main(String[] args) {
		...
		try {
			...
			for (BulkRemarketingList bulkRemarketingList : remarketingListResults) {
                            ...
                            {
                                BulkAdGroupRemarketingList bulkAdGroupRemarketingList = new BulkAdGroupRemarketingList();
			...
			for (BulkEntity entity : downloadEntities) {
                            ...
                            else if (entity instanceof BulkAdGroupRemarketingList) {
                                outputBulkAdGroupRemarketingLists(Arrays.asList((BulkAdGroupRemarketingList) entity) );
                            }
			}
			downloadEntities.close();
			Reader.close();
