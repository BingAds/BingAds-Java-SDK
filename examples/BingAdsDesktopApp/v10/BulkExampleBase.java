...
import com.microsoft.bingads.v10.bulk.entities.BulkAdGroupRemarketingList;
    ...
    static void outputBulkSiteLinks(Iterable<BulkSiteLink> bulkEntities)
{
    ...
    static void outputBulkAdGroupRemarketingLists(Iterable<BulkAdGroupRemarketingList> bulkEntities){
        for (BulkAdGroupRemarketingList entity : bulkEntities){
