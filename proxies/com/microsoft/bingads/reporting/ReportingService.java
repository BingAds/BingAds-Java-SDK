    ...
    extends Service
{
    ...
    private final static QName REPORTINGSERVICE_QNAME = new QName("https://bingads.microsoft.com/Reporting/v9", "ReportingService");
    ...
    public IReportingService getBasicHttpBindingIReportingService() {
        return super.getPort(new QName("https://bingads.microsoft.com/Reporting/v9", "BasicHttpBinding_IReportingService"), IReportingService.class);
    }
    ...
    public IReportingService getBasicHttpBindingIReportingService(WebServiceFeature... features) {
        return super.getPort(new QName("https://bingads.microsoft.com/Reporting/v9", "BasicHttpBinding_IReportingService"), IReportingService.class, features);
    }
