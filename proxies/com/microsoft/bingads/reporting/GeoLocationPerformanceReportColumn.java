...
/**
 * <p>Java class for GeoLocationPerformanceReportColumn.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="GeoLocationPerformanceReportColumn">
 ...
 * 
 */
@XmlType(name = "GeoLocationPerformanceReportColumn")
@XmlEnum
public enum GeoLocationPerformanceReportColumn {
    ...
    public static GeoLocationPerformanceReportColumn fromValue(String v) {
        for (GeoLocationPerformanceReportColumn c: GeoLocationPerformanceReportColumn.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
