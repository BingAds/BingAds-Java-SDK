 ...
 * 
 */
@WebServiceClient(name = "CustomerManagementService", targetNamespace = "https://bingads.microsoft.com/Customer/v9", wsdlLocation = "https://clientcenter.api.sandbox.bingads.microsoft.com/Api/CustomerManagement/v9/CustomerManagementService.svc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERMANAGEMENTSERVICE_QNAME = new QName("https://bingads.microsoft.com/Customer/v9", "CustomerManagementService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://clientcenter.api.sandbox.bingads.microsoft.com/Api/CustomerManagement/v9/CustomerManagementService.svc?wsdl");
    ...
    public ICustomerManagementService getBasicHttpBindingICustomerManagementService() {
        return super.getPort(new QName("https://bingads.microsoft.com/Customer/v9", "BasicHttpBinding_ICustomerManagementService"), ICustomerManagementService.class);
    }
    ...
    public ICustomerManagementService getBasicHttpBindingICustomerManagementService(WebServiceFeature... features) {
        return super.getPort(new QName("https://bingads.microsoft.com/Customer/v9", "BasicHttpBinding_ICustomerManagementService"), ICustomerManagementService.class, features);
    }
