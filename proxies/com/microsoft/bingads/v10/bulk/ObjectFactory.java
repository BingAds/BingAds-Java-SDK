 ...
 * generated in the com.microsoft.bingads.v10.bulk package. 
...
public class ObjectFactory {
    ...
    private final static QName _CompressionType_QNAME = new QName("https://bingads.microsoft.com/CampaignManagement/v10", "CompressionType");
    ...
    private final static QName _CampaignScope_QNAME = new QName("https://bingads.microsoft.com/CampaignManagement/v10", "CampaignScope");
    ...
    private final static QName _DownloadFileType_QNAME = new QName("https://bingads.microsoft.com/CampaignManagement/v10", "DownloadFileType");
    private final static QName _ArrayOfAdApiError_QNAME = new QName("https://adapi.microsoft.com", "ArrayOfAdApiError");
    private final static QName _ReportTimePeriod_QNAME = new QName("https://bingads.microsoft.com/CampaignManagement/v10", "ReportTimePeriod");
    ...
    private final static QName _ResponseMode_QNAME = new QName("https://bingads.microsoft.com/CampaignManagement/v10", "ResponseMode");
    private final static QName _DataScope_QNAME = new QName("https://bingads.microsoft.com/CampaignManagement/v10", "DataScope");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.microsoft.bingads.v10.bulk
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://bingads.microsoft.com/CampaignManagement/v10", name = "CompressionType")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://bingads.microsoft.com/CampaignManagement/v10", name = "CampaignScope")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://bingads.microsoft.com/CampaignManagement/v10", name = "DownloadFileType")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://bingads.microsoft.com/CampaignManagement/v10", name = "ReportTimePeriod")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://bingads.microsoft.com/CampaignManagement/v10", name = "ArrayOfCampaignScope")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://bingads.microsoft.com/CampaignManagement/v10", name = "PerformanceStatsDateRange")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://bingads.microsoft.com/CampaignManagement/v10", name = "ResponseMode")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://bingads.microsoft.com/CampaignManagement/v10", name = "DataScope")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://bingads.microsoft.com/CampaignManagement/v10", name = "BulkDownloadEntity")
