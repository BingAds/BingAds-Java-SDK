...
@XmlRootElement(name = "GetHistoricalKeywordPerformanceResponse", namespace = "Microsoft.Advertiser.AdInsight.Api.Service")
public class GetHistoricalKeywordPerformanceResponse {

    @XmlElement(name = "KeywordHistoricalPerformances", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
