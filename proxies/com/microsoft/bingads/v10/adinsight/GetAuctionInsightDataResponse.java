...
@XmlRootElement(name = "GetAuctionInsightDataResponse", namespace = "Microsoft.Advertiser.AdInsight.Api.Service")
public class GetAuctionInsightDataResponse {

    @XmlElement(name = "Result", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
