...
@XmlRootElement(name = "GetEstimatedBidByKeywordsResponse", namespace = "Microsoft.Advertiser.AdInsight.Api.Service")
public class GetEstimatedBidByKeywordsResponse {

    @XmlElement(name = "KeywordEstimatedBids", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
    protected ArrayOfKeywordEstimatedBid keywordEstimatedBids;
    @XmlElement(name = "AdGroupEstimatedBid", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
