...
@XmlRootElement(name = "SuggestKeywordsFromExistingKeywordsResponse", namespace = "Microsoft.Advertiser.AdInsight.Api.Service")
public class SuggestKeywordsFromExistingKeywordsResponse {

    @XmlElement(name = "KeywordSuggestions", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
