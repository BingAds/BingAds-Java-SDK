...
@XmlRootElement(name = "GetBidLandscapeByAdGroupIdsResponse", namespace = "Microsoft.Advertiser.AdInsight.Api.Service")
public class GetBidLandscapeByAdGroupIdsResponse {

    @XmlElement(name = "BidLandscape", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
