...
@XmlRootElement(name = "SuggestKeywordsFromExistingKeywordsRequest", namespace = "Microsoft.Advertiser.AdInsight.Api.Service")
public class SuggestKeywordsFromExistingKeywordsRequest {
    ...
    @XmlElement(name = "MaxSuggestionsPerKeyword", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
    protected Integer maxSuggestionsPerKeyword;
    @XmlElement(name = "SuggestionType", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
    protected Integer suggestionType;
    @XmlElement(name = "RemoveDuplicates", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
    protected Boolean removeDuplicates;
    @XmlElement(name = "ExcludeBrand", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
