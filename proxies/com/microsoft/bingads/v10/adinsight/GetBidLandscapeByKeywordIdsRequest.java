...
@XmlRootElement(name = "GetBidLandscapeByKeywordIdsRequest", namespace = "Microsoft.Advertiser.AdInsight.Api.Service")
public class GetBidLandscapeByKeywordIdsRequest {
    ...
    @XmlElement(name = "IncludeCurrentBid", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
