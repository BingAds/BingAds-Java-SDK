...
@XmlRootElement(name = "GetKeywordDemographicsResponse", namespace = "Microsoft.Advertiser.AdInsight.Api.Service")
public class GetKeywordDemographicsResponse {

    @XmlElement(name = "KeywordDemographicResult", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
