...
@XmlRootElement(name = "GetKeywordLocationsRequest", namespace = "Microsoft.Advertiser.AdInsight.Api.Service")
public class GetKeywordLocationsRequest {
    ...
    @XmlElement(name = "Device", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
    protected ArrayOfstring device;
    @XmlElement(name = "Level", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
    protected Integer level;
    @XmlElement(name = "ParentCountry", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
    protected String parentCountry;
    @XmlElement(name = "MaxLocations", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
