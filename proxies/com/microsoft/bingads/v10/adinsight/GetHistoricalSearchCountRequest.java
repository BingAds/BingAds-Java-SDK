...
@XmlRootElement(name = "GetHistoricalSearchCountRequest", namespace = "Microsoft.Advertiser.AdInsight.Api.Service")
public class GetHistoricalSearchCountRequest {
    ...
    @XmlElement(name = "StartDate", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
    protected DayMonthAndYear startDate;
    @XmlElement(name = "EndDate", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
    protected DayMonthAndYear endDate;
    @XmlElement(name = "TimePeriodRollup", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
    protected String timePeriodRollup;
    @XmlElement(name = "Devices", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
