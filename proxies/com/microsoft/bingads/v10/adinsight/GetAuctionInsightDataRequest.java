...
@XmlRootElement(name = "GetAuctionInsightDataRequest", namespace = "Microsoft.Advertiser.AdInsight.Api.Service")
public class GetAuctionInsightDataRequest {

    @XmlElement(name = "Selector", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
