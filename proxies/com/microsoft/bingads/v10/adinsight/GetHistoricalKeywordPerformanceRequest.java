...
@XmlRootElement(name = "GetHistoricalKeywordPerformanceRequest", namespace = "Microsoft.Advertiser.AdInsight.Api.Service")
public class GetHistoricalKeywordPerformanceRequest {
    ...
    @XmlElement(name = "TimeInterval", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
    @XmlSchemaType(name = "string")
    protected TimeInterval timeInterval;
    @XmlElement(name = "TargetAdPosition", namespace = "Microsoft.Advertiser.AdInsight.Api.Service", nillable = true)
    @XmlSchemaType(name = "string")
