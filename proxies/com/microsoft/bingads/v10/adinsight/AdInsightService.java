 ...
 * 
 */
@WebServiceClient(name = "AdInsightService", targetNamespace = "Microsoft.Advertiser.AdInsight.Api.Service", wsdlLocation = "https://adinsight.api.sandbox.bingads.microsoft.com/Api/Advertiser/AdInsight/V10/AdInsightService.svc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADINSIGHTSERVICE_QNAME = new QName("Microsoft.Advertiser.AdInsight.Api.Service", "AdInsightService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adinsight.api.sandbox.bingads.microsoft.com/Api/Advertiser/AdInsight/V10/AdInsightService.svc?wsdl");
    ...
    public IAdInsightService getBasicHttpBindingIAdInsightService() {
        return super.getPort(new QName("Microsoft.Advertiser.AdInsight.Api.Service", "BasicHttpBinding_IAdInsightService"), IAdInsightService.class);
    }
