...
@XmlRootElement(name = "GetKeywordLocationsRequest", namespace = "https://bingads.microsoft.com/AdIntelligence/v9")
public class GetKeywordLocationsRequest {
    ...
    @XmlElement(name = "PublisherCountry", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
    protected String publisherCountry;
    @XmlElement(name = "Device", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
    protected ArrayOfstring device;
    @XmlElement(name = "Level", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
    protected Integer level;
    @XmlElement(name = "ParentCountry", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
    protected String parentCountry;
    @XmlElement(name = "MaxLocations", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
