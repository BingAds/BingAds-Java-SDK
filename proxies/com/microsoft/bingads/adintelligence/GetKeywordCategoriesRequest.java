...
@XmlRootElement(name = "GetKeywordCategoriesRequest", namespace = "https://bingads.microsoft.com/AdIntelligence/v9")
public class GetKeywordCategoriesRequest {
    ...
    @XmlElement(name = "MaxCategories", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
