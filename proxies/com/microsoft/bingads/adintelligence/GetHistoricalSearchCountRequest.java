 ...
 *         &lt;element name="StartDate" type="{http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.CampaignManagement.Api.DataContracts}DayMonthAndYear" minOccurs="0"/>
 *         &lt;element name="EndDate" type="{http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.CampaignManagement.Api.DataContracts}DayMonthAndYear" minOccurs="0"/>
...
@XmlRootElement(name = "GetHistoricalSearchCountRequest", namespace = "https://bingads.microsoft.com/AdIntelligence/v9")
public class GetHistoricalSearchCountRequest {
    ...
    @XmlElement(name = "StartDate", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
    protected DayMonthAndYear startDate;
    @XmlElement(name = "EndDate", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
    protected DayMonthAndYear endDate;
    @XmlElement(name = "TimePeriodRollup", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
    protected String timePeriodRollup;
    @XmlElement(name = "Devices", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
