 ...
 *       &lt;sequence>
 *         &lt;element name="KeywordHistoricalPerformances" type="{http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.CampaignManagement.Api.DataContracts}ArrayOfKeywordHistoricalPerformance" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetHistoricalKeywordPerformanceResponse", namespace = "https://bingads.microsoft.com/AdIntelligence/v9")
public class GetHistoricalKeywordPerformanceResponse {

    @XmlElement(name = "KeywordHistoricalPerformances", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
