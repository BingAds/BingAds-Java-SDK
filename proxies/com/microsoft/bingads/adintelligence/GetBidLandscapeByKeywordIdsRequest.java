...
@XmlRootElement(name = "GetBidLandscapeByKeywordIdsRequest", namespace = "https://bingads.microsoft.com/AdIntelligence/v9")
public class GetBidLandscapeByKeywordIdsRequest {
    ...
    @XmlElement(name = "IncludeCurrentBid", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
