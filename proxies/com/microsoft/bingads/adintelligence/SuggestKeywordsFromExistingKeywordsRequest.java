...
@XmlRootElement(name = "SuggestKeywordsFromExistingKeywordsRequest", namespace = "https://bingads.microsoft.com/AdIntelligence/v9")
public class SuggestKeywordsFromExistingKeywordsRequest {
    ...
    @XmlElement(name = "MaxSuggestionsPerKeyword", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
    protected Integer maxSuggestionsPerKeyword;
    @XmlElement(name = "SuggestionType", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
    protected Integer suggestionType;
    @XmlElement(name = "RemoveDuplicates", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
    protected Boolean removeDuplicates;
    @XmlElement(name = "ExcludeBrand", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
