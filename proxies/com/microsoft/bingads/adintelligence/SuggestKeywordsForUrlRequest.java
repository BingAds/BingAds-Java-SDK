...
@XmlRootElement(name = "SuggestKeywordsForUrlRequest", namespace = "https://bingads.microsoft.com/AdIntelligence/v9")
public class SuggestKeywordsForUrlRequest {

    @XmlElement(name = "Url", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
    protected String url;
    @XmlElement(name = "Language", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
    protected String language;
    @XmlElement(name = "MaxKeywords", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
    protected Integer maxKeywords;
    @XmlElement(name = "MinConfidenceScore", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
