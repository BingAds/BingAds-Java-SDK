 ...
 *         &lt;element name="TargetAdPosition" type="{http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.CampaignManagement.Api.DataContracts}AdPosition" minOccurs="0"/>
...
@XmlRootElement(name = "GetHistoricalKeywordPerformanceRequest", namespace = "https://bingads.microsoft.com/AdIntelligence/v9")
public class GetHistoricalKeywordPerformanceRequest {
    ...
    @XmlElement(name = "TargetAdPosition", namespace = "https://bingads.microsoft.com/AdIntelligence/v9", nillable = true)
    @XmlSchemaType(name = "string")
