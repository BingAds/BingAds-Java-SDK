...
@XmlRootElement(name = "AddLabelsResponse")
public class AddLabelsResponse {

    @XmlElement(name = "LabelIds", nillable = true)
    protected ArrayOfNullableOflong labelIds;
     ...
     *     
     */
    public ArrayOfNullableOflong getLabelIds() {
        return labelIds;
    }
     ...
     *     
     */
    public void setLabelIds(ArrayOfNullableOflong value) {
        this.labelIds = value;
    }
