 ...
 *       &lt;sequence>
 *         &lt;element name="AdExtensionIdentity" type="{https://bingads.microsoft.com/CampaignManagement/v11}AdExtensionIdentity" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfAdExtensionIdentity {
     ...
     * This is why there is not a <CODE>set</CODE> method for the adExtensionIdentities property.
     * 
     * <p>
    ...
    public List<AdExtensionIdentity> getAdExtensionIdentities() {
        if (adExtensionIdentities == null) {
            adExtensionIdentities = new ArrayList<AdExtensionIdentity>();
        }
