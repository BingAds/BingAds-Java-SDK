 ...
 *       &lt;sequence>
 *         &lt;element name="KeywordSearchCounts" type="{http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.AdInsight.Api.DataContract.V11.Entity}ArrayOfKeywordSearchCount" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetHistoricalSearchCountResponse", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V11")
public class GetHistoricalSearchCountResponse {

    @XmlElement(name = "KeywordSearchCounts", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V11", nillable = true)
