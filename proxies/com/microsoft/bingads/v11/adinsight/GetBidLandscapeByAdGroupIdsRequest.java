 ...
 *       &lt;sequence>
 *         &lt;element name="AdGroupBidLandscapeInputs" type="{http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.AdInsight.Api.DataContract.V11.Entity}ArrayOfAdGroupBidLandscapeInput" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetBidLandscapeByAdGroupIdsRequest", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V11")
public class GetBidLandscapeByAdGroupIdsRequest {

    @XmlElement(name = "AdGroupBidLandscapeInputs", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V11", nillable = true)
