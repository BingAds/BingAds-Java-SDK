 ...
 *       &lt;sequence>
 *         &lt;element name="KeywordLocationResult" type="{http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.AdInsight.Api.DataContract.V11.Entity}ArrayOfKeywordLocationResult" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetKeywordLocationsResponse", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V11")
public class GetKeywordLocationsResponse {

    @XmlElement(name = "KeywordLocationResult", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V11", nillable = true)
