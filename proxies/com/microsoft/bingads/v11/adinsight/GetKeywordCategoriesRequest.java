...
@XmlRootElement(name = "GetKeywordCategoriesRequest", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V11")
public class GetKeywordCategoriesRequest {
    ...
    @XmlElement(name = "MaxCategories", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V11", nillable = true)
