...
@XmlRootElement(name = "GetKeywordLocationsRequest", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V11")
public class GetKeywordLocationsRequest {
    ...
    @XmlElement(name = "Level", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V11", nillable = true)
    protected Integer level;
    @XmlElement(name = "ParentCountry", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V11", nillable = true)
    protected String parentCountry;
    @XmlElement(name = "MaxLocations", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V11", nillable = true)
