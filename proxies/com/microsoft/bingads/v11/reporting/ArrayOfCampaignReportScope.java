 ...
 *       &lt;sequence>
 *         &lt;element name="CampaignReportScope" type="{https://bingads.microsoft.com/Reporting/v11}CampaignReportScope" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfCampaignReportScope {
     ...
     * This is why there is not a <CODE>set</CODE> method for the campaignReportScopes property.
     * 
     * <p>
    ...
    public List<CampaignReportScope> getCampaignReportScopes() {
        if (campaignReportScopes == null) {
            campaignReportScopes = new ArrayList<CampaignReportScope>();
        }
