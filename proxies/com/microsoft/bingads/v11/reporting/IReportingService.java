 ...
 * 
 */
@WebService(name = "IReportingService", targetNamespace = "https://bingads.microsoft.com/Reporting/v11")
...
public interface IReportingService {
     ...
     * @param parameters
     * @return
     *     returns javax.xml.ws.Response<com.microsoft.bingads.v11.reporting.SubmitGenerateReportResponse>
     */
    ...
    public Response<SubmitGenerateReportResponse> submitGenerateReportAsync(
        @WebParam(name = "SubmitGenerateReportRequest", targetNamespace = "https://bingads.microsoft.com/Reporting/v11", partName = "parameters")
     ...
     * @param parameters
     * @return
     *     returns javax.xml.ws.Response<com.microsoft.bingads.v11.reporting.PollGenerateReportResponse>
     */
    ...
    public Response<PollGenerateReportResponse> pollGenerateReportAsync(
        @WebParam(name = "PollGenerateReportRequest", targetNamespace = "https://bingads.microsoft.com/Reporting/v11", partName = "parameters")
     ...
     * @param parameters
     * @return
     *     returns com.microsoft.bingads.v11.reporting.PollGenerateReportResponse
     * @throws AdApiFaultDetail_Exception
     * @throws ApiFaultDetail_Exception
     */
    @WebMethod(operationName = "PollGenerateReport", action = "PollGenerateReport")
    @WebResult(name = "PollGenerateReportResponse", targetNamespace = "https://bingads.microsoft.com/Reporting/v11", partName = "parameters")
