    ...
    extends XmlAdapter<String, Collection<AdGroupStatusReportFilter>>
{
    ...
    public Collection<AdGroupStatusReportFilter> unmarshal(String value) {
        return (com.microsoft.bingads.v11.reporting.AdGroupStatusReportFilterConverter.convertToList(value));
    }

    public String marshal(Collection<AdGroupStatusReportFilter> value) {
        return (com.microsoft.bingads.v11.reporting.AdGroupStatusReportFilterConverter.convertToString(value));
    }
