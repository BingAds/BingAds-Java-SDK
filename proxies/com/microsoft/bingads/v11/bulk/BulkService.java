    ...
    extends Service
{
    ...
    private final static QName BULKSERVICE_QNAME = new QName("https://bingads.microsoft.com/CampaignManagement/v11", "BulkService");
    ...
    public IBulkService getBasicHttpBindingIBulkService() {
        return super.getPort(new QName("https://bingads.microsoft.com/CampaignManagement/v11", "BasicHttpBinding_IBulkService"), IBulkService.class);
    }
    ...
    public IBulkService getBasicHttpBindingIBulkService(WebServiceFeature... features) {
        return super.getPort(new QName("https://bingads.microsoft.com/CampaignManagement/v11", "BasicHttpBinding_IBulkService"), IBulkService.class, features);
    }
