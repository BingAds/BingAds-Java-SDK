    ...
    extends Service
{
    ...
    private final static QName CUSTOMERBILLINGSERVICE_QNAME = new QName("https://bingads.microsoft.com/Billing/v11", "CustomerBillingService");
    ...
    public ICustomerBillingService getBasicHttpBindingICustomerBillingService() {
        return super.getPort(new QName("https://bingads.microsoft.com/Billing/v11", "BasicHttpBinding_ICustomerBillingService"), ICustomerBillingService.class);
    }
    ...
    public ICustomerBillingService getBasicHttpBindingICustomerBillingService(WebServiceFeature... features) {
        return super.getPort(new QName("https://bingads.microsoft.com/Billing/v11", "BasicHttpBinding_ICustomerBillingService"), ICustomerBillingService.class, features);
    }
