 ...
 *         &lt;element name="Role" type="{https://bingads.microsoft.com/Customer/v11/Entities}UserRole" minOccurs="0"/>
...
@XmlType(name = "UserInvitation", namespace = "https://bingads.microsoft.com/Customer/v11/Entities", propOrder = {
    "id",
    "firstName",
    "lastName",
    "email",
