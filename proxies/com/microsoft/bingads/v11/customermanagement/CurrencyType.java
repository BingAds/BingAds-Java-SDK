 ...
 * 
 */
@XmlType(name = "CurrencyType", namespace = "https://bingads.microsoft.com/Customer/v11/Entities")
@XmlEnum
public enum CurrencyType {
    ...
    @XmlEnumValue("CordobaOro")
    CORDOBA_ORO("CordobaOro"),
    @XmlEnumValue("CostaRicanColon")
    COSTA_RICAN_COLON("CostaRicanColon"),
    @XmlEnumValue("Croatiankuna")
    ...
    NUEVO_SOL("NuevoSol"),
    @XmlEnumValue("PakistanRupee")
    PAKISTAN_RUPEE("PakistanRupee"),
    @XmlEnumValue("Pataca")
    PATACA("Pataca"),
    @XmlEnumValue("PesoUruguayo")
    ...
    @XmlEnumValue("Quetzal")
    QUETZAL("Quetzal"),
    @XmlEnumValue("RialOmani")
    RIAL_OMANI("RialOmani"),
    @XmlEnumValue("Rufiyaa")
    RUFIYAA("Rufiyaa"),
    @XmlEnumValue("Rupiah")
    RUPIAH("Rupiah"),
    @XmlEnumValue("RussianRuble")
    ...
    @XmlEnumValue("SyrianPound")
    SYRIAN_POUND("SyrianPound"),
    @XmlEnumValue("Tenge")
    TENGE("Tenge"),
    @XmlEnumValue("Tolar")
    TOLAR("Tolar"),
    @XmlEnumValue("TrinidadandTobagoDollar")
    TRINIDADAND_TOBAGO_DOLLAR("TrinidadandTobagoDollar"),
    @XmlEnumValue("Tugrik")
    TUGRIK("Tugrik"),
    @XmlEnumValue("TunisianDinar")
