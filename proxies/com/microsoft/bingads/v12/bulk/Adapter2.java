    ...
    extends XmlAdapter<String, Collection<DataScope>>
{
    ...
    public Collection<DataScope> unmarshal(String value) {
        return (com.microsoft.bingads.v12.bulk.DataScopeConverter.convertToList(value));
    }

    public String marshal(Collection<DataScope> value) {
        return (com.microsoft.bingads.v12.bulk.DataScopeConverter.convertToString(value));
    }
