 ...
 * 
 */
@WebServiceClient(name = "AdInsightService", targetNamespace = "Microsoft.Advertiser.AdInsight.Api.Service.V12", wsdlLocation = "https://adinsight.api.sandbox.bingads.microsoft.com/Api/Advertiser/AdInsight/v12/AdInsightService.svc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADINSIGHTSERVICE_QNAME = new QName("Microsoft.Advertiser.AdInsight.Api.Service.V12", "AdInsightService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adinsight.api.sandbox.bingads.microsoft.com/Api/Advertiser/AdInsight/v12/AdInsightService.svc?wsdl");
    ...
    public IAdInsightService getBasicHttpBindingIAdInsightService() {
        return super.getPort(new QName("Microsoft.Advertiser.AdInsight.Api.Service.V12", "BasicHttpBinding_IAdInsightService"), IAdInsightService.class);
    }
