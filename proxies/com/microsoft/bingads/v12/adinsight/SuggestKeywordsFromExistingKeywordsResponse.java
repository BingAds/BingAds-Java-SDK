...
@XmlRootElement(name = "SuggestKeywordsFromExistingKeywordsResponse", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V12")
public class SuggestKeywordsFromExistingKeywordsResponse {

    @XmlElement(name = "KeywordSuggestions", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V12", nillable = true)
