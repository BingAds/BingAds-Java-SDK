...
@XmlRootElement(name = "SuggestKeywordsForUrlRequest", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V12")
public class SuggestKeywordsForUrlRequest {

    @XmlElement(name = "Url", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V12", nillable = true)
    protected String url;
    @XmlElement(name = "Language", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V12", nillable = true)
    protected String language;
    @XmlElement(name = "MaxKeywords", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V12", nillable = true)
    protected Integer maxKeywords;
    @XmlElement(name = "MinConfidenceScore", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V12", nillable = true)
