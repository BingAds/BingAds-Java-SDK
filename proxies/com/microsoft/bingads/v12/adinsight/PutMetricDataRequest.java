...
@XmlRootElement(name = "PutMetricDataRequest", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V12")
public class PutMetricDataRequest {

    @XmlElement(name = "Metrics", namespace = "Microsoft.Advertiser.AdInsight.Api.Service.V12", nillable = true)
