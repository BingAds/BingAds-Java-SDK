    ...
    extends XmlAdapter<String, Collection<BidOpportunityType>>
{
    ...
    public Collection<BidOpportunityType> unmarshal(String value) {
        return (com.microsoft.bingads.v12.adinsight.BidOpportunityTypeConverter.convertToList(value));
    }

    public String marshal(Collection<BidOpportunityType> value) {
        return (com.microsoft.bingads.v12.adinsight.BidOpportunityTypeConverter.convertToString(value));
    }
