 ...
 *       &lt;sequence>
 *         &lt;element name="SharedEntity" type="{https://bingads.microsoft.com/CampaignManagement/v12}SharedEntity" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfSharedEntity {
     ...
     * This is why there is not a <CODE>set</CODE> method for the sharedEntities property.
     * 
     * <p>
    ...
    public List<SharedEntity> getSharedEntities() {
        if (sharedEntities == null) {
            sharedEntities = new ArrayList<SharedEntity>();
        }
