...
public interface IReportingService {
     ...
     * @param parameters
     * @return
     *     returns javax.xml.ws.Response<com.microsoft.bingads.v12.reporting.SubmitGenerateReportResponse>
     */
    ...
    public Response<SubmitGenerateReportResponse> submitGenerateReportAsync(
        @WebParam(name = "SubmitGenerateReportRequest", targetNamespace = "https://bingads.microsoft.com/Reporting/v12", partName = "parameters")
     ...
     * @param parameters
     * @return
     *     returns com.microsoft.bingads.v12.reporting.SubmitGenerateReportResponse
     ...
     * @param parameters
     * @return
     *     returns javax.xml.ws.Response<com.microsoft.bingads.v12.reporting.PollGenerateReportResponse>
     */
    ...
    public Response<PollGenerateReportResponse> pollGenerateReportAsync(
        @WebParam(name = "PollGenerateReportRequest", targetNamespace = "https://bingads.microsoft.com/Reporting/v12", partName = "parameters")
     ...
     * @param parameters
     * @return
     *     returns com.microsoft.bingads.v12.reporting.PollGenerateReportResponse
     * @throws ApiFaultDetail_Exception
     * @throws AdApiFaultDetail_Exception
     */
    @WebMethod(operationName = "PollGenerateReport", action = "PollGenerateReport")
