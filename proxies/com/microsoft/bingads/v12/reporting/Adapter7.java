    ...
    extends XmlAdapter<String, Collection<CampaignStatusReportFilter>>
{
    ...
    public Collection<CampaignStatusReportFilter> unmarshal(String value) {
        return (com.microsoft.bingads.v12.reporting.CampaignStatusReportFilterConverter.convertToList(value));
    }

    public String marshal(Collection<CampaignStatusReportFilter> value) {
        return (com.microsoft.bingads.v12.reporting.CampaignStatusReportFilterConverter.convertToString(value));
    }
