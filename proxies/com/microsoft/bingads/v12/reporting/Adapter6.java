    ...
    extends XmlAdapter<String, Collection<DeviceOSReportFilter>>
{
    ...
    public Collection<DeviceOSReportFilter> unmarshal(String value) {
        return (com.microsoft.bingads.v12.reporting.DeviceOSReportFilterConverter.convertToList(value));
    }

    public String marshal(Collection<DeviceOSReportFilter> value) {
        return (com.microsoft.bingads.v12.reporting.DeviceOSReportFilterConverter.convertToString(value));
    }
