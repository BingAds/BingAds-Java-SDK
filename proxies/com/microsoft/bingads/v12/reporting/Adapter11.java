    ...
    extends XmlAdapter<String, Collection<DeviceTypeReportFilter>>
{
    ...
    public Collection<DeviceTypeReportFilter> unmarshal(String value) {
        return (com.microsoft.bingads.v12.reporting.DeviceTypeReportFilterConverter.convertToList(value));
    }

    public String marshal(Collection<DeviceTypeReportFilter> value) {
        return (com.microsoft.bingads.v12.reporting.DeviceTypeReportFilterConverter.convertToString(value));
    }
