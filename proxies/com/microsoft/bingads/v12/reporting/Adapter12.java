    ...
    extends XmlAdapter<String, Collection<ChangeTypeReportFilter>>
{
    ...
    public Collection<ChangeTypeReportFilter> unmarshal(String value) {
        return (com.microsoft.bingads.v12.reporting.ChangeTypeReportFilterConverter.convertToList(value));
    }

    public String marshal(Collection<ChangeTypeReportFilter> value) {
        return (com.microsoft.bingads.v12.reporting.ChangeTypeReportFilterConverter.convertToString(value));
    }
