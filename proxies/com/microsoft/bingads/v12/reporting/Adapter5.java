    ...
    extends XmlAdapter<String, Collection<AdTypeReportFilter>>
{
    ...
    public Collection<AdTypeReportFilter> unmarshal(String value) {
        return (com.microsoft.bingads.v12.reporting.AdTypeReportFilterConverter.convertToList(value));
    }

    public String marshal(Collection<AdTypeReportFilter> value) {
        return (com.microsoft.bingads.v12.reporting.AdTypeReportFilterConverter.convertToString(value));
    }
