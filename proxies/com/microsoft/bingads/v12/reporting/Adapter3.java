    ...
    extends XmlAdapter<String, Collection<BidMatchTypeReportFilter>>
{
    ...
    public Collection<BidMatchTypeReportFilter> unmarshal(String value) {
        return (com.microsoft.bingads.v12.reporting.BidMatchTypeReportFilterConverter.convertToList(value));
    }

    public String marshal(Collection<BidMatchTypeReportFilter> value) {
        return (com.microsoft.bingads.v12.reporting.BidMatchTypeReportFilterConverter.convertToString(value));
    }
