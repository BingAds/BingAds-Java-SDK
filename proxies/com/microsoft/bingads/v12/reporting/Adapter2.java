    ...
    extends XmlAdapter<String, Collection<AccountStatusReportFilter>>
{
    ...
    public Collection<AccountStatusReportFilter> unmarshal(String value) {
        return (com.microsoft.bingads.v12.reporting.AccountStatusReportFilterConverter.convertToList(value));
    }

    public String marshal(Collection<AccountStatusReportFilter> value) {
        return (com.microsoft.bingads.v12.reporting.AccountStatusReportFilterConverter.convertToString(value));
    }
