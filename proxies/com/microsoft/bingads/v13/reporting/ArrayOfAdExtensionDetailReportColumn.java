...
public class ArrayOfAdExtensionDetailReportColumn {
    ...
    public ArrayOfAdExtensionDetailReportColumn()
    {
      this.adExtensionDetailReportColumns = new ArrayList<AdExtensionDetailReportColumn>();
    }
    @JsonCreator
    public ArrayOfAdExtensionDetailReportColumn(List<AdExtensionDetailReportColumn> adextensiondetailreportcolumns)
    {
      this.adExtensionDetailReportColumns = adextensiondetailreportcolumns;
    }
