...
public class ArrayOfDSASearchQueryPerformanceReportColumn {
    ...
    public ArrayOfDSASearchQueryPerformanceReportColumn()
    {
      this.dsaSearchQueryPerformanceReportColumns = new ArrayList<DSASearchQueryPerformanceReportColumn>();
    }
    @JsonCreator
    public ArrayOfDSASearchQueryPerformanceReportColumn(List<DSASearchQueryPerformanceReportColumn> dsasearchqueryperformancereportcolumns)
    {
      this.dsaSearchQueryPerformanceReportColumns = dsasearchqueryperformancereportcolumns;
    }
