...
public class ArrayOfDSACategoryPerformanceReportColumn {
    ...
    public ArrayOfDSACategoryPerformanceReportColumn()
    {
      this.dsaCategoryPerformanceReportColumns = new ArrayList<DSACategoryPerformanceReportColumn>();
    }
    @JsonCreator
    public ArrayOfDSACategoryPerformanceReportColumn(List<DSACategoryPerformanceReportColumn> dsacategoryperformancereportcolumns)
    {
      this.dsaCategoryPerformanceReportColumns = dsacategoryperformancereportcolumns;
    }
