...
public class ArrayOfAdExtensionByAdReportColumn {
    ...
    public ArrayOfAdExtensionByAdReportColumn()
    {
      this.adExtensionByAdReportColumns = new ArrayList<AdExtensionByAdReportColumn>();
    }
    @JsonCreator
    public ArrayOfAdExtensionByAdReportColumn(List<AdExtensionByAdReportColumn> adextensionbyadreportcolumns)
    {
      this.adExtensionByAdReportColumns = adextensionbyadreportcolumns;
    }
