...
public class ArrayOfKeywordDemographic {
    ...
    public ArrayOfKeywordDemographic()
    {
      this.keywordDemographics = new ArrayList<KeywordDemographic>();
    }
    @JsonCreator
    public ArrayOfKeywordDemographic(List<KeywordDemographic> keyworddemographics)
    {
