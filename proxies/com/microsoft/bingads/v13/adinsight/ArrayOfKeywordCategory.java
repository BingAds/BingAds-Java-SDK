...
public class ArrayOfKeywordCategory {
    ...
    {
      this.keywordCategories = new ArrayList<KeywordCategory>();
    }
    @JsonCreator
    public ArrayOfKeywordCategory(List<KeywordCategory> keywordcategorys)
    {
      this.keywordCategories = keywordcategorys;
    }
