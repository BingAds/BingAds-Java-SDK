...
public class ArrayOfBidOpportunity {
    ...
    {
      this.bidOpportunities = new ArrayList<BidOpportunity>();
    }
    @JsonCreator
    public ArrayOfBidOpportunity(List<BidOpportunity> bidopportunitys)
    {
      this.bidOpportunities = bidopportunitys;
    }
