...
public class ArrayOfDismissRecommendationEntity {
    ...
    public ArrayOfDismissRecommendationEntity()
    {
      this.dismissRecommendationEntities = new ArrayList<DismissRecommendationEntity>();
    }
    @JsonCreator
    public ArrayOfDismissRecommendationEntity(List<DismissRecommendationEntity> dismissrecommendationentitys)
    {
      this.dismissRecommendationEntities = dismissrecommendationentitys;
    }
