...
public class ArrayOfKeywordEstimator {
    ...
    public ArrayOfKeywordEstimator()
    {
      this.keywordEstimators = new ArrayList<KeywordEstimator>();
    }
    @JsonCreator
    public ArrayOfKeywordEstimator(List<KeywordEstimator> keywordestimators)
    {
