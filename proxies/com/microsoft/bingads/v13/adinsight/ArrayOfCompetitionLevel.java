...
public class ArrayOfCompetitionLevel {
    ...
    public ArrayOfCompetitionLevel()
    {
      this.competitionLevels = new ArrayList<CompetitionLevel>();
    }
    @JsonCreator
    public ArrayOfCompetitionLevel(List<CompetitionLevel> competitionlevels)
    {
