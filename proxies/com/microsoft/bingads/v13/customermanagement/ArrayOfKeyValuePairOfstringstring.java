...
public class ArrayOfKeyValuePairOfstringstring {
    ...
    {
      this.keyValuePairOfstringstrings = new ArrayList<KeyValuePairOfstringstring>();
    }
    @JsonCreator
    public ArrayOfKeyValuePairOfstringstring(List<KeyValuePairOfstringstring> keyvaluepairofstringstrings)
    {
      this.keyValuePairOfstringstrings = keyvaluepairofstringstrings;
    }
