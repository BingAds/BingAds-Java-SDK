...
public class ArrayOfAdExtensionAssociation {
    ...
    {
      this.adExtensionAssociations = new ArrayList<AdExtensionAssociation>();
    }
    @JsonCreator
    public ArrayOfAdExtensionAssociation(List<AdExtensionAssociation> adextensionassociations)
    {
