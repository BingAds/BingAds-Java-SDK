...
/**
 * <p>Java class for AppDownloadGoal complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="AppDownloadGoal">
 *   <complexContent>
...
@XmlType(name = "AppDownloadGoal", propOrder = {
    "appPlatform",
    "appStoreId"
})
public class AppDownloadGoal
    extends ConversionGoal
{
    public AppDownloadGoal() {
      this.type = Collections.singletonList(ConversionGoalType.fromValue("AppDownload"));
    }
