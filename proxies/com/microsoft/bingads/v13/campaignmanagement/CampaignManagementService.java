 ...
 * 
 */
@WebServiceClient(name = "CampaignManagementService", targetNamespace = "https://bingads.microsoft.com/CampaignManagement/v13", wsdlLocation = "https://campaign.api.bingads.microsoft.com/Api/Advertiser/CampaignManagement/v13/CampaignManagementService.svc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNMANAGEMENTSERVICE_QNAME = new QName("https://bingads.microsoft.com/CampaignManagement/v13", "CampaignManagementService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://campaign.api.bingads.microsoft.com/Api/Advertiser/CampaignManagement/v13/CampaignManagementService.svc?wsdl");
