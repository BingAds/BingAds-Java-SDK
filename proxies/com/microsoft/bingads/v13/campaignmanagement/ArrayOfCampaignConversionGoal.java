...
public class ArrayOfCampaignConversionGoal {
    ...
    {
      this.campaignConversionGoals = new ArrayList<CampaignConversionGoal>();
    }
    @JsonCreator
    public ArrayOfCampaignConversionGoal(List<CampaignConversionGoal> campaignconversiongoals)
    {
