...
public class ArrayOfBidStrategy {
    ...
    public ArrayOfBidStrategy()
    {
      this.bidStrategies = new ArrayList<BidStrategy>();
    }
    @JsonCreator
    public ArrayOfBidStrategy(List<BidStrategy> bidstrategys)
    {
      this.bidStrategies = bidstrategys;
    }
