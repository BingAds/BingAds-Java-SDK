...
public class ArrayOfCustomerAccountShareAssociation {
     ...
     * This is why there is not a <CODE>set</CODE> method for the customerAccountShareAssociations property.
     * 
     * <p>
    ...
    public List<CustomerAccountShareAssociation> getCustomerAccountShareAssociations() {
        if (customerAccountShareAssociations == null) {
            customerAccountShareAssociations = new ArrayList<CustomerAccountShareAssociation>();
        }
