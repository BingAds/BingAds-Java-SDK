...
@XmlRootElement(name = "AddExperimentsResponse")
public class AddExperimentsResponse {

    @XmlElement(name = "ExperimentIds", nillable = true)
    protected ArrayOfNullableOflong experimentIds;
     ...
     *     
     */
    public ArrayOfNullableOflong getExperimentIds() {
     ...
     *     
     */
    public void setExperimentIds(ArrayOfNullableOflong value) {
