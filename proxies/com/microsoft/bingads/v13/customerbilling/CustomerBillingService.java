 ...
 * 
 */
@WebServiceClient(name = "CustomerBillingService", targetNamespace = "https://bingads.microsoft.com/Billing/v13", wsdlLocation = "https://clientcenter.api.bingads.microsoft.com/Api/Billing/v13/CustomerBillingService.svc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERBILLINGSERVICE_QNAME = new QName("https://bingads.microsoft.com/Billing/v13", "CustomerBillingService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://clientcenter.api.bingads.microsoft.com/Api/Billing/v13/CustomerBillingService.svc?wsdl");
