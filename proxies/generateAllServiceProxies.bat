...
if exist ..\tools\WsdlEnumGenerator\bin\Debug\WsdlEnumGenerator.exe (
	...
	rem del jaxb-bindings-v12.adinsight.xml
	REM del jaxb-bindings-v12.bulk.xml
	...
	REM call generateProxy v11.campaignmanagement https://campaign.api.bingads.microsoft.com/Api/Advertiser/CampaignManagement/v11/CampaignManagementService.svc
	...
	REM call generateProxy v11.adinsight https://adinsight.api.sandbox.bingads.microsoft.com/Api/Advertiser/AdInsight/v11/AdInsightService.svc
